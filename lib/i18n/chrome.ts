...
const en: ChromeStrings = {
  ...
  adblock: { title: "Konvertools is free thanks to ads", body1: "You can disable ads by", goPro: "going Pro at €25/month", body2: ", or by allowing ads on this site.", dismiss: "Dismiss" },
...
const fr: ChromeStrings = {
  ...
  adblock: { title: "Konvertools est gratuit grâce aux publicités", body1: "Vous pouvez désactiver les pubs en", goPro: "passant Pro pour 25 €/mois", body2: ", ou en autorisant les pubs sur ce site.", dismiss: "Fermer" },
...
const es: ChromeStrings = {
  ...
  adblock: { title: "Konvertools es gratis gracias a los anuncios", body1: "Puedes desactivar los anuncios", goPro: "pasando a Pro por 25 €/mes", body2: ", o permitiendo los anuncios en este sitio.", dismiss: "Cerrar" },
...
const pt: ChromeStrings = {
  ...
  adblock: { title: "Konvertools é grátis graças aos anúncios", body1: "Você pode desativar os anúncios", goPro: "indo Pro por €25/mês", body2: ", ou permitindo anúncios neste site.", dismiss: "Fechar" },
...
const de: ChromeStrings = {
  ...
  adblock: { title: "Konvertools ist dank Werbung kostenlos", body1: "Du kannst die Werbung deaktivieren, indem du", goPro: "Pro für 25 €/Monat holst", body2: " oder Werbung auf dieser Seite zulässt.", dismiss: "Schließen" },
...
const it: ChromeStrings = {
  ...
  adblock: { title: "Konvertools è gratis grazie agli annunci", body1: "Puoi disattivare gli annunci", goPro: "passando a Pro per 25 €/mese", body2: ", o consentendo gli annunci su questo sito.", dismiss: "Chiudi" },
...
const nl: ChromeStrings = {
  ...
  adblock: { title: "Konvertools is gratis dankzij advertenties", body1: "Je kunt advertenties uitschakelen door", goPro: "Pro te nemen voor €25/maand", body2: ", of door advertenties op deze site toe te staan.", dismiss: "Sluiten" },
...
const ja: ChromeStrings = {
  ...
  adblock: { title: "Konvertools は広告のおかげで無料です", body1: "広告は次の方法で無効化できます：", goPro: "月 25 ユーロで Pro へ", body2: " もしくは、このサイトで広告を許可してください。", dismiss: "閉じる" },
...
const zh: ChromeStrings = {
  ...
  adblock: { title: "Konvertools 因广告而免费", body1: "您可以通过以下方式关闭广告:", goPro: "每月 25 欧元升级 Pro", body2: ",或在本站允许广告。", dismiss: "关闭" },
...
const ko: ChromeStrings = {
  ...
  adblock: { title: "Konvertools 는 광고 덕분에 무료입니다", body1: "광고는 다음 방법으로 비활성화 가능:", goPro: "월 25유로로 Pro 가입", body2: " 또는 이 사이트의 광고를 허용해 주세요.", dismiss: "닫기" },
...
const ar: ChromeStrings = {
  ...
  adblock: { title: "Konvertools مجاني بفضل الإعلانات", body1: "يمكنك تعطيل الإعلانات عبر:", goPro: "الترقية إلى Pro بـ 25 يورو/شهر", body2: " أو السماح بالإعلانات على هذا الموقع.", dismiss: "إغلاق" },
...
const ru: ChromeStrings = {
  ...
  adblock: { title: "Konvertools бесплатен благодаря рекламе", body1: "Рекламу можно отключить,", goPro: "перейдя на Pro за 25 €/мес", body2: ", или разрешив рекламу на этом сайте.", dismiss: "Закрыть" },
...
const hi: ChromeStrings = {
  ...
  adblock: { title: "Konvertools विज्ञापनों के कारण मुफ़्त है", body1: "आप विज्ञापन इस तरह बंद कर सकते हैं:", goPro: "€25/माह में Pro लें", body2: ", या इस साइट पर विज्ञापनों की अनुमति दें।", dismiss: "बंद करें" },
...
const tr: ChromeStrings = {
  ...
  adblock: { title: "Konvertools reklamlar sayesinde ücretsizdir", body1: "Reklamları şu şekilde devre dışı bırakabilirsiniz:", goPro: "ayda 25 €'ya Pro'ya geçerek", body2: " veya bu sitede reklamlara izin vererek.", dismiss: "Kapat" },
...
const id: ChromeStrings = {
  ...
  adblock: { title: "Konvertools gratis berkat iklan", body1: "Anda dapat menonaktifkan iklan dengan", goPro: "beralih ke Pro seharga €25/bulan", body2: ", atau dengan mengizinkan iklan di situs ini.", dismiss: "Tutup" },
...
const vi: ChromeStrings = {
  ...
  adblock: { title: "Konvertools miễn phí nhờ quảng cáo", body1: "Bạn có thể tắt quảng cáo bằng cách", goPro: "lên Pro với giá 25 €/tháng", body2: ", hoặc cho phép quảng cáo trên trang này.", dismiss: "Đóng" },
...
const sv: ChromeStrings = {
  ...
  adblock: { title: "Konvertools är gratis tack vare annonser", body1: "Du kan inaktivera annonser genom att", goPro: "gå Pro för 25 €/månad", body2: ", eller genom att tillåta annonser på den här webbplatsen.", dismiss: "Stäng" },
...
const pl: ChromeStrings = {
  ...
  adblock: { title: "Konvertools jest darmowy dzięki reklamom", body1: "Możesz wyłączyć reklamy,", goPro: "przechodząc na Pro za 25 €/mies.", body2: ", lub zezwalając na reklamy w tej witrynie.", dismiss: "Zamknij" },
...
const uk: ChromeStrings = {
  ...
  adblock: { title: "Konvertools безкоштовний завдяки рекламі", body1: "Ви можете вимкнути рекламу,", goPro: "перейшовши на Pro за 25 €/міс", body2: ", або дозволивши рекламу на цьому сайті.", dismiss: "Закрити" },
...
const cs: ChromeStrings = {
  ...
  adblock: { title: "Konvertools je zdarma díky reklamám", body1: "Reklamy můžete vypnout", goPro: "přechodem na Pro za 25 €/měsíc", body2: ", nebo povolením reklam na tomto webu.", dismiss: "Zavřít" },
