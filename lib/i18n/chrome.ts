...
const en: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo is free thanks to ads", body1: "You can disable ads by", goPro: "going Pro at €12/month", body2: ", or by allowing ads on this site.", dismiss: "Dismiss" },
...
const fr: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo est gratuit grâce aux publicités", body1: "Vous pouvez désactiver les pubs en", goPro: "passant Pro pour 12 €/mois", body2: ", ou en autorisant les pubs sur ce site.", dismiss: "Fermer" },
...
const es: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo es gratis gracias a los anuncios", body1: "Puedes desactivar los anuncios", goPro: "pasando a Pro por 12 €/mes", body2: ", o permitiendo los anuncios en este sitio.", dismiss: "Cerrar" },
...
const pt: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo é grátis graças aos anúncios", body1: "Você pode desativar os anúncios", goPro: "indo Pro por €12/mês", body2: ", ou permitindo anúncios neste site.", dismiss: "Fechar" },
...
const de: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo ist dank Werbung kostenlos", body1: "Du kannst die Werbung deaktivieren, indem du", goPro: "Pro für 12 €/Monat holst", body2: " oder Werbung auf dieser Seite zulässt.", dismiss: "Schließen" },
  ...
  auth: { loginTitle: "Willkommen zurück", loginLead: "Melde dich bei deinem Wyrlo-Konto an.", registerTitle: "Konto erstellen", registerLead: "5 kostenlose Durchläufe pro Tag. Keine Karte erforderlich.", email: "E-Mail", password: "Passwort", loginCta: "Anmelden", registerCta: "Konto erstellen", loading: "Bitte warten…", orWithEmail: "oder mit E-Mail", google: "Mit Google fortfahren", checkInbox: "Prüfe dein Postfach zur Bestätigung.", noAccount: "Noch kein Konto?", createOne: "Eines erstellen", hasAccount: "Schon ein Konto?", logIn: "Anmelden" },
};
...
const it: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo è gratis grazie agli annunci", body1: "Puoi disattivare gli annunci", goPro: "passando a Pro per 12 €/mese", body2: ", o consentendo gli annunci su questo sito.", dismiss: "Chiudi" },
  ...
  auth: { loginTitle: "Bentornato", loginLead: "Accedi al tuo account Wyrlo.", registerTitle: "Crea il tuo account", registerLead: "5 utilizzi gratis al giorno. Senza carta.", email: "E-mail", password: "Password", loginCta: "Accedi", registerCta: "Crea account", loading: "Attendere…", orWithEmail: "o con e-mail", google: "Continua con Google", checkInbox: "Controlla la posta per confermare.", noAccount: "Non hai un account?", createOne: "Creane uno", hasAccount: "Hai già un account?", logIn: "Accedi" },
};
...
const nl: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo is gratis dankzij advertenties", body1: "Je kunt advertenties uitschakelen door", goPro: "Pro te nemen voor €12/maand", body2: ", of door advertenties op deze site toe te staan.", dismiss: "Sluiten" },
...
const ja: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo は広告のおかげで無料です", body1: "広告は次の方法で無効化できます：", goPro: "月 12 ユーロで Pro へ", body2: " もしくは、このサイトで広告を許可してください。", dismiss: "閉じる" },
  ...
  auth: { loginTitle: "お帰りなさい", loginLead: "Wyrlo アカウントにログイン。", registerTitle: "アカウント作成", registerLead: "1 日 5 回まで無料。クレジットカード不要。", email: "メール", password: "パスワード", loginCta: "ログイン", registerCta: "アカウント作成", loading: "お待ちください…", orWithEmail: "またはメールで", google: "Google で続行", checkInbox: "確認メールを受信箱でご確認ください。", noAccount: "アカウントをお持ちでない方は？", createOne: "作成する", hasAccount: "既にアカウントをお持ちですか？", logIn: "ログイン" },
};
...
const zh: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo 因广告而免费", body1: "您可以通过以下方式关闭广告:", goPro: "每月 12 欧元升级 Pro", body2: ",或在本站允许广告。", dismiss: "关闭" },
  ...
  auth: { loginTitle: "欢迎回来", loginLead: "登录您的 Wyrlo 帐户。", registerTitle: "创建帐户", registerLead: "每日 5 次免费使用。无需信用卡。", email: "邮箱", password: "密码", loginCta: "登录", registerCta: "创建帐户", loading: "请稍候…", orWithEmail: "或使用邮箱", google: "使用 Google 继续", checkInbox: "请查收邮件确认。", noAccount: "还没有帐户?", createOne: "创建一个", hasAccount: "已有帐户?", logIn: "登录" },
};
...
const ko: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo 는 광고 덕분에 무료입니다", body1: "광고는 다음 방법으로 비활성화 가능:", goPro: "월 12유로로 Pro 가입", body2: " 또는 이 사이트의 광고를 허용해 주세요.", dismiss: "닫기" },
...
const ar: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo مجاني بفضل الإعلانات", body1: "يمكنك تعطيل الإعلانات عبر:", goPro: "الترقية إلى Pro بـ 12 يورو/شهر", body2: " أو السماح بالإعلانات على هذا الموقع.", dismiss: "إغلاق" },
...
const ru: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo бесплатен благодаря рекламе", body1: "Рекламу можно отключить,", goPro: "перейдя на Pro за 12 €/мес", body2: ", или разрешив рекламу на этом сайте.", dismiss: "Закрыть" },
...
const hi: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo विज्ञापनों के कारण मुफ़्त है", body1: "आप विज्ञापन इस तरह बंद कर सकते हैं:", goPro: "€12/माह में Pro लें", body2: ", या इस साइट पर विज्ञापनों की अनुमति दें।", dismiss: "बंद करें" },
  ...
  auth: { loginTitle: "वापसी पर स्वागत है", loginLead: "अपने Wyrlo खाते में लॉग इन करें।", registerTitle: "अपना खाता बनाएँ", registerLead: "रोज़ 5 मुफ़्त रन। क्रेडिट कार्ड ज़रूरी नहीं।", email: "ईमेल", password: "पासवर्ड", loginCta: "लॉग इन", registerCta: "खाता बनाएँ", loading: "कृपया प्रतीक्षा करें…", orWithEmail: "या ईमेल से", google: "Google से जारी रखें", checkInbox: "पुष्टि के लिए अपना इनबॉक्स देखें।", noAccount: "खाता नहीं है?", createOne: "एक बनाएँ", hasAccount: "पहले से खाता है?", logIn: "लॉग इन" },
};
