...
const en: BillingStrings = {
  ...
  subDescSubscriber: "Change plan, update or remove your card, download invoices, or cancel — all handled securely by Paddle.",
  ...
  portalNote: "Opens your secure Paddle portal: payment method, plan changes, invoices and cancellation.",
  portalNoteCustomer: "Opens your Paddle customer portal: update your payment method and download receipts for your purchases.",
  ...
  vatNote: "Paddle is our Merchant of Record — VAT/sales tax is calculated, collected and remitted for you.",
  aiUsage: "AI usage",
...
const fr: BillingStrings = {
  ...
  subDescSubscriber: "Changer d'offre, mettre à jour ou retirer votre carte, télécharger vos factures ou résilier — tout est géré en toute sécurité par Paddle.",
  ...
  portalNote: "Ouvre votre portail Paddle sécurisé : moyen de paiement, changement d'offre, factures et résiliation.",
  portalNoteCustomer: "Ouvre votre portail client Paddle : mettez à jour votre moyen de paiement et téléchargez les reçus de vos achats.",
  ...
  vatNote: "Paddle est notre revendeur officiel (Merchant of Record) — la TVA / taxe est calculée, collectée et reversée pour vous.",
