    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "ul", items: [
          ...
          "third-party service failures (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, hosting providers);",
    ...
    },
    {
      ...
      blocks: [
        { kind: "ul", items: [
          ...
          "**Tax**: Paddle is the Merchant of Record for all purchases and acts as the seller of record. It calculates, collects and remits any VAT or sales tax due in your jurisdiction, so the price you pay at checkout already includes any applicable tax.",
        ] },
      ],
    },
    {
