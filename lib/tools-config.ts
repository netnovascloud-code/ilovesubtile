...
export const TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    short: "Add a selectable subtitle track to your MP4 (soft subtitles).",
    h1: "Add Subtitles to Video Online — Embed SRT into MP4 for Free",
    metaTitle: "Add Subtitles to Video Online Free — Embed SRT into MP4 | Konvertools",
    metaDescription:
      "Add a selectable subtitle track to any MP4. Upload your video and an SRT or VTT, and download a captioned MP4 with a soft track viewers can toggle on or off.",
    primaryKeyword: "add subtitles to video online free",
    accept: ["mp4", "mov", "webm", "mkv", "avi", "srt", "vtt"],
    freeMaxMb: 200,
    outputType: "MP4",
    steps: [
      ...
      { title: "Download captioned MP4", body: "We mux the subtitles as a selectable track with FFmpeg and send back your video." },
    ],
...
TOOLS.push(
  ...
  imgTool("compress-image", Shrink, "Compress Image", "Cut file size while keeping it sharp.",
    ...
    "Compress JPG, PNG and WebP images to a lightweight WebP, instantly in your browser. Big size savings with a quality you control. Free and unlimited.",
...
TOOLS.push(
  ...
  docTool("compress-pdf", Shrink, "Compress PDF", "Reduce PDF file size (best for image-heavy or scanned PDFs).",
    "Compress PDF Online — Make PDFs Smaller",
    "Compress PDF Online — Free Tool | Konvertools",
    "Shrink the size of image-heavy or scanned PDFs in your browser. Note: pages are rasterised, so a text-only PDF may not get smaller.",
    "compress pdf", ["pdf"], "PDF",
    [{ title: "Upload your PDF", body: "Any size." }, { title: "We optimise it", body: "Pages are re-encoded to cut size." }, { title: "Download the result", body: "Compressed PDF, ready to share." }], false),
  ...
  docTool("html-to-pdf", FileCode, "HTML to PDF", "Convert an HTML file (or pasted HTML) to PDF.",
    "HTML to PDF Online — Render HTML to PDF",
    "HTML to PDF Online — Free Tool | Konvertools",
    "Convert an .html file or pasted HTML markup to a clean PDF, right in your browser.",
    "html to pdf", ["html", "htm"], "PDF",
    [{ title: "Upload HTML or paste markup", body: "Static .html files or pasted HTML." }, { title: "We render it", body: "Converted to PDF locally in your browser." }, { title: "Download the PDF", body: "Crisp, paginated." }], false),
