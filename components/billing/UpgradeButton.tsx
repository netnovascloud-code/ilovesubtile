 ...
 * needed) and the Stripe hosted-checkout redirect. One code path whether or not
 * the visitor is signed in — the launcher page decides. Inert while
 * BILLING_ENABLED (lib/flags) is off.
 */
