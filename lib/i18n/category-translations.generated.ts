 ...
 * Machine translations of category labels + blurbs. The resolver falls back
 * to the English label/blurb when a locale is missing.
 * Stored as a TS object literal (no runtime imports) so it loads everywhere.
 */
