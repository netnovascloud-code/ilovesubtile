...
export function CompetitorPage({ alt }: { alt: AlternativeDef }) {
  ...
  return (
    <>
      ...
      <section className="border-t border-ink-100 bg-white">
        <div className="container py-16">
          <h2 className="text-2xl font-semibold text-ink-900">
            Why creators switch from {alt.competitor} to Wyrlo
          </h2>
            ...
            <table className="w-full min-w-[560px] text-sm">
              <thead>
                <tr className="border-b border-ink-100 text-left">
                  ...
                  <th className="px-5 py-3 font-semibold text-brand-700">Wyrlo</th>
      ...
      <section className="border-t border-ink-100 bg-white">
        <div className="container py-16">
          <h2 className="text-2xl font-semibold text-ink-900">Most-used tools on Wyrlo</h2>
