...
export const PRIVACY_TRANSLATIONS: Partial<Record<Locale, LegalDoc>> = {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Aux fins du Règlement général sur la protection des données (RGPD – Règlement (UE) 2016/679, « GDPR »), le responsable du traitement des données est l’éditeur du Service. Pour toute question relative à la confidentialité : [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Les seules données personnelles que nous conservons dans notre base de données sont les suivantes :"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**État de l’abonnement** : plan actuel (gratuit / Pro / Business), identifiant client Paddle, ainsi que les dates de vos renouvellements les plus récents.",
              "**Compteurs d’utilisation** : compteurs de quota agrégés (par exemple, « 3 exécutions IA utilisées aujourd’hui », « 420 exécutions IA mensuelles utilisées ») mis à jour directement dans votre profil. Nous **ne conservons pas de registres par exécution**.",
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Obligation légale** (Art. 6(1)(c)) — conservation des enregistrements de facturation conformément à la législation fiscale française (généralement dix ans)."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "En tant que personne concernée par le Règlement (UE) 2016/679 du 27 avril 2016 (« RGPD »), vous bénéficiez des droits suivants, exercables à tout moment et gratuitement depuis l’adresse e-mail enregistrée sur votre compte :"
          },
          {
            "kind": "ul",
            "items": [
              "**Droit d’accès** (RGPD Art. 15) — obtenir confirmation que nous traitons vos données et en obtenir une copie.",
              ...
              "**Droit d’opposition** (RGPD Art. 21) — vous opposer, pour des raisons liées à votre situation particulière, au traitement basé sur nos intérêts légitimes.",
              "**Droit de retirer votre consentement** (RGPD Art. 7(3)) — pour un traitement basé sur le consentement, le retirer à tout moment sans affecter la légalité des traitements antérieurs.",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Mistral AI** (France) — inférence de grands modèles de langage pour la traduction, la reformulation, la synthèse, l’humanisation IA, l’analyse de motifs de phishing et autres tâches textuelles ; transcription audio (Voxtral) ; OCR et tâches de vision par IA (Pixtral). Le texte ou l’image que vous soumettez est envoyé à Mistral pour inférence. Mistral s’est engagé contractuellement à **ne pas utiliser les entrées de l’API pour entraîner ses modèles**.",
              ...
              "**HaveIBeenPwned** (Have I Been Pwned LLC) — uniquement lorsque vous utilisez le Vérificateur de fuites de mots de passe, et uniquement les cinq premiers caractères du hachage SHA-1 de votre mot de passe (principe de k-anonymat). Interrogé directement depuis votre navigateur, sans passer par nos serveurs.",
              "**Paddle** (Paddle.com Market Ltd, Royaume-Uni) — notre Marchand de Record : traitement des paiements, gestion des abonnements et collecte/remise de la TVA et des taxes à la consommation dans le monde entier. Nous **ne voyons ni ne stockons** les détails de votre carte. Paddle reçoit votre adresse e-mail, votre méthode de paiement et le plan que vous avez acheté.",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Publicitaires optionnels** : si et lorsque nous activons des partenaires publicitaires (actuellement Ezoic est référencé dans notre code mais non encore activé pour votre trafic), nous afficherons une bannière de consentement claire et ne définirons des cookies publicitaires qu’après votre accord."
            ]
          },
          {
            "kind": "p",
            "text": "Nous n’utilisons actuellement aucun outil d’analyse, pixel de suivi ou balise de reciblage. Si nous en ajoutons, la bannière de cookies ci-dessus les contrôlera."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Gestion des mots de passe** — votre mot de passe est haché par Supabase Auth et jamais stocké en clair. Nous vérifions en outre les nouveaux mots de passe côté client contre l’API HaveIBeenPwned (principe de k-anonymat) pour refuser les mots de passe connus pour avoir fuité.",
              "**Données de paiement** — jamais vues ni stockées par nos soins ; le flux de paiement par carte est entièrement délégué à Paddle, notre Marchand de Record (conforme PCI-DSS Niveau 1).",
              ...
              "**Hygiène des fichiers** — aucun fichier téléversé n’est conservé : les outils exécutés uniquement dans le navigateur ne transmettent rien, et les outils assistés par serveur suppriment les tampons temporaires dans les 30 minutes.",
    ...
    "sections": [
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Herramientas con asistencia de servidor** (transcripción con IA, traducción con IA, tareas de texto con IA, incrustación de subtítulos en vídeo, el escáner de URLs, el detector de phishing, el verificador de certificados SSL y algunas otras) necesitan enviar algo a un backend. En todos los casos, el archivo o texto se procesa en tiempo real y se elimina del almacenamiento temporal en un plazo de treinta (30) minutos.",
              "Nunca almacenamos el contenido de ningún archivo subido en una ubicación persistente, no utilizamos tus subidas para entrenar modelos de IA, ni vendemos, alquilamos ni compartimos tus archivos con terceros con ningún otro propósito que no sea entregar el resultado que solicitaste."
            ]
          }
        ]
      },
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Estado de suscripción**: plan actual (gratis / Pro / Business), identificador de cliente de Paddle y las fechas de tus renovaciones más recientes.",
              "**Contadores de uso**: contadores agregados de cuota (por ejemplo, \"3 ejecuciones de IA utilizadas hoy\", \"420 ejecuciones de IA mensuales utilizadas\") actualizados en tu fila de perfil. **No registramos** registros por ejecución.",
          ...
          {
            "kind": "p",
            "text": "**No recopilamos**: tu dirección IP (más allá del uso temporal que Supabase y nuestro proveedor de alojamiento hacen de ella para limitación de tasas y registros de seguridad), tu huella digital del navegador, eventos de seguimiento conductual, grabaciones de pantalla ni ningún dato biométrico."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Escáner de URLs/verificador de SSL**: solo se transmite la URL o nombre de host que escribes (a Google Safe Browsing para el escáner de URLs, o se usa para abrir una conexión TLS en vivo para el verificador de SSL). No se incluyen los contenidos de la página circundante."
            ]
          }
        ]
      },
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Consentimiento** (Art. 6(1)(a)) — correos electrónicos de marketing, cookies analíticas o publicitarias opcionales (si y cuando se activen), e integraciones opcionales futuras.",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Derecho de oposición** (GDPR Art. 21) — oponerte, en cualquier momento y por motivos relacionados con tu situación particular, al tratamiento basado en nuestros intereses legítimos.",
              ...
              "**Derecho a no ser objeto de decisiones automatizadas** (GDPR Art. 22) — ninguno de nuestros tratamientos implica decisiones automatizadas que produzcan efectos legales sobre ti."
            ]
          },
          {
            "kind": "p",
            "text": "Para ejercer cualquiera de estos derechos, escribe a [support@konvertools.com](mailto:support@konvertools.com) desde la dirección registrada en tu cuenta. Respondemos en un plazo de un (1) mes, según lo exige el GDPR Art. 12(3); el plazo puede ampliarse hasta dos meses adicionales para solicitudes especialmente complejas, en cuyo caso te informaremos dentro del primer mes."
          },
          {
            "kind": "p",
            "text": "También tienes el **derecho a presentar una reclamación ante una autoridad de control** (GDPR Art. 77). Para usuarios en Francia, esta es la **Comisión Nacional de Informática y Libertades (CNIL)** — 3 Place de Fontenoy, TSA 80715, 75334 PARÍS CEDEX 07, Francia — teléfono +33 (0)1 53 73 22 22 — reclamaciones en línea en [www.cnil.fr/es/reclamaciones](https://www.cnil.fr/en/plaintes). Para usuarios en otros Estados miembros de la UE/EEE, puedes presentar una reclamación ante tu **autoridad nacional de control** (la lista está mantenida por el Comité Europeo de Protección de Datos en [edpb.europa.eu](https://edpb.europa.eu/about-edpb/about-edpb/members_en)). También puedes buscar una vía judicial según el GDPR Art. 79."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Mistral AI** (Francia) — inferencia de modelos de lenguaje para traducción, reformulación, resumen, humanización de texto con IA, análisis de patrones de phishing y otras tareas de texto; transcripción de audio (Voxtral); tareas de OCR e imagen con visión artificial (Pixtral). El texto o imagen que envíes se envía a Mistral para inferencia. Mistral se ha comprometido contractualmente a **no usar las entradas de la API para entrenar sus modelos**.",
              "**Google Safe Browsing** (Google LLC, EE. UU.) — solo cuando usas el Escáner de URLs o el Detector de Phishing. Solo se transmiten las URLs que envíes (o los enlaces extraídos del correo electrónico que pegues). Este es el único servicio de seguridad de terceros que utilizamos.",
              ...
              "**Paddle** (Paddle.com Market Ltd, Reino Unido) — nuestro Proveedor de Servicios de Pagos: procesamiento de pagos, gestión de suscripciones y recaudación y remisión de impuestos sobre el IVA/ventas a nivel mundial. **Nunca vemos ni almacenamos** los detalles de tu tarjeta. Paddle recibe tu correo electrónico, método de pago y el plan que compraste.",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Publicidad opcional**: si y cuando habilitemos socios publicitarios (actualmente Ezoic está referenciado en nuestro código pero no activado para tu tráfico), mostraremos un banner de consentimiento claro y solo estableceremos cookies publicitarias una vez que optes por aceptarlas."
            ]
          },
          {
            "kind": "p",
            "text": "Actualmente no ejecutamos ningún análisis, píxeles de seguimiento ni etiquetas de remarketing. Si añadimos alguno, el banner de cookies mencionado anteriormente lo regulará."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "De conformidad con el GDPR Art. 32, implementamos las medidas técnicas y organizativas adecuadas para garantizar un nivel de seguridad acorde al riesgo:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**Datos de pago** — nunca vistos ni almacenados por nosotros; el flujo de pago con tarjeta está completamente delegado a Paddle, nuestro Proveedor de Servicios de Pagos (cumplimiento PCI-DSS Nivel 1).",
              ...
              "**Higiene de archivos** — ningún archivo subido se retiene: las herramientas solo en el navegador nunca transmiten nada, y las herramientas con asistencia de servidor eliminan búferes temporales en un plazo de 30 minutos.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "De conformidad con el GDPR Art. 5(1)(c), recopilamos solo los datos estrictamente necesarios para los fines establecidos en esta Política. En concreto: no recopilamos tu dirección IP más allá de registros de enrutamiento efímeros, no fingerprinting de tu navegador, no ejecutamos análisis conductuales, y nunca usamos ningún archivo que proceses para entrenar modelos de IA. No recopilamos datos de categorías especiales (Art. 9) ni datos relacionados con infracciones penales (Art. 10). Los datos se mantienen exactos y actualizados (Art. 5(1)(d)); puedes corregir cualquier inexactitud en cualquier momento a través de tu panel o contactando a [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "El Servicio **no está dirigido a menores de dieciséis (16) años**. Si tienes menos de esa edad, no debes crear una cuenta. No recopilamos datos de menores de forma intencional; si llegáramos a tomar conocimiento de ello, los eliminaremos."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Ferramentas apenas no navegador** (conversores de imagem, ferramentas de PDF que usam o pdf-lib, conversões de áudio e vídeo com o FFmpeg.wasm, ferramentas de código, calculadoras, geradores de QR, o verificador de violações de senha, a maioria das utilidades) são executadas **totalmente dentro do seu navegador web por meio do WebAssembly**. Seu arquivo ou entrada nunca é transmitido aos nossos servidores. Não temos meios técnicos de lê-lo.",
              "**Ferramentas assistidas por servidor** (transcrição de IA, tradução de IA, tarefas de texto de IA, legendas de vídeo queimadas, o scanner de URL, o detector de phishing, o verificador de certificados SSL e um pequeno número de outros) precisam enviar algo para um backend. Em todos os casos, o arquivo ou texto é processado em tempo real e excluído do armazenamento temporário em até trinta (30) minutos.",
              "Nunca armazenamos o conteúdo de nenhum arquivo carregado em nenhum local persistente, nunca usamos seus uploads para treinar modelos de IA e nunca os vendemos, alugamos ou compartilhamos com terceiros para qualquer finalidade além de entregar o resultado que você solicitou."
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Credenciais de conta**: seu endereço de e-mail; uma cópia com hash e salgada da sua senha (gerenciada pelo Supabase Auth — nunca vemos ou armazenamos o texto não criptografado); nome de exibição e URL do avatar opcionais, se você fizer login com o Google.",
              "**Estado da assinatura**: plano atual (gratuito / Pro / Business), identificador do cliente da Paddle e as datas das suas renovações mais recentes.",
              "**Contadores de uso**: contadores agregados de cota (por exemplo, \"3 execuções de IA usadas hoje\", \"420 execuções de IA mensais usadas\") atualizados no seu perfil. Não registramos **registros por execução**.",
              "**Metadados de tarefas (transitórios)**: quando uma ferramenta assistida por servidor produz uma saída (por exemplo, um arquivo .srt de transcrição), registramos o nome da ferramenta, a URL de download do resultado, o idioma de origem e um carimbo de data/hora de conclusão. Essas linhas são **excluídas automaticamente após duas (2) horas**. Elas nunca contêm o conteúdo do seu arquivo.",
              "**Registros de consentimento**: a data e a hora em que você aceitou estes Termos e nossa Política de Privacidade, e se você optou por receber e-mails de marketing. Mantidos durante a duração da sua conta mais um período de evidência legal de cinco (5) anos após a exclusão."
            ]
          },
          {
            "kind": "p",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Transcrição / tradução / OCR / análise de phishing de IA**: o arquivo ou texto é transmitido para nossa Supabase Edge Function, que imediatamente o encaminha para o respectivo provedor de IA (consulte a seção 7) para inferência. O resultado é retornado a você e o buffer de upload temporário é descartado. Os arquivos de resultado gravados no nosso bucket de armazenamento privado são acessíveis por meio de URL assinado por sessenta (60) minutos e fisicamente excluídos em até trinta (30) minutos após a geração.",
              "**Verificador de violações de senha**: sua senha nunca sai do seu navegador. Nós a criptografamos localmente com SHA-1 e consultamos o HaveIBeenPwned usando k-anonimato — apenas os primeiros 5 caracteres do hash são enviados. A senha e o hash completo nunca são transmitidos.",
              "**Scanner de URL / verificador de SSL**: apenas a URL ou nome de host que você digita é transmitido (para o Google Safe Browsing no caso do scanner de URL ou usado para abrir uma conexão TLS ao vivo no caso do verificador de SSL). Nenhum conteúdo da página circundante."
            ]
          }
        ]
      },
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Obrigação legal** (Art. 6(1)(c)) — retenção de registros de faturamento conforme exigido pela lei fiscal francesa (geralmente dez anos)."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Como titular de dados sob o Regulamento (UE) 2016/679 de 27 de abril de 2016 (o \"GDPR\"), você tem os seguintes direitos, exercíveis a qualquer momento e gratuitamente a partir do endereço de e-mail registrado na sua conta:"
          },
          {
            "kind": "ul",
            "items": [
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Mistral AI** (França) — inferência de modelos de linguagem de grande porte para tradução, reformulação, resumo, o humanizador de IA, análise de padrões de phishing e outras tarefas de texto; transcrição de áudio (Voxtral); tarefas de OCR e Visão de imagem (Pixtral). O texto ou imagem que você enviar é enviado à Mistral para inferência. A Mistral comprometeu-se contratualmente a **não usar as entradas da API para treinar seus modelos**.",
              "**Google Safe Browsing** (Google LLC, EUA) — apenas quando você usa o Scanner de URL ou o Detector de Phishing. Apenas as URLs que você enviar (ou links extraídos do e-mail que você colar) são transmitidos. Este é o único serviço de segurança de terceiros que usamos.",
              "**HaveIBeenPwned** (Have I Been Pwned LLC) — apenas quando você usa o Verificador de Violações de Senha e apenas os primeiros 5 caracteres do hash SHA-1 da sua senha (k-anonimato). Consultado diretamente do seu navegador, não por meio dos nossos servidores.",
              "**Paddle** (Paddle.com Market Ltd, Reino Unido) — nosso Comerciante de Registro: processamento de pagamentos, gerenciamento de assinaturas e cobrança/remessa de IVA/impostos sobre vendas em todo o mundo. **Nunca vemos ou armazenamos** os detalhes do seu cartão. A Paddle recebe seu e-mail, método de pagamento e o plano que você comprou.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Usamos apenas os seguintes cookies e itens de armazenamento local:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**Publicidade opcional**: se e quando ativarmos parceiros de anúncios (atualmente o Ezoic está referenciado no nosso código, mas ainda não ativado para o seu tráfego), exibiremos um banner de consentimento claro e só definiremos cookies de publicidade após você optar por aceitar."
            ]
          },
          {
            "kind": "p",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Manuseio de senhas** — sua senha é criptografada pelo Supabase Auth e nunca armazenada em texto não criptografado. Além disso, verificamos novas senhas no cliente contra a API de k-anonimato do HaveIBeenPwned para recusar senhas conhecidas como comprometidas.",
              "**Dados de pagamento** — nunca vistos ou armazenados por nós; o fluxo de pagamento com cartão é totalmente delegado à Paddle, nosso Comerciante de Registro (conforme PCI-DSS Nível 1).",
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "Metadados de tarefas: excluídos automaticamente após duas (2) horas.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "O Serviço **não é direcionado a crianças menores de dezesseis (16) anos**. Se você tiver menos de 16 anos, não deve criar uma conta. Não coletamos dados de menores de idade de forma intencional; se ficarmos cientes de tê-lo feito, excluiremos os dados."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Der Service **Konvertools** (der „Dienst“) wird als ein auf Privatsphäre ausgerichtetes Toolkit betrieben. Die wichtigste Verpflichtung, die wir eingehen, lautet:"
          },
          {
            "kind": "ul",
            "items": [
              "**Browserbasierte Tools** (Bildkonverter, PDF-Tools, die pdf-lib verwenden, Audio- und Videokonvertierungen mit FFmpeg.wasm, Code-Tools, Rechner, QR-Generatoren, der Passwort-Breach-Checker, die meisten Utilities) laufen **vollständig in Ihrem Webbrowser über WebAssembly**. Ihre Datei oder Eingabe wird niemals an unsere Server übertragen. Wir haben keine technischen Möglichkeiten, sie zu lesen.",
              ...
              "Wir speichern niemals den Inhalt einer hochgeladenen Datei an einem persistenten Speicherort, wir verwenden Ihre Uploads nicht zur Schulung von KI-Modellen und wir verkaufen, vermieten oder teilen sie nicht mit Dritten zu einem anderen Zweck als der Bereitstellung des von Ihnen angeforderten Ergebnisses."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Für die Zwecke der **EU-Datenschutz-Grundverordnung (Verordnung (EU) 2016/679, „GDPR“)** ist der für die Datenverarbeitung Verantwortliche der Herausgeber des Dienstes. Kontakt für Datenschutzanfragen: [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Kontozugangsdaten**: Ihre E-Mail-Adresse; eine gesalzene, gehashte Kopie Ihres Passworts (verwaltet durch Supabase Auth — wir sehen oder speichern niemals das Klartextpasswort); optional ein Anzeigename und eine Avatar-URL, falls Sie sich mit Google anmelden.",
              "**Abonnementstatus**: aktueller Plan (kostenlos / Pro / Business), Kundennummer bei Paddle und die Daten Ihrer letzten Verlängerungen.",
              "**Nutzungskontingente**: aggregierte Zähler für die Nutzung (z. B. „3 KI-Läufe heute genutzt“, „420 monatliche KI-Läufe genutzt“), die auf Ihrem Profil aktualisiert werden. Wir führen **keine Aufzeichnungen pro Lauf** durch.",
          ...
          {
            "kind": "p",
            "text": "Wir erheben **keine** Daten zu: Ihrer IP-Adresse (außer der vorübergehenden Nutzung durch Supabase und unseren Hosting-Anbieter für Ratenbegrenzung und Sicherheitsprotokollierung), Ihrem Browser-Fingerabdruck, Verhaltens-Tracking-Ereignissen, Bildschirmaufzeichnungen oder biometrischen Daten."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Browserbasierte Tools**: keine Übertragung. Die Datei wird von Ihrem Browser in den Speicher gelesen, das Ergebnis wird lokal erzeugt und Sie laden es direkt herunter. Wir protokollieren nichts über die Datei selbst.",
              ...
              "**URL-Scanner / SSL-Checker**: Es wird nur die von Ihnen eingegebene URL oder der Hostname übertragen (an Google Safe Browsing für den URL-Scanner oder zur Herstellung einer TLS-Verbindung für den SSL-Checker). Keine umgebenden Seitinhalte."
            ]
          }
        ]
      },
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Einwilligung** (Art. 6(1)(a)) — Marketing-E-Mails, optionale Analyse- oder Werbe-Cookies (falls und wann aktiviert) sowie zukünftige optionale Integrationen.",
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Auskunftsrecht** (GDPR Art. 15) — Bestätigung erhalten, ob wir Ihre Daten verarbeiten, und eine Kopie davon erhalten.",
              "**Berichtigungsrecht** (GDPR Art. 16) — Ungenauigkeiten oder unvollständige Daten korrigieren lassen.",
              "**Löschrecht / Recht auf Vergessenwerden** (GDPR Art. 17) — Ihre Daten löschen lassen, wenn die Rechtsgrundlage für die Verarbeitung nicht mehr besteht.",
              ...
              "**Recht auf Widerruf der Einwilligung** (GDPR Art. 7(3)) — Bei auf Einwilligung beruhender Verarbeitung die Einwilligung jederzeit widerrufen, ohne dass die Rechtmäßigkeit der vorherigen Verarbeitung dadurch berührt wird.",
              "**Recht auf keinem ausschließlich automatisierten Entscheidungsverfahren unterworfen zu werden** (GDPR Art. 22) — Keine unserer Verarbeitungen umfasst ausschließlich automatisierte Entscheidungen mit rechtlicher Wirkung oder ähnlich erheblicher Auswirkung auf Sie."
            ]
          },
          {
            "kind": "p",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Für die Erbringung des Dienstes müssen wir uns an folgende Auftragsverarbeiter wenden, wobei wir streng begrenzte Daten weitergeben. Jeder hat seine eigene Datenschutzrichtlinie, die regelt, wie sie die von uns erhaltenen Daten behandeln."
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase** (in Singapur gegründet, für unser Projekt in der EU gehostet) — Authentifizierung, Datenbank, Dateispeicher und Edge Functions. Erhält Ihre Kontozugangsdaten, Profildaten und (vorübergehend) jede Datei, die Sie für ein servergestütztes Tool hochladen. Agiert als unser Unterauftragsverarbeiter.",
              "**Mistral AI** (Frankreich) — Inferenz mit großen Sprachmodellen für Übersetzung, Umformulierung, Zusammenfassung, den KI-Humanizer, Phishing-Musteranalyse und andere Textaufgaben; Audio-Transkription (Voxtral); Bild-OCR und Vision-Aufgaben (Pixtral). Der von Ihnen übermittelte Text oder das Bild wird an Mistral zur Inferenz gesendet. Mistral hat vertraglich zugesichert, **keine API-Eingaben** zur Schulung seiner Modelle zu verwenden.",
              ...
              "**Paddle** (Paddle.com Market Ltd, Vereinigtes Königreich) — unser Merchant of Record: Abrechnung, Abonnementverwaltung und weltweite Erhebung und Abführung von MwSt./Umsatzsteuer. Wir **sehen oder speichern niemals** Ihre Kartendaten. Paddle erhält Ihre E-Mail-Adresse, Zahlungsmethode und den von Ihnen gekauften Plan.",
              "**Resend** (USA) — Zustellung von Transaktions-E-Mails (Kontobestätigung, Zahlungsbestätigung, Passwortzurücksetzung). Erhält Ihre E-Mail-Adresse und den von uns gesendeten E-Mail-Inhalt.",
          ...
          {
            "kind": "p",
            "text": "Falls einer dieser Auftragsverarbeiter außerhalb des Europäischen Wirtschaftsraums tätig ist, unterliegen die Datenübermittlungen den Standardvertragsklauseln (SCCs) der Europäischen Kommission oder einem gleichwertigen Übermittlungsmechanismus."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Optional Werbung**: Falls und wann wir Werbepartner aktivieren (derzeit ist Ezoic in unserem Code referenziert, aber noch nicht für Ihren Traffic aktiviert), zeigen wir ein klares Einwilligungsbanner und setzen Werbe-Cookies erst nach Ihrer Zustimmung."
            ]
          },
          {
            "kind": "p",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Zahlungsdaten** — Werden von uns weder gesehen noch gespeichert; der Kartenzahlungsvorgang wird vollständig an Paddle, unseren Merchant of Record (PCI-DSS Level 1-konform), delegiert.",
              "**Zugangskontrolle** — Row-Level-Sicherheitspolitiken verhindern, dass ein Nutzer auf die Daten eines anderen Nutzers zugreift; Service-Rollen-Schlüssel sind auf Edge Functions beschränkt.",
              "**Dateihygiene** — Keine hochgeladene Datei wird jemals gespeichert: Browserbasierte Tools übertragen nichts, und servergestützte Tools löschen temporäre Puffer innerhalb von 30 Minuten.",
          ...
          {
            "kind": "p",
            "text": "Trotz dieser Maßnahmen ist kein System perfekt sicher; Sie akzeptieren das verbleibende Risiko, das mit jedem Online-Dienst einhergeht."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "Einwilligungsnachweise: Werden für die Dauer Ihres Kontos plus fünf (5) Jahre danach als rechtlicher Nachweis gespeichert."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Der Dienst richtet sich **nicht an Kinder unter sechzehn (16) Jahren**. Wenn Sie unter diesem Alter sind, dürfen Sie kein Konto erstellen. Wir sammeln keine Daten von Minderjährigen; falls wir davon Kenntnis erlangen, löschen wir diese."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Wir können diese Datenschutzrichtlinie von Zeit zu Zeit ändern. Wesentliche Änderungen werden mindestens dreißig (30) Tage vor Inkrafttreten per E-Mail an Kontoinhaber angekündigt. Die aktuelle Version ist stets unter [https://konvertools.com/privacy](https://konvertools.com/privacy) verfügbar."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Il servizio **Konvertools** (il \"Servizio\") viene gestito come una suite di strumenti incentrata sulla privacy. L'impegno più importante che assumiamo è questo:"
          },
          {
            "kind": "ul",
            "items": [
              "**Strumenti che funzionano esclusivamente nel browser** (convertitori di immagini, strumenti PDF che utilizzano pdf-lib, conversioni audio e video tramite FFmpeg.wasm, strumenti per il codice, calcolatrici, generatori di codici QR, il controllo delle violazioni delle password, la maggior parte delle utility) vengono eseguiti **completamente all'interno del browser tramite WebAssembly**. Il file o l'input non vengono mai trasmessi ai nostri server. Non abbiamo mezzi tecnici per leggerli.",
              "**Strumenti assistiti dal server** (trascrizione AI, traduzione AI, attività testuali AI, sottotitoli video incisi, lo scanner di URL, il rilevatore di phishing, il controllo dei certificati SSL e altri pochi) necessitano di inviare qualcosa a un backend. In ogni caso, il file o il testo viene elaborato in tempo reale e cancellato dalla memoria temporanea entro trenta (30) minuti.",
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Credenziali dell'account**: il tuo indirizzo email; una copia salata e crittografata della password (gestita da Supabase Auth — non vediamo né memorizziamo mai il testo in chiaro); nome visualizzato e URL dell'avatar opzionali se ti registri con Google.",
              "**Stato dell'abbonamento**: piano attuale (gratuito / Pro / Business), identificatore cliente Paddle e le date dei tuoi ultimi rinnovi.",
              ...
              "**Registri del consenso**: la data e l'ora in cui hai accettato questi Termini e la nostra Politica sulla privacy, e se hai scelto di ricevere email di marketing. Conservati per la durata del tuo account più un periodo di prova legale di cinque (5) anni dopo la cancellazione."
            ]
          },
          {
            "kind": "p",
            "text": "**Non raccogliamo**: il tuo indirizzo IP (oltre all'uso temporaneo che Supabase e il nostro provider di hosting ne fanno per il rate-limiting e la registrazione delle attività di sicurezza), l'impronta digitale del browser, eventi di tracciamento comportamentale, registrazioni dello schermo o dati biometrici."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Strumenti che funzionano esclusivamente nel browser**: nessuna trasmissione. Il file viene letto in memoria dal browser, il risultato viene prodotto localmente e lo scarichi direttamente. Non registriamo nulla riguardo al file stesso.",
              ...
              "**Controllo delle violazioni delle password**: la password non lascia mai il browser. La crittografiamo localmente con SHA-1 e interroghiamo HaveIBeenPwned utilizzando la k-anonimità — vengono inviati solo i primi 5 caratteri dell'hash. La password e l'hash completo non vengono mai trasmessi.",
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Interessi legittimi** (Art. 6(1)(f)) — prevenzione delle frodi, mitigazione degli abusi, registrazione di base delle attività di sicurezza e miglioramento del Servizio.",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Diritto alla cancellazione / diritto all'oblio** (GDPR Art. 17) — far cancellare i tuoi dati quando le basi giuridiche del trattamento non sono più applicabili.",
              "**Diritto alla limitazione del trattamento** (GDPR Art. 18) — sospendere temporaneamente il trattamento durante la risoluzione di una controversia.",
              "**Diritto alla portabilità dei dati** (GDPR Art. 20) — ricevere i tuoi dati in un formato strutturato, leggibile meccanicamente.",
              "**Diritto di opposizione** (GDPR Art. 21) — opporsi in qualsiasi momento, per motivi connessi alla tua situazione particolare, al trattamento basato su interessi legittimi.",
              "**Diritto di revocare il consenso** (GDPR Art. 7(3)) — per il trattamento basato su consenso, revocarlo in qualsiasi momento senza pregiudicare la liceità dei trattamenti precedenti.",
              "**Diritto a non essere soggetto a decisioni automatizzate** (GDPR Art. 22) — nessuno dei nostri trattamenti prevede decisioni automatizzate che producano effetti giuridici su di te."
            ]
          },
          {
            "kind": "p",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "L'erogazione del Servizio richiede di condividere dati strettamente limitati con i seguenti responsabili del trattamento. Ognuno ha una propria politica sulla privacy che disciplina come gestisce i dati che riceve da noi."
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase** (società costituita a Singapore, ospitata nell'UE per il nostro progetto) — autenticazione, database, archiviazione file ed Edge Functions. Riceve le tue credenziali dell'account, i dati del profilo e (transitoriamente) qualsiasi file che carichi per uno strumento assistito dal server. Agisce come nostro sub-responsabile del trattamento.",
              ...
              "**HaveIBeenPwned** (Have I Been Pwned LLC) — solo quando utilizzi il Controllo delle violazioni delle password e solo i primi 5 caratteri dell'hash SHA-1 della tua password (k-anonimità). Interrogato direttamente dal browser, non tramite i nostri server.",
              "**Paddle** (Paddle.com Market Ltd, Regno Unito) — nostro Merchant of Record: elaborazione dei pagamenti, gestione degli abbonamenti e riscossione e versamento dell'IVA/tasse sulle vendite a livello mondiale. **Non vediamo né memorizziamo** i dettagli della tua carta. Paddle riceve il tuo indirizzo email, il metodo di pagamento e il piano acquistato.",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Gestione delle password** — la tua password viene crittografata da Supabase Auth e non memorizzata in chiaro. Inoltre, controlliamo localmente le nuove password tramite l'API k-anonimità di HaveIBeenPwned per rifiutare password note per essere state violate.",
              "**Dati di pagamento** — non vengono mai visti né memorizzati da noi; il flusso di pagamento della carta è completamente delegato a Paddle, nostro Merchant of Record (conforme PCI-DSS Livello 1).",
              ...
              "**Igiene dei file** — nessun file caricato viene mai conservato: gli strumenti che funzionano esclusivamente nel browser non trasmettono nulla e gli strumenti assistiti dal server eliminano i buffer temporanei entro 30 minuti.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "In conformità con il GDPR Art. 5(1)(c), raccogliamo solo i dati strettamente necessari per gli scopi indicati in questa Politica. In concreto: non raccogliamo il tuo indirizzo IP oltre ai log di instradamento effimeri, non tracciamo l'impronta digitale del browser, non eseguiamo analisi comportamentali e non utilizziamo mai alcun file che elabori per addestrare modelli AI. Non raccogliamo dati di categoria speciale (Art. 9) né dati relativi a reati (Art. 10). I dati sono mantenuti accurati e aggiornati (Art. 5(1)(d)); puoi correggere eventuali inesattezze in qualsiasi momento tramite la dashboard o contattando [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "Registri del consenso: conservati per la durata del tuo account più cinque (5) anni dopo per fini di prova legale."
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Possiamo modificare questa Politica sulla privacy di volta in volta. Le modifiche sostanziali verranno annunciate tramite email agli utenti registrati almeno trenta (30) giorni prima della loro entrata in vigore. L'ultima versione è sempre disponibile su [https://konvertools.com/privacy](https://konvertools.com/privacy)."
          }
        ]
      },
      {
  ...
  "nl": {
    "h1": "Privacybeleid",
    "lastUpdated": "2026-06-02",
    "lastUpdatedLabel": "Laatst bijgewerkt: %DATE% · Direct van toepassing op alle bezoekers en houders van een account.",
    "sections": [
      {
        "id": "principle",
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Konvertools (de \"Dienst\") wordt geëxploiteerd als een privacy-first toolkit. De belangrijkste belofte die wij maken is deze:"
          },
          {
            "kind": "ul",
            "items": [
              "**Browser-only tools** (afbeeldingsconversies, PDF-tools die gebruikmaken van pdf-lib, audio- en videoconversies aangedreven door FFmpeg.wasm, code-tools, rekenmachines, QR-generators, de wachtwoordbreukcontrole, de meeste utilities) draaien **volledig binnen uw webbrowser via WebAssembly**. Uw bestand of invoer wordt nooit naar onze servers verzonden. Wij hebben geen technische middelen om het te lezen.",
              "**Server-assisted tools** (AI-transcriptie, AI-vertaling, AI-teksttaken, inbrandvideo-ondertiteling, de URL-scanner, de phishingdetector, de SSL-certificaatcontrole en een klein aantal andere) moeten iets naar een backend verzenden. In elk geval wordt het bestand of de tekst in realtime verwerkt en binnen dertig (30) minuten verwijderd uit tijdelijke opslag.",
              "Wij slaan nooit de inhoud van een geüpload bestand op in een persistentie locatie, wij gebruiken uw uploads nooit om AI-modellen te trainen en wij verkopen, verhuren of delen ze niet met derden voor enig ander doel dan het leveren van het resultaat dat u heeft aangevraagd."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Voor de toepassing van de Algemene verordening gegevensbescherming (Verordening (EU) 2016/679, \"GDPR\"), is de gegevensverwerkingsverantwoordelijke de uitgever van de Dienst. Contact voor elke privacyvraag: [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        "id": "what-we-collect",
        "title": "3. Wat wij verzamelen",
        "blocks": [
          {
            "kind": "p",
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Accountgegevens**: uw e-mailadres; een gezouten, gehashte kopie van uw wachtwoord (beheerd door Supabase Auth — wij zien of slaan het plaintext nooit op); optionele weergavenaam en avatar-URL als u inlogt met Google.",
              "**Abonnementstatus**: huidig abonnement (gratis / Pro / Business), Paddle-klantidentificator en de data van uw meest recente verlengingen.",
              "**Gebruikscounters**: geaggregeerde quota-counters (bijv. \"3 AI-runs gebruikt vandaag\", \"420 maandelijkse AI-runs gebruikt\") die op uw profielrij worden bijgewerkt. Wij loggen **geen** per-runrecords.",
              "**Jobmetadata (tijdelijk)**: wanneer een server-assisted tool een resultaat produceert (bijv. een .srt-bestand van transcriptie), registreren wij de naam van de tool, de download-URL van het resultaat, de brontaal en een voltooiingstijdstempel. Deze rijen worden automatisch gewist na **twee (2) uur**. Ze bevatten nooit de inhoud van uw bestand.",
              "**Toestemmingsrecords**: de datum en tijd waarop u deze voorwaarden en ons Privacybeleid heeft geaccepteerd, en of u heeft ingestemd met marketingmails. Worden bewaard voor de duur van uw account plus een wettelijk bewijsperiode van vijf (5) jaar na verwijdering."
            ]
          },
          {
            "kind": "p",
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Browser-only tools**: nul transmissie. Het bestand wordt door uw browser in het geheugen gelezen, het resultaat wordt lokaal geproduceerd en u downloadt het direct. Wij loggen niets over het bestand zelf.",
              "**AI-transcriptie / vertaling / OCR / phishinganalyse**: het bestand of de tekst wordt gestreamd naar onze Supabase Edge Function, die het direct doorstuurt naar de relevante AI-aanbieder (zie sectie 7) voor inferentie. Het resultaat wordt aan u teruggegeven en de tijdelijke uploadbuffer wordt verwijderd. Resultaatbestanden die naar onze private opslagbucket worden geschreven, zijn gedurende zestig (60) minuten via een gesigneerde URL toegankelijk voor u en worden fysiek gewist binnen dertig (30) minuten na generatie.",
              "**Wachtwoordbreukcontrole**: uw wachtwoord verlaat nooit uw browser. Wij hashen het lokaal met SHA-1 en vragen HaveIBeenPwned aan met k-anonimiteit — alleen de eerste 5 tekens van de hash worden verzonden. Het wachtwoord en de volledige hash worden nooit verzonden.",
      ...
      {
        "id": "legal-bases",
        "title": "5. Juridische grondslagen voor verwerking (GDPR Art. 6)",
        "blocks": [
          {
            "kind": "ul",
            "items": [
      ...
      {
        "id": "rights",
        "title": "6. Uw rechten onder de GDPR",
        "blocks": [
          {
            "kind": "p",
            "text": "Als betrokkene onder Verordening (EU) 2016/679 van 27 april 2016 (de \"GDPR\"), heeft u de volgende rechten, die op elk moment en kosteloos kunnen worden uitgeoefend vanaf het e-mailadres geregistreerd op uw account:"
          },
          {
            "kind": "ul",
            "items": [
              "**Recht op inzage** (GDPR Art. 15) — verkrijg bevestiging dat wij uw gegevens verwerken en een kopie daarvan.",
              "**Recht op rectificatie** (GDPR Art. 16) — laat onjuiste of onvolledige gegevens corrigeren.",
              "**Recht op wissen / recht op vergetelheid** (GDPR Art. 17) — laat uw gegevens verwijderen wanneer de juridische grondslag voor verwerking niet langer van toepassing is.",
              "**Recht op beperking van de verwerking** (GDPR Art. 18) — zet de verwerking tijdelijk stop terwijl een geschil wordt opgelost.",
              "**Recht op gegevensoverdraagbaarheid** (GDPR Art. 20) — ontvang uw gegevens in een gestructureerd, machineleesbaar formaat.",
              "**Recht op verzet** (GDPR Art. 21) — verzet u op elk moment, op grond van uw persoonlijke situatie, tegen verwerking op basis van onze legitieme belangen.",
              ...
              "**Recht niet onderworpen te worden aan geautomatiseerde individuele besluitvorming** (GDPR Art. 22) — geen van onze verwerkingen omvat besluitvorming die uitsluitend op geautomatiseerde processen berust en juridische gevolgen heeft voor u."
            ]
          },
          {
            "kind": "p",
            "text": "Om een van deze rechten uit te oefenen, schrijft u naar [support@konvertools.com](mailto:support@konvertools.com) vanaf het geregistreerde e-mailadres op uw account. Wij reageren binnen één (1) maand, zoals vereist door GDPR Art. 12(3); de termijn kan met twee maanden worden verlengd voor bijzonder complexe verzoeken, in welk geval wij u binnen de eerste maand hiervan op de hoogte stellen."
          },
          {
            "kind": "p",
            "text": "U heeft ook het **recht om een klacht in te dienen bij een toezichthoudende autoriteit** (GDPR Art. 77). Voor gebruikers in Frankrijk is dit de **Commission Nationale de l'Informatique et des Libertés (CNIL)** — 3 Place de Fontenoy, TSA 80715, 75334 PARIS CEDEX 07, Frankrijk — telefoon +33 (0)1 53 73 22 22 — online klachten op [www.cnil.fr/fr/plaintes](https://www.cnil.fr/fr/plaintes). Voor gebruikers in andere EU/EEA-lidstaten kunt u een klacht indienen bij uw **nationale toezichthoudende autoriteit** (de lijst wordt bijgehouden door de European Data Protection Board op [edpb.europa.eu](https://edpb.europa.eu/about-edpb/about-edpb/members_en)). U kunt ook een gerechtelijke voorziening zoeken onder GDPR Art. 79."
          }
        ]
      },
      {
        "id": "third-parties",
        "title": "7. Verwerkers van derden",
        "blocks": [
          {
            "kind": "p",
            "text": "Voor het leveren van de Dienst moeten wij strikt beperkte gegevens delen met de volgende verwerkers. Elke partij heeft zijn eigen privacybeleid dat bepaalt hoe zij de gegevens die zij van ons ontvangen, behandelen."
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase** (in Singapore gevestigd, in de EU gehost voor ons project) — authenticatie, database, bestandsopslag en Edge Functions. Ontvangt uw accountgegevens, profielgegevens en (tijdelijk) elk bestand dat u uploadt voor een server-assisted tool. Treedt op als onze subverwerker.",
              ...
              "**Google Safe Browsing** (Google LLC, USA) — alleen wanneer u de URL-scanner of de phishingdetector gebruikt. Alleen de URLs die u indient (of links die uit de e-mail worden geëxtraheerd die u plakt) worden verzonden. Dit is de enige derde-partijbeveiligingsservice die wij gebruiken.",
              "**HaveIBeenPwned** (Have I Been Pwned LLC) — alleen wanneer u de wachtwoordbreukcontrole gebruikt, en alleen de eerste 5 tekens van de SHA-1-hash van uw wachtwoord (k-anonimiteit). Rechtstreeks vanuit uw browser bevraagd, niet via onze servers.",
              "**Paddle** (Paddle.com Market Ltd, Verenigd Koninkrijk) — onze Merchant of Record: verwerking van betalingen, abonnementbeheer en wereldwijde BTW/omzetbelastingheffing en -afdracht. Wij **zien of slaan uw kaartgegevens nooit op**. Paddle ontvangt uw e-mailadres, betaalmethode en het abonnement dat u heeft gekocht.",
              "**Resend** (USA) — transactie-e-maildienst (accountbevestiging, betalingsbevestiging, wachtwoordreset). Ontvangt uw e-mailadres en de e-mailinhoud die wij verzenden.",
              "**Vercel** (USA) — content delivery network voor statische pagina's. Ontvangt standaard webverkeersmetadata (IP, user-agent, aangevraagde URL) voor routering en misbruikpreventie. Wordt bewaard volgens de logretentiebeleid van Vercel."
            ]
          },
          {
            "kind": "p",
      ...
      {
        "id": "cookies",
        "title": "8. Cookies en vergelijkbare technologieën",
        "blocks": [
          {
            "kind": "p",
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Essentieel**: NEXT_LOCALE (onthoudt uw gekozen taal) en Supabase sessiecookies (sb-*-auth-token) wanneer u bent ingelogd. Deze vereisen geen toestemming onder de GDPR.",
              "**Optioneel advertentie**: indien en wanneer wij advertentiepartners inschakelen (momenteel wordt Ezoic in onze code vermeld maar nog niet geactiveerd voor uw verkeer), zullen wij een duidelijke toestemmingsbanner weergeven en alleen advertentiecookies instellen nadat u heeft ingestemd."
            ]
          },
          {
            "kind": "p",
            "text": "Wij voeren momenteel geen analytics, trackingpixels of remarketingtags uit. Als wij er een toevoegen, zal de cookiebanner hierboven deze blokkeren."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "In overeenstemming met GDPR Art. 32 implementeren wij passende technische en organisatorische maatregelen om een beveiligingsniveau te waarborgen dat past bij het risico:"
          },
          {
            "kind": "ul",
            "items": [
              "**Versleuteling in transit** — al het verkeer naar en van de Dienst wordt beschermd door TLS 1.2 of hoger.",
              "**Versleuteling bij rust** — Supabase versleutelt de onderliggende database (inclusief uw accountgegevens) met AES-256.",
              "**Wachtwoordafhandeling** — uw wachtwoord wordt gehash door Supabase Auth en nooit in plaintext opgeslagen. Wij controleren nieuwe wachtwoorden bovendien client-side tegen de HaveIBeenPwned k-anonimiteit-API om bekende gelekte wachtwoorden te weigeren.",
              "**Betaalgegevens** — nooit door ons gezien of opgeslagen; de betaalstroom voor kaarten wordt volledig gedelegeerd aan Paddle, onze Merchant of Record (PCI-DSS Level 1 compliant).",
              ...
              "**Vulnerabiliteitsrespons** — beveiligingsproblemen kunnen vertrouwelijk worden gemeld via [support@konvertools.com](mailto:support@konvertools.com)."
            ]
          },
          {
            "kind": "p",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "In overeenstemming met GDPR Art. 5(1)(c) verzamelen wij alleen de gegevens die strikt noodzakelijk zijn voor de doelen uiteengezet in dit beleid. Concreet: wij verzamelen uw IP-adres niet verder dan ephemere routeringslogs, wij fingerprinten uw browser niet, wij voeren geen gedragsmatige analytics uit en wij gebruiken nooit een bestand dat u verwerkt om AI-modellen te trainen. Wij verzamelen geen bijzondere categorieën gegevens (Art. 9) of gegevens met betrekking tot strafbare feiten (Art. 10). Gegevens worden nauwkeurig en up-to-date gehouden (Art. 5(1)(d)); u kunt elke onnauwkeurigheid op elk moment corrigeren via uw dashboard of door contact op te nemen met [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "De Dienst is **niet gericht op kinderen onder de zestien (16) jaar**. Als u jonger bent, mag u geen account aanmaken. Wij verzamelen niet bewust gegevens van minderjarigen; als wij ervan op de hoogte worden gesteld dat wij dit toch doen, zullen wij deze verwijderen."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Wij kunnen dit Privacybeleid van tijd tot tijd aanpassen. Substantiële wijzigingen worden minimaal dertig (30) dagen voorafgaand aan inwerkingtreding per e-mail aan houders van een account bekendgemaakt. De meest recente versie is altijd beschikbaar op [https://konvertools.com/privacy](https://konvertools.com/privacy)."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Konvertools（以下「本サービス」）は、プライバシーを最優先とするツールキットとして運営されています。当社が最も重要な約束として掲げるのは、次のとおりです。"
          },
          {
            "kind": "ul",
            "items": [
              "**ブラウザ内ツール** (画像変換、pdf-libを使用したPDFツール、FFmpeg.wasmによるオーディオ・ビデオ変換、コードツール、計算機、QR生成、パスワード漏洩チェッカー、その他のユーティリティ) は、**WebAssemblyを介してお客様のウェブブラウザ内で完全に実行されます**。ファイルや入力内容は当社のサーバーに送信されることはありません。当社にはそれを読み取る技術的手段はありません。",
              ...
              "当社は、アップロードされたファイルの内容を永続的な場所に保存することはなく、お客様のアップロードデータをAIモデルの学習に使用することもなく、結果をご提供する目的以外で第三者に販売、賃貸、共有することもありません。"
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "EU一般データ保護規則（規則（EU）2016/679、「GDPR」）の目的において、データ管理者は本サービスの発行者です。プライバシーに関するお問い合わせ先：[support@konvertools.com](mailto:support@konvertools.com)。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "当社がデータベースに永続的に保持する個人データは、以下のとおりです。"
          },
          {
            "kind": "ul",
            "items": [
              "**アカウント資格情報**：メールアドレス。パスワードのソルト化・ハッシュ化されたコピー（Supabase Authによって管理されており、平文は見えず保存されません）。Googleでサインインした場合は、任意の表示名とアバターURL。",
              "**サブスクリプション状態**：現在のプラン（無料 / Pro / Business）、Paddleの顧客識別子、および直近の更新日。",
              "**使用カウンター**：集約された割り当てカウンター（例：「本日のAI実行回数：3回」、「今月のAI実行回数：420回」）は、プロファイル行上で更新されます。当社は**実行ごとの記録はログに残しません**。",
              ...
              "**同意記録**：本規約およびプライバシーポリシーの受諾日時、ならびにマーケティングメールのオプトインの有無。アカウント削除後5年間の法的証拠期間を含む、アカウントの存続期間中に保持されます。"
            ]
          },
          {
            "kind": "p",
            "text": "当社は以下を収集しません：IPアドレス（Supabaseおよびホスティングプロバイダーによる一時的なレート制限・セキュリティログ目的の使用を除く）、ブラウザフィンガープリント、行動追跡イベント、画面録画、生体認証データ。"
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**AI文字起こし / 翻訳 / OCR / フィッシング分析**：ファイルまたはテキストはSupabase Edge Functionにストリーミングされ、直ちに関連するAIプロバイダー（第7項を参照）に転送されて推論が行われます。結果はお客様に返却され、一時的なアップロードバッファは破棄されます。結果ファイルは当社のプライベートストレージバケットに保存され、60分間署名付きURLでアクセス可能であり、生成から30分以内に物理的に消去されます。",
              "**パスワード漏洩チェッカー**：パスワードはブラウザから送信されることはありません。SHA-1でローカルにハッシュ化され、k-匿名性を用いてHaveIBeenPwnedに照会されます。ハッシュの先頭5文字のみが送信されます。パスワードおよび完全なハッシュは送信されません。",
              "**URLスキャナー / SSLチェッカー**：入力されたURLまたはホスト名のみが送信されます（URLスキャナーの場合はGoogle Safe Browsing、SSLチェッカーの場合はライブTLS接続の確立）。周辺のページ内容は送信されません。"
            ]
          }
        ]
      },
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**契約の履行**（Art. 6(1)(b)）—アカウントを作成し有料機能を使用する際、サービスの提供に必要な処理です。",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "2016年4月27日の規則（EU）2016/679（以下「GDPR」）に基づくデータ主体として、お客様は以下の権利を享受できます。これらの権利は、アカウントに登録されたメールアドレスからいつでも無料で行使できます。"
          },
          {
            "kind": "ul",
            "items": [
              "**アクセス権**（GDPR Art. 15）—当社がお客様のデータを処理していることの確認と、そのコピーの取得。",
              "**訂正権**（GDPR Art. 16）—不正確または不完全なデータの訂正。",
              "**消去権 / 忘れられる権利**（GDPR Art. 17）—処理の法的根拠がなくなった場合にデータを削除。",
              "**処理制限権**（GDPR Art. 18）—紛争が解決されるまで処理を一時的に停止。",
              "**データポータビリティ権**（GDPR Art. 20）—構造化された機械可読形式でデータを受領。",
              "**異議申し立て権**（GDPR Art. 21）—正当な利益に基づく処理に対し、お客様の特定の状況に関連していつでも異議を申し立てる。",
              "**同意の撤回権**（GDPR Art. 7(3)）—同意に基づく処理について、過去の処理の合法性に影響を与えることなくいつでも撤回。",
              "**自動化された個別意思決定からの保護**（GDPR Art. 22）—当社の処理において、お客様に法的効果を及ぼす完全に自動化された意思決定は行われません。"
            ]
          },
          {
            "kind": "p",
            "text": "これらの権利を行使するには、アカウントに登録されたメールアドレスから[support@konvertools.com](mailto:support@konvertools.com)にご連絡ください。GDPR Art. 12(3)に基づき、1か月以内に回答いたします。特に複雑なリクエストの場合はさらに2か月延長されることがあり、その際は最初の1か月以内にご連絡いたします。"
          },
          {
            "kind": "p",
            "text": "また、**監督機関への苦情申立権**（GDPR Art. 77）も有しています。フランス在住の方は、**フランス国立情報・自由委員会（CNIL）**—3 Place de Fontenoy, TSA 80715, 75334 PARIS CEDEX 07, France—電話 +33 (0)1 53 73 22 22—オンライン苦情申立先 [www.cnil.fr/en/plaintes](https://www.cnil.fr/en/plaintes) までご連絡ください。EU/EEA加盟国在住の方は、お住まいの国の**国家監督機関**（欧州データ保護委員会が[edpb.europa.eu](https://edpb.europa.eu/about-edpb/about-edpb/members_en)で維持するリストを参照）に苦情を申し立てることができます。また、GDPR Art. 79に基づく司法救済を求めることも可能です。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "サービスの提供には、以下のプロセッサとの厳格に制限されたデータ共有が必要です。各プロセッサは、当社から受領したデータを処理する方法を規定する独自のプライバシーポリシーを有しています。"
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase**（シンガポール法人、当社プロジェクトではEU内でホスティング）—認証、データベース、ファイルストレージ、Edge Functions。アカウント資格情報、プロファイルデータ、サーバー支援ツールでアップロードされたファイル（一時的）を受領。当社のサブプロセッサとして機能。",
              "**Mistral AI**（フランス）—翻訳、言い換え、要約、AIヒューマナイザー、フィッシングパターン分析、その他テキストタスク向けの大規模言語モデル推論。音声文字起こし（Voxtral）、画像OCR・Visionタスク（Pixtral）。送信されたテキストまたは画像はMistralに送られ推論が行われます。Mistralは契約上、API入力をモデルの学習に使用しないことを約束しています。",
              ...
              "**HaveIBeenPwned**（Have I Been Pwned LLC）—パスワード漏洩チェッカーを使用する場合のみ。SHA-1ハッシュの先頭5文字（k-匿名性）のみが送信されます。ブラウザから直接照会され、当社のサーバーを経由しません。",
              "**Paddle**（Paddle.com Market Ltd、英国）—当社の決済代行業者：決済処理、サブスクリプション管理、世界的なVAT/消費税の徴収・納付。当社は**カード情報を一切見ることも保存することもありません**。Paddleはメールアドレス、決済方法、購入したプランを受領します。",
              "**Resend**（米国）—トランザクションメール配信（アカウント確認、支払い領収書、パスワードリセット）。メールアドレスと当社が送信するメール本文を受領。",
              "**Vercel**（米国）—静的ページ向けコンテンツデリバリーネットワーク。ルーティング・悪用防止のための標準的なウェブトラフィックメタデータ（IP、ユーザーエージェント、リクエストURL）を受領。Vercelのログ保持ポリシーに従って保持されます。"
            ]
          },
          {
            "kind": "p",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**任意の広告**：当社が広告パートナー（現在コード内でEzoicが参照されていますが、お客様のトラフィックではまだ有効化されていません）を有効化する場合、明確な同意バナーを表示し、オプトイン後にのみ広告Cookieを設定します。"
            ]
          },
          {
            "kind": "p",
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**転送時の暗号化** — 本サービスとのすべてのトラフィックはTLS 1.2以上で保護されています。",
              "**保存時の暗号化** — Supabaseはデータベース（アカウントデータを含む）をAES-256で暗号化。",
              "**パスワード処理** — パスワードはSupabase Authによってハッシュ化され、平文で保存されることはありません。また、新規パスワードはクライアントサイドでHaveIBeenPwnedのk-匿名性APIを照会し、既知の漏洩パスワードを拒否します。",
              "**決済データ** — 当社は見ることも保存することもありません。カード決済フローは、当社の決済代行業者であるPaddle（PCI-DSSレベル1準拠）に完全に委任されています。",
              "**アクセス制御** — 行レベルのセキュリティポリシーにより、ユーザーは他のユーザーのデータを読み取ることができません。サービスロールキーはEdge Functionsに制限されています。",
              "**ファイルの衛生管理** — アップロードされたファイルは一切保持されません。ブラウザ内ツールは一切送信せず、サーバー支援ツールは一時バッファを30分以内に削除。",
              "**脆弱性対応** — セキュリティ上の問題は[support@konvertools.com](mailto:support@konvertools.com)まで機密で報告できます。"
            ]
          },
          {
            "kind": "p",
            "text": "これらの措置にもかかわらず、完全に安全なシステムは存在しません。お客様はオンラインサービスに固有の残存リスクを受け入れます。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "GDPR Art. 5(1)(c)に従い、当社は本ポリシーに記載された目的のために厳格に必要なデータのみを収集します。具体的には：IPアドレスは一時的なルーティングログを超えて収集せず、ブラウザのフィンガープリントを行わず、行動分析を実行せず、処理されるファイルをAIモデルの学習に使用することもありません。特別カテゴリデータ（Art. 9）または犯罪に関連するデータ（Art. 10）は収集しません。データは正確かつ最新の状態に保たれ（Art. 5(1)(d)）、ダッシュボードまたは[support@konvertools.com](mailto:support@konvertools.com)までご連絡いただくことでいつでも訂正できます。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "ジョブメタデータ：自動的に2時間後に消去されます。",
              "ストレージバケット内の結果ファイル：生成から30分以内に物理的に削除されます。",
              "請求記録：フランスの税務義務を果たすため10年間保持されます。",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "本サービスは**16歳未満の児童を対象としていません**。16歳未満の方はアカウントを作成できません。当社は故意に未成年者のデータを収集することはありません。万一収集した場合は削除いたします。"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "本ポリシーまたはお客様のデータに関するご質問（第6項のGDPR権利の行使を含む）については、[support@konvertools.com](mailto:support@konvertools.com)までご連絡ください。このメールボックスは、プライバシー、セキュリティ、請求、および一般的なサポートに関するお問い合わせ窓口です。また、フランスのデータ保護当局であるCNIL（3 Place de Fontenoy, TSA 80715, 75334 Paris Cedex 07 — [www.cnil.fr](https://www.cnil.fr)）またはお住まいの国の監督機関に苦情を申し立てることもできます。"
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**仅在浏览器中运行的工具**（图像转换器、使用 pdf-lib 的 PDF 工具、由 FFmpeg.wasm 驱动的音频和视频转换、代码工具、计算器、二维码生成器、密码泄露检查器、大多数实用工具）会**完全在您的网页浏览器中通过 WebAssembly 执行**。您的文件或输入永远不会传输到我们的服务器。我们无法读取它。",
              "**服务器辅助工具**（AI 转录、AI 翻译、AI 文本任务、视频字幕烧录、URL 扫描器、钓鱼检测器、SSL 证书检查器及其他少数工具）需要将某些内容发送到后端。在所有情况下，文件或文本均会实时处理并在三十（30）分钟内从临时存储中删除。",
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**账户凭据**：您的电子邮件地址；经过盐值处理并哈希的密码副本（由 Supabase Auth 管理——我们永远不会看到或存储明文密码）；如果您使用 Google 登录，则还包括可选的显示名称和头像 URL。",
              "**订阅状态**：当前套餐（免费 / Pro / Business）、Paddle 客户标识符，以及您最近续费的日期。",
              "**使用计数器**：聚合配额计数器（例如“今日已使用 3 次 AI 功能”、“本月已使用 420 次 AI 功能”），在您的个人资料行中就地更新。我们**不会**记录每次运行的详细记录。",
              "**作业元数据（临时）**：当服务器辅助工具生成输出时（例如转录生成 .srt 文件），我们会记录工具名称、结果下载 URL、源语言和完成时间戳。这些数据行会在**两（2）小时**后自动清除。它们永远不会包含您文件的内容。",
              "**同意记录**：您接受本条款及我们的隐私政策的日期和时间，以及您是否选择接收营销邮件。这些记录会在您的账户存在期间保留，并在账户删除后的五（5）年内作为法律证据保留。"
            ]
          },
          {
            "kind": "p",
            "text": "我们**不会**收集：您的 IP 地址（仅在 Supabase 和我们的托管服务商为限速和安全日志临时使用）、您的浏览器指纹、行为跟踪事件、屏幕录制内容或任何生物识别数据。"
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**AI 转录 / 翻译 / OCR / 钓鱼分析**：文件或文本会流式传输到我们的 Supabase Edge Function，该函数会立即将其转发至相关 AI 提供商（见第 7 节）进行推理。结果会返回给您，临时上传缓冲区会在三十（30）分钟内丢弃。写入我们私有存储桶的结果文件可通过您的签名 URL 在六十（60）分钟内访问，并在生成后三十（30）分钟内物理清除。",
              "**密码泄露检查器**：您的密码永远不会离开浏览器。我们在本地使用 SHA-1 对其进行哈希处理，并通过 k-匿名性查询 HaveIBeenPwned——仅发送哈希值的前 5 个字符。密码和完整哈希值永远不会被传输。",
              "**URL 扫描器 / SSL 检查器**：仅传输您输入的 URL 或主机名（URL 扫描器传输至 Google Safe Browsing，SSL 检查器用于建立 TLS 连接）。不会传输周围的页面内容。"
            ]
          }
        ]
      },
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**合同履行**（第 6(1)(b) 条）——当您创建账户并使用付费功能时，处理是为提供服务所必需的。",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "作为《欧盟通用数据保护条例》（2016 年 4 月 27 日第(EU) 2016/679 号条例，“GDPR”）下的数据主体，您享有以下权利，可随时通过注册在您账户上的电子邮件地址免费行使："
          },
          {
            "kind": "ul",
            "items": [
              "**访问权**（GDPR 第 15 条）——获取我们是否处理您的数据以及数据副本的确认。",
              "**更正权**（GDPR 第 16 条）——更正不准确或不完整的数据。",
              "**删除权 / 被遗忘权**（GDPR 第 17 条）——在不再存在处理法律依据时删除您的数据。",
              "**限制处理权**（GDPR 第 18 条）——在争议解决期间临时冻结处理。",
              "**可携权**（GDPR 第 20 条）——以结构化、机器可读的格式接收您的数据。",
              "**异议权**（GDPR 第 21 条）——基于您的特定情况，随时对基于我们合法利益的处理提出异议。",
              "**撤回同意权**（GDPR 第 7(3) 条）——对于基于同意的处理，可随时撤回，且不影响先前处理的合法性。",
              "**不受自动决策约束的权利**（GDPR 第 22 条）——我们的处理均不涉及仅基于自动化决策对您产生法律效果。"
            ]
          },
          {
            "kind": "p",
            "text": "要行使上述任何权利，请从您账户注册的地址发送邮件至 [support@konvertools.com](mailto:support@konvertools.com)。我们将在一个（1）月内响应，如《GDPR》第 12(3) 条要求；对于特别复杂的请求，可延长两个月，届时我们会在首月内通知您。"
          },
          {
            "kind": "p",
            "text": "您还享有**向监管机构投诉的权利**（GDPR 第 77 条）。对于法国用户，监管机构为**法国信息与自由国家委员会（CNIL）**——地址：3 Place de Fontenoy, TSA 80715, 75334 PARIS CEDEX 07, 法国——电话：+33 (0)1 53 73 22 22——在线投诉：[www.cnil.fr/en/plaintes](https://www.cnil.fr/en/plaintes)。对于其他欧盟/欧洲经济区成员国用户，您可向所在国的**国家监管机构**投诉（欧洲数据保护委员会在 [edpb.europa.eu](https://edpb.europa.eu/about-edpb/about-edpb/members_en) 维护名单）。您还可根据《GDPR》第 79 条寻求司法救济。"
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase**（新加坡注册，在欧盟为我们的项目提供托管）——身份验证、数据库、文件存储和 Edge Functions。接收您的账户凭据、个人资料数据以及（临时）您上传用于服务器辅助工具的任何文件。作为我们的分包处理者。",
              ...
              "**HaveIBeenPwned**（Have I Been Pwned LLC）——仅在您使用密码泄露检查器时，且仅发送您的密码 SHA-1 哈希值的前 5 个字符（k-匿名性）。直接从您的浏览器查询，不通过我们的服务器。",
              "**Paddle**（Paddle.com Market Ltd，英国）——我们的记录商：支付处理、订阅管理以及全球增值税/销售税的收集和缴纳。我们**永远不会**看到或存储您的卡片详情。Paddle 接收您的电子邮件、支付方式和您购买的套餐。",
              "**Resend**（美国）——交易邮件传递（账户确认、付款收据、密码重置）。接收您的电子邮件地址和我们发送的邮件正文。",
              "**Vercel**（美国）——静态页面的内容分发网络。接收标准网络流量元数据（IP、用户代理、请求 URL）用于路由和滥用预防。遵循 Vercel 的日志保留政策。"
            ]
          },
          {
            "kind": "p",
            "text": "当任何处理者位于欧洲经济区之外时，数据传输受欧盟委员会《标准合同条款》（SCCs）或等效传输机制的约束。"
          }
        ]
      },
      {
        "id": "cookies",
        "title": "8. Cookie 和类似技术",
        "blocks": [
          {
            "kind": "p",
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**必要 Cookie**：NEXT_LOCALE（记住您选择的语言）以及您登录时的 Supabase 会话 Cookie（sb-*-auth-token）。这些不需要《GDPR》的同意。",
              "**可选广告 Cookie**：如果我们启用广告合作伙伴（目前代码中引用了 Ezoic，但尚未为您的流量激活），我们会显示明确的同意横幅，并在您选择加入后才设置广告 Cookie。"
            ]
          },
          {
            "kind": "p",
            "text": "我们目前不运行任何分析、跟踪像素或重定向标签。如果添加任何此类功能，上述 Cookie 横幅将对其进行管控。"
          }
        ]
      },
      {
        "id": "security",
        "title": "9. 处理安全性（GDPR 第 32 条）",
        "blocks": [
          {
            "kind": "p",
            "text": "根据《GDPR》第 32 条，我们实施适当的技术和组织措施，确保风险水平适当的安全性："
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**密码处理**——您的密码由 Supabase Auth 哈希处理，永远不会以明文形式存储。我们还会在客户端通过 HaveIBeenPwned k-匿名性 API 检查新密码，拒绝已知泄露的密码。",
              "**支付数据**——我们永远不会看到或存储；卡支付流程完全委托给我们的记录商 Paddle（PCI-DSS Level 1 合规）。",
              "**访问控制**——行级安全策略可防止用户读取其他用户的数据；服务角色密钥仅限 Edge Functions 使用。",
              "**文件卫生**——上传的文件永远不会保留：仅在浏览器中运行的工具永远不会传输任何内容，服务器辅助工具会在 30 分钟内删除临时缓冲区。",
              "**漏洞响应**——安全问题可保密报告至 [support@konvertools.com](mailto:support@konvertools.com)。"
            ]
          },
          {
            "kind": "p",
            "text": "尽管采取了这些措施，没有任何系统是绝对安全的；您接受任何在线服务固有的残余风险。"
          }
        ]
      },
      {
        "id": "minimisation",
        "title": "10. 数据最小化和目的限制（GDPR 第 5 条）",
        "blocks": [
          {
            "kind": "p",
            "text": "根据《GDPR》第 5(1)(c) 条，我们仅收集本政策中规定目的所严格必需的数据。具体而言：我们不会收集您的 IP 地址（仅用于临时路由日志），不会指纹您的浏览器，不会运行行为分析，也永远不会使用您处理的任何文件来训练 AI 模型。我们不收集特殊类别数据（第 9 条）或与刑事犯罪相关的数据（第 10 条）。数据保持准确和最新（第 5(1)(d) 条）；您可随时通过仪表板或联系 [support@konvertools.com](mailto:support@konvertools.com) 纠正任何不准确信息。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "同意记录：在账户存在期间保留，之后作为法律证据再保留五（5）年。"
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "本服务**不针对十六（16）岁以下儿童**。如果您未满该年龄，请勿创建账户。我们不会有意收集未成年人的数据；如果我们发现此类情况，将立即删除。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "我们可能会不时修改本隐私政策。实质性变更将至少提前三十（30）天通过电子邮件通知账户持有人。最新版本始终可在 [https://konvertools.com/privacy](https://konvertools.com/privacy) 获取。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "如对本政策或您的数据有任何疑问——包括行使您的任何《GDPR》权利（见第 6 节）——请发送邮件至 [support@konvertools.com](mailto:support@konvertools.com)。此单一邮箱是我们隐私、安全、账单和一般支持咨询的联系点。您还可向法国数据保护机构 CNIL（地址：3 Place de Fontenoy, TSA 80715, 75334 Paris Cedex 07——[www.cnil.fr](https://www.cnil.fr)）或您居住国的监管机构投诉。"
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Konvertools(이하 \"서비스\")는 개인정보 우선 도구 키트로 운영됩니다. 저희가 가장 중요하게 약속하는 단 한 가지는 다음과 같습니다:"
          },
          {
            "kind": "ul",
            "items": [
              "**브라우저 전용 도구** (이미지 변환기, pdf-lib을 사용하는 PDF 도구, FFmpeg.wasm으로 구동되는 오디오 및 비디오 변환, 코드 도구, 계산기, QR 생성기, 비밀번호 유출 확인기, 대부분의 유틸리티)는 **웹어셈블리를 통해 웹 브라우저 내에서 완전히 실행**됩니다. 귀하의 파일이나 입력은 저희 서버로 전송되지 않습니다. 저희는 이를 읽을 기술적 수단이 없습니다.",
              "**서버 지원 도구** (AI 필사, AI 번역, AI 텍스트 작업, 비디오 자막 삽입, URL 스캐너, 피싱 감지기, SSL 인증서 확인기 및 기타 소수 도구)는 백엔드로 무언가를 전송해야 합니다. 모든 경우에 파일이나 텍스트는 실시간으로 처리되며 임시 저장소에서 삼십(30) 분 이내에 삭제됩니다.",
              "저희는 업로드된 파일의 내용을 어떤 영구 저장소에도 보관하지 않으며, AI 모델 훈련에 사용하지 않으며, 요청하신 결과를 제공하는 목적 외에는 제3자와 공유, 임대 또는 판매하지 않습니다."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "EU 일반 데이터 보호 규정(GDPR, 규정 (EU) 2016/679)의 목적상, 데이터 관리자는 서비스 게시자입니다. 개인정보 관련 문의는 다음으로 연락하십시오: [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**계정 인증 정보**: 귀하의 이메일 주소; 암호화된 해시화된 비밀번호 복사본(Supabase Auth에서 관리하며, 평문은 절대 확인하거나 저장하지 않음); Google 로그인으로 로그인 시 선택적 표시 이름 및 아바타 URL.",
              "**구독 상태**: 현재 플랜(무료 / Pro / Business), Paddle 고객 식별자, 가장 최근 갱신 일자.",
              "**사용량 카운터**: 집계된 할당량 카운터(예: \"오늘 AI 실행 3회 사용\", \"월간 AI 실행 420회 사용\")가 프로필 행에서 실시간으로 업데이트됩니다. **실행별 기록은 로그하지 않습니다**.",
              "**작업 메타데이터(일시적)**: 서버 지원 도구가 출력물을 생성할 때(예: 필사 결과 .srt 파일), 도구 이름, 결과 다운로드 URL, 소스 언어, 완료 타임스탬프를 기록합니다. 이러한 행은 자동으로 **이시간(2) 시간 후** 삭제됩니다. 파일 내용은 포함되지 않습니다.",
              "**동의 기록**: 본 약관과 개인정보 보호정책을 수락한 날짜 및 시각, 마케팅 이메일 수신 동의 여부. 계정 삭제 후 5년간 법적 증거 보존 기간 동안 보관됩니다."
            ]
          },
          {
            "kind": "p",
            "text": "저희는 다음을 **수집하지 않습니다**: IP 주소(Supsabase 및 호스팅 제공업체의 보안 로깅 및 속도 제한 용도로 일시적으로 사용되는 경우 제외), 브라우저 핑거프린트, 행동 추적 이벤트, 화면 녹화, 또는 생체 인식 데이터."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**브라우저 전용 도구**: 전송 없음. 파일이 브라우저에 메모리로 읽혀지고 결과가 로컬에서 생성되며, 귀하가 직접 다운로드합니다. 파일에 대한 로그는 남기지 않습니다.",
              "**AI 필사 / 번역 / OCR / 피싱 분석**: 파일이나 텍스트가 Supabase Edge Function으로 스트리밍되며, 해당 함수가 관련 AI 제공업체(7항 참조)로 즉시 전달됩니다. 결과는 귀하에게 반환되며 임시 업로드 버퍼는 삼십(30) 분 이내에 삭제됩니다. 개인 저장소 버킷에 작성된 결과 파일은 60분 동안 서명된 URL로 접근 가능하며, 생성 후 삼십(30) 분 이내에 물리적으로 삭제됩니다.",
              "**비밀번호 유출 확인기**: 비밀번호는 브라우저를 떠나지 않습니다. SHA-1로 로컬에서 해시화한 후 k-익명성을 사용하여 HaveIBeenPwned에 쿼리합니다. 해시의 처음 5자만 전송됩니다. 비밀번호와 전체 해시는 전송되지 않습니다.",
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**법적 의무** (Art. 6(1)(c)) — 프랑스 세법(일반적으로 10년) 요구에 따라 청구 기록 보관."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "2016년 4월 27일 규정 (EU) 2016/679(이하 \"GDPR\")에 따라 데이터 주체로서 귀하는 언제든지 무료로 다음 권리를 행사할 수 있습니다(계정에 등록된 이메일 주소에서):"
          },
          {
            "kind": "ul",
            "items": [
              "**접근권** (GDPR Art. 15) — 저희가 귀하의 데이터를 처리하고 있음을 확인하고 복사본을 받을 권리.",
              "**정정권** (GDPR Art. 16) — 부정확하거나 불완전한 데이터를 수정할 권리.",
              "**삭제권 / 잊힐 권리** (GDPR Art. 17) — 처리 법적 근거가 더 이상 적용되지 않을 때 데이터를 삭제할 권리.",
              "**처리 제한권** (GDPR Art. 18) — 분쟁이 해결되는 동안 처리를 일시적으로 정지할 권리.",
              "**데이터 이동권** (GDPR Art. 20) — 데이터를 구조화된 기계 판독 가능한 형식으로 받을 권리.",
              "**이의권** (GDPR Art. 21) — 특정 상황에 근거하여 정당한 이익에 기반한 처리(Art. 6(1)(f))에 대해 언제든지 이의를 제기할 권리.",
              "**동의 철회권** (GDPR Art. 7(3)) — 동의에 기반한 처리(Art. 6(1)(a))에 대해 사전 처리의 적법성에 영향을 미치지 않고 언제든지 동의를 철회할 권리.",
              "**자동화된 의사결정으로부터의 보호권** (GDPR Art. 22) — 저희의 어떤 처리도 귀하에 대한 법적 효과를 초래하는 전적으로 자동화된 의사결정을 포함하지 않습니다."
            ]
          },
          {
            "kind": "p",
            "text": "이러한 권리를 행사하려면 계정에 등록된 이메일 주소로 [support@konvertools.com](mailto:support@konvertools.com)으로 연락하십시오. GDPR Art. 12(3)에 따라 1개월 이내에 응답하며, 특히 복잡한 요청의 경우 2개월까지 연장될 수 있으며, 이 경우 첫 달 내에 통보드릴 것입니다."
          },
          {
            "kind": "p",
            "text": "또한 **감독기관에 불만 제기권** (GDPR Art. 77)이 있습니다. 프랑스 사용자의 경우, 이는 **프랑스 정보 보호 위원회(CNIL)** — 3 Place de Fontenoy, TSA 80715, 75334 PARIS CEDEX 07, 프랑스 — 전화 +33 (0)1 53 73 22 22 — 온라인 불만 접수 [www.cnil.fr/en/plaintes](https://www.cnil.fr/en/plaintes)입니다. EU/EEA 회원국 사용자의 경우, **국가 감독기관**에 불만을 제기할 수 있습니다(유럽 데이터 보호 위원회에서 [edpb.europa.eu](https://edpb.europa.eu/about-edpb/about-edpb/members_en)에서 목록을 관리합니다). 또한 GDPR Art. 79에 따라 사법적 구제를 요청할 수도 있습니다."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "서비스 제공을 위해 다음 처리자와 엄격히 제한된 데이터를 공유해야 합니다. 각 처리자는 저희로부터 받은 데이터를 처리하는 방식에 대한 자체 개인정보 보호정책을 보유하고 있습니다."
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase** (싱가포르 법인, EU 내 호스팅) — 인증, 데이터베이스, 파일 저장소, Edge Functions. 계정 인증 정보, 프로필 데이터, 서버 지원 도구용 파일(일시적)을 수신합니다. 저희의 하위 처리자로 활동합니다.",
              "**Mistral AI** (프랑스) — 번역, 재구성, 요약, AI 인간화, 피싱 패턴 분석 및 기타 텍스트 작업용 대형 언어 모델 추론; 오디오 필사(Voxtral); 이미지 OCR 및 Vision 작업(Pixtral). 제출한 텍스트나 이미지가 추론용으로 Mistral로 전송됩니다. Mistral은 API 입력을 모델 훈련에 **사용하지 않겠다는 계약상 약속**을 했습니다.",
              ...
              "**HaveIBeenPwned** (Have I Been Pwned LLC) — 비밀번호 유출 확인기를 사용할 때만 해당되며, SHA-1 해시의 처음 5자만(k-익명성) 전송됩니다. 브라우저에서 직접 쿼리되며 저희 서버를 거치지 않습니다.",
              "**Paddle** (Paddle.com Market Ltd, 영국) — 저희 결제 대행사: 결제 처리, 구독 관리, 전 세계 부가가치세/판매세 징수 및 납부. **카드 세부 정보는 절대 확인하거나 저장하지 않습니다**. Paddle은 귀하의 이메일, 결제 수단, 구매한 플랜을 수신합니다.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "저희는 다음 쿠키 및 로컬 저장소 항목만 사용합니다:"
          },
          {
            "kind": "ul",
            "items": [
              "**필수**: NEXT_LOCALE(선택한 언어 기억), 로그인 시 Supabase 세션 쿠키(sb-*-auth-token). 이러한 쿠키는 GDPR에 따라 동의가 필요하지 않습니다.",
              "**선택적 광고**: 광고 파트너(현재 코드에 Ezoic이 참조되어 있지만 아직 귀하의 트래픽에 대해 활성화되지 않음)를 사용한다면, 명확한 동의 배너를 표시하고 동의 후 광고 쿠키만 설정할 것입니다."
            ]
          },
          {
            "kind": "p",
            "text": "현재 어떤 분석, 추적 픽셀 또는 재타겟팅 태그도 실행하지 않습니다. 추가할 경우 위의 쿠키 배너에서 차단할 것입니다."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "GDPR Art. 32에 따라 위험 수준에 맞는 적절한 기술적 및 조직적 보호 조치를 구현합니다:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**비밀번호 처리** — 비밀번호는 Supabase Auth에서 해시화되며 평문으로 저장되지 않습니다. 또한 클라이언트 측에서 HaveIBeenPwned k-익명성 API를 사용하여 알려진 유출 비밀번호를 거부합니다.",
              "**결제 데이터** — 저희는 확인하거나 저장하지 않음; 카드 결제 흐름은 PCI-DSS Level 1 준수인 저희 결제 대행사 Paddle에 완전히 위임됩니다.",
              "**접근 제어** — 행 수준 보안 정책으로 한 사용자가 다른 사용자의 데이터를 읽지 못하도록 방지; 서비스 역할 키는 Edge Functions에만 제한됩니다.",
              "**파일 위생** — 업로드된 파일은 절대 보관되지 않음: 브라우저 전용 도구는 아무것도 전송하지 않으며, 서버 지원 도구는 임시 버퍼를 30분 이내에 삭제합니다.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "GDPR Art. 5(1)(c)에 따라, 본 정책에 명시된 목적에 strictly 필요한 데이터만 수집합니다. 구체적으로: IP 주소를 일시적 라우팅 로그 외에는 수집하지 않으며, 브라우저를 핑거프린팅하지 않으며, 행동 분석을 실행하지 않으며, 처리하는 파일을 AI 모델 훈련에 사용하지 않습니다. 특별 범주 데이터(Art. 9) 또는 형사 범죄 관련 데이터(Art. 10)를 수집하지 않습니다. 데이터는 정확하고 최신 상태로 유지됩니다(Art. 5(1)(d)); 대시보드 또는 [support@konvertools.com](mailto:support@konvertools.com)으로 연락하여 언제든지 오류를 수정할 수 있습니다."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "작업 메타데이터: 자동으로 이시간(2) 시간 후 삭제됩니다.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "서비스는 **16세 미만의 아동에게는 제공되지 않습니다**. 해당 연령 미만이라면 계정을 생성할 수 없습니다. 미성년자로부터 데이터를 알고 있거나 수집한 사실이 없으며, 알게 된다면 즉시 삭제할 것입니다."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "저희는 본 개인정보 보호정책을 수시로 개정할 수 있습니다. 실질적인 변경 사항은 계정 보유자에게 30일 전에 이메일로 통보됩니다. 최신 버전은 항상 [https://konvertools.com/privacy](https://konvertools.com/privacy)에서 확인할 수 있습니다."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "본 정책 또는 귀하의 데이터에 대한 모든 질문이 있는 경우 — 6항의 GDPR 권리 행사 포함 — [support@konvertools.com](mailto:support@konvertools.com)으로 연락하십시오. 이 단일 메일박스가 개인정보, 보안, 결제 및 일반 지원 문의에 대한 연락처입니다. 프랑스 데이터 보호 당국 CNIL(3 Place de Fontenoy, TSA 80715, 75334 Paris Cedex 07 — [www.cnil.fr](https://www.cnil.fr)) 또는 거주 국가의 감독기관에 불만을 제기할 수도 있습니다."
          }
        ]
      }
    ]
  ...
  "ar": {
    "h1": "سياسة الخصوصية",
    "lastUpdated": "2026-06-02",
    "lastUpdatedLabel": "آخر تحديث: %DATE% · سارية المفعول فورًا لجميع الزوار وأصحاب الحسابات.",
    "sections": [
      {
        "id": "principle",
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "يتم تشغيل **Konvertools** (الخدمة) كأداة خصوصية رائدة. الالتزام الأهم الذي نقدمه هو هذا:"
          },
          {
            "kind": "ul",
            "items": [
              "**الأدوات التي تعمل فقط في المتصفح** (م converters الصور، أدوات PDF التي تستخدم pdf-lib، تحويلات الصوت والفيديو التي تعمل بواسطة FFmpeg.wasm، أدوات الكود، الآلات الحاسبة، مولدات QR، فاحص اختراقات كلمات المرور، معظم الأدوات) تعمل **كاملة داخل متصفحك عبر WebAssembly**. لم يتم إرسال ملفك أو إدخالك مطلقًا إلى خوادمنا. ليس لدينا أي وسيلة فنية لقراءته.",
              "**الأدوات المدعومة بالخادم** (النسخ الصوتية/الترجمة بواسطة الذكاء الاصطناعي، المهام النصية بواسطة الذكاء الاصطناعي، إضافة ترجمات الفيديو، فاحص الروابط، كاشف التصيد، فاحص شهادة SSL وبعض الأدوات الأخرى) تحتاج إلى إرسال شيء إلى الخلفية. في كل حالة، تتم معالجة الملف أو النص في الوقت الفعلي ويتم حذفه من التخزين المؤقت خلال ثلاثين (30) دقيقة.",
              "لم نقم مطلقًا بتخزين محتوى أي ملف تم تحميله في أي موقع دائم، ولم نستخدمever ملفاتك لتدريب نماذج الذكاء الاصطناعي، ولم نبعها أو نؤجرها أو نشاركها مع أطراف ثالثة لأي غرض يتجاوز تقديم النتيجة التي طلبتها."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "لأغراض لائحة الاتحاد الأوروبي العامة لحماية البيانات (Regulation (EU) 2016/679، \"GDPR\")، فإن مسؤول البيانات هو الناشر للخدمة. للتواصل بشأن أي استفسار خصوصية: [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**بيانات اعتماد الحساب**: عنوان بريدك الإلكتروني؛ نسخة مشفرة ومملحة من كلمة المرور (تدار بواسطة Supabase Auth — لم نتمكن مطلقًا من رؤية كلمة المرور الأصلية أو تخزينها)؛ الاسم المعروض الاختياري ورابط الصورة الرمزية إذا قمت بتسجيل الدخول باستخدام Google.",
              "**حالة الاشتراك**: الخطة الحالية (مجاني / Pro / Business)، المعرف العميل لـ Paddle، وتواريخ أحدث تجديداتك.",
              "**عدادات الاستخدام**: عدادات الحصة المجمعة (مثل \"تم استخدام 3 عمليات ذكاء اصطناعي اليوم\"، \"تم استخدام 420 عملية ذكاء اصطناعي شهريًا\") التي يتم تحديثها في مكانها على صفك الشخصي. **لا نقوم** بتسجيل سجلات لكل عملية.",
              "**بيانات تعريف الوظيفة (عابرة)**: عند إنتاج أداة مدعومة بالخادم مخرجًا (مثل ملف .srt من النسخ الصوتي)، نسجل اسم الأداة، رابط تنزيل النتيجة، لغة المصدر، وتوقيت الإكمال. تتم إزالة هذه الصفوف تلقائيًا بعد **ساعتين (2)**. لا تحتوي مطلقًا على محتويات ملفك.",
          ...
          {
            "kind": "p",
            "text": "**لا نقوم** بجمع: عنوان IP الخاص بك (بخلاف الاستخدام المؤقت الذي تقوم به Supabase ومزود الاستضافة لدينا لأغراض الحد من المعدل وتسجيلات الأمان)، بصمة متصفحك، أحداث التتبع السلوكي، تسجيلات شاشتك، أو أي بيانات حيوية."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "كما هو مذكور في القسم 1، لم نقم مطلقًا بتخزين محتويات الملفات التي تعالجها. الدورة الحياتية الدقيقة هي:"
          },
          {
            "kind": "ul",
            "items": [
              "**الأدوات التي تعمل فقط في المتصفح**: لا إرسال مطلق. يتم قراءة الملف في ذاكرة متصفحك، ويتم إنتاج النتيجة محليًا، وتقوم بتنزيلها مباشرة. لا نقوم بتسجيل أي شيء عن الملف نفسه.",
              "**النسخ الصوتي/الترجمة/OCR بواسطة الذكاء الاصطناعي / تحليل التصيد**: يتم إرسال الملف أو النص إلى دالة Edge الخاصة بنا في Supabase، والتي تقوم فورًا بإرساله إلى مزود الذكاء الاصطناعي ذي الصلة (انظر القسم 7) للاستدلال. يتم إرجاع النتيجة إليك ويتم التخلص من مخزن التحميل المؤقت. يتم الوصول إلى ملفات النتائج المكتوبة في حاوية التخزين الخاصة بنا عبر روابط موقعة لمدة ستين (60) دقيقة ويتم إزالتها ماديًا خلال ثلاثين (30) دقيقة من إنشائها.",
              "**فاحص اختراقات كلمات المرور**: لم تغادر كلمة مرورك مطلقًا متصفحك. نقوم بتشفيرها محليًا باستخدام SHA-1 ونستعلم من HaveIBeenPwned باستخدام k-anonymity — يتم إرسال الأحرف الخمسة الأولى من التجزئة فقط. لم يتم إرسال كلمة المرور أو التجزئة الكاملة مطلقًا.",
              "**فاحص الروابط / فاحص شهادة SSL**: يتم إرسال الرابط أو اسم النطاق الذي تكتبه فقط (إلى Google Safe Browsing لفاحص الروابط، أو لاستخدامه لفتح اتصال TLS مباشر لفاحص شهادة SSL). لا توجد محتويات الصفحة المحيطة."
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "باعتبارك خاضعًا للائحة (EU) 2016/679 المؤرخ 27 أبريل 2016 (\"GDPR\")، تتمتع بالحقوق التالية، التي يمكن ممارستها في أي وقت وبالمجان من عنوان البريد الإلكتروني المسجل في حسابك:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**حق نقل البيانات** (GDPR المادة 20) — تلقي بياناتك بتنسيق منظم وقابل للقراءة آليًا.",
          ...
          {
            "kind": "p",
            "text": "لممارسة أي من هذه الحقوق، اكتب إلى [support@konvertools.com](mailto:support@konvertools.com) من العنوان المسجل في حسابك. سنرد خلال شهر (1) واحد، كما هو مطلوب بموجب GDPR المادة 12(3)؛ قد يتم تمديد الفترة لشهرين آخرين للطلبات المعقدة بشكل خاص، وفي هذه الحالة سنبلغك خلال الشهر الأول."
          },
          {
            "kind": "p",
            "text": "لديك أيضًا **الحق في تقديم شكوى إلى سلطة رقابية** (GDPR المادة 77). للمستخدمين في فرنسا، هذه هي **اللجنة الوطنية للمعالجة الآلية للمعلومات (CNIL)** — 3 Place de Fontenoy, TSA 80715, 75334 PARIS CEDEX 07, فرنسا — هاتف +33 (0)1 53 73 22 22 — شكاوى عبر الإنترنت على [www.cnil.fr/en/plaintes](https://www.cnil.fr/en/plaintes). للمستخدمين في دول الاتحاد الأوروبي/المنطقة الاقتصادية الأوروبية الأخرى، يمكنك تقديم شكوى إلى **السلطة الرقابية الوطنية** الخاصة بك (القائمة محفوظة من قبل المجلس الأوروبي لحماية البيانات على [edpb.europa.eu](https://edpb.europa.eu/about-edpb/about-edpb/members_en)). يمكنك أيضًا طلب سبيل قضائي بموجب GDPR المادة 79."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "يتطلب تقديم الخدمة منا مشاركة بيانات محدودة للغاية مع المعالجين التاليين. لكل منهم سياسته الخاصة للخصوصية التي تحكم كيفية تعاملهم مع البيانات التي يتلقونها منا."
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase** (مؤسسة في سنغافورة، مستضافة في الاتحاد الأوروبي لمشروعنا) — المصادقة، قاعدة البيانات، تخزين الملفات، ودوال Edge. يستقبل بيانات اعتماد حسابك وبيانات الملف الشخصي وأي ملف تقوم بتحميله لأداة مدعومة بالخادم. يعمل كمعالج فرعي لنا.",
              "**Mistral AI** (فرنسا) — استدلال نماذج اللغة الكبيرة للترجمة، إعادة الصياغة، التلخيص، التحويل البشري للذكاء الاصطناعي، تحليل أنماط التصيد، والمهام النصية الأخرى؛ النسخ الصوتي (Voxtral)؛ OCR والوظائف البصرية للصور (Pixtral). يتم إرسال النص أو الصورة التي تقدمها إلى Mistral للاستدلال. التزمت Mistral بموجب عقد **بعدم استخدام** مدخلات API لتدريب نماذجها.",
              "**Google Safe Browsing** (Google LLC، الولايات المتحدة) — فقط عند استخدامك لفاحص الروابط أو كاشف التصيد. يتم إرسال الروابط التي تقدمها (أو الروابط المستخرجة من البريد الإلكتروني الذي تلصقه) فقط. هذه هي الخدمة الأمنية التابعة لجهة خارجية الوحيدة التي نستخدمها.",
              ...
              "**Paddle** (Paddle.com Market Ltd، المملكة المتحدة) — بائعنا المسجل: معالجة الدفع، إدارة الاشتراكات، وجمع وإرسال ضريبة المبيعات/القيمة المضافة عالميًا. **لم نتمكن مطلقًا من رؤية أو تخزين** تفاصيل بطاقتك. يستقبل Paddle بريدك الإلكتروني وطريقة الدفع والخطة التي اشتريتها.",
              ...
              "**Vercel** (الولايات المتحدة) — شبكة توصيل محتوى للصفحات الثابتة. يستقبل بيانات تعريف حركة مرور الويب القياسية (IP، وكيل المستخدم، والرابط المطلوب) للتوجيه ومنع سوء الاستخدام. يتم الاحتفاظ بها وفقًا لسياسة الاحتفاظ بسجلات Vercel."
            ]
          },
          {
            "kind": "p",
            "text": "عندما يعمل أي من هذه المعالجين خارج المنطقة الاقتصادية الأوروبية، تتم إدارة النقل بموجب الشروط التعاقدية القياسية (SCCs) للجنة الأوروبية أو آلية نقل مكافئة."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "نستخدم فقط ملفات تعريف الارتباط والمواد المحلية التالية:"
          },
          {
            "kind": "ul",
            "items": [
              "**أساسية**: NEXT_LOCALE (تذكر اللغة التي اخترتها)، وملفات تعريف ارتباط جلسة Supabase (sb-*-auth-token) عند تسجيل الدخول. لا تتطلب هذه الموافقة بموجب GDPR.",
              "**إعلانية اختيارية**: إذا قمنا بتمكين شركاء الإعلانات (يتمcurrently الإشارة إلى Ezoic في الكود الخاص بنا ولكن لم يتم تفعيله بعد لحركة المرور الخاصة بك)، سنعرض لافتة موافقة واضحة ولن نضع ملفات تعريف ارتباط إعلانية إلا بعد موافقتك."
            ]
          },
          {
            "kind": "p",
            "text": "لا نقوم حاليًا بتشغيل أي تحليلات أو وحدات تتبع أو علامات إعادة تسويق. إذا أضفنا أيًا منها، ستتحكم لافتة الموافقة أعلاه فيها."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**التشفير أثناء النقل** — يتم حماية جميع حركة المرور إلى الخدمة ومنها بواسطة TLS 1.2 أو أعلى.",
              "**التشفير أثناء التخزين** — تقوم Supabase بتشفير قاعدة البيانات الأساسية (بما في ذلك بيانات حسابك) باستخدام AES-256.",
              "**معالجة كلمات المرور** — يتم تجزئة كلمة مرورك بواسطة Supabase Auth ولا يتم تخزينها كنص عادي. نتحقق أيضًا من كلمات المرور الجديدة مقابل API HaveIBeenPwned باستخدام k-anonymity من جانب العميل لرفض كلمات المرور المعروفة التي تم اختراقها.",
              "**بيانات الدفع** — لم نتمكن مطلقًا من رؤيتها أو تخزينها؛ تتم إدارة تدفق الدفع بالكامل بواسطة Paddle، بائعنا المسجل (متوافق مع PCI-DSS المستوى 1).",
              "**تحكم الوصول** — تمنع سياسات الأمان على مستوى الصف مستخدمًا واحدًا من قراءة بيانات مستخدم آخر؛ يتم تقييد مفاتيح دور الخدمة بوظائف Edge.",
              "**نظافة الملفات** — لم يتم الاحتفاظ بأي ملف تم تحميله مطلقًا: لا تقوم الأدوات التي تعمل فقط في المتصفح بإرسال أي شيء، وتقوم الأدوات المدعومة بالخادم بحذف المخازن المؤقتة المؤقتة خلال 30 دقيقة.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "وفقًا للمادة 5(1)(ج) من GDPR، نقوم بجمع البيانات الضرورية فقط للأغراض المحددة في هذه السياسة. بشكل ملموس: لا نقوم بجمع عنوان IP الخاص بك خارج سجلات التوجيه العابرة، ولا نقوم بتتبع بصمة متصفحك، ولا نقوم بتشغيل تحليلات سلوكية، ولا نستخدم مطلقًا أي ملف تعالجه لتدريب نماذج الذكاء الاصطناعي. لا نقوم بجمع البيانات الخاصة بفئة خاصة (المادة 9) أو البيانات المتعلقة بجرائم جنائية (المادة 10). يتم الاحتفاظ بالبيانات دقيقة وحديثة (المادة 5(1)(د))؛ يمكنك تصحيح أي عدم دقة في أي وقت عبر لوحة التحكم الخاصة بك أو عن طريق الاتصال بـ [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "ملفات النتائج في حاوية التخزين: يتم حذفها ماديًا خلال ثلاثين (30) دقيقة من إنشائها.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "الخدمة **غير موجهة للأطفال دون سن السادسة عشرة (16)**. إذا لم تبلغ هذا العمر، يجب ألا تنشئ حسابًا. لا نقوم بجمع بيانات القصر عن علم؛ إذا علمنا بذلك، سنحذفها."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "قد نقوم بتعديل سياسة الخصوصية هذه من وقت لآخر. سيتم الإعلان عن التغييرات الجوهرية عبر البريد الإلكتروني لأصحاب الحسابات قبل ثلاثين (30) يومًا على الأقل من سريانها. النسخة الأحدث متاحة دائمًا على [https://konvertools.com/privacy](https://konvertools.com/privacy)."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Инструменты, работающие только в браузере** (конвертеры изображений, PDF-инструменты с использованием pdf-lib, аудио- и видеоконвертеры на основе FFmpeg.wasm, инструменты для работы с кодом, калькуляторы, генераторы QR-кодов, проверка утечек паролей, большинство утилит) выполняются **полностью внутри вашего веб-браузера через WebAssembly**. Ваш файл или ввод никогда не передаётся на наши серверы. У нас нет технической возможности прочитать его.",
              "**Инструменты с поддержкой сервера** (AI-транскрибирование, AI-перевод, AI-обработка текста, наложение субтитров на видео, сканирование URL, детектор фишинга, проверка SSL-сертификатов и некоторые другие) требуют отправки данных на бэкенд. В каждом случае файл или текст обрабатывается в режиме реального времени и удаляется из временного хранилища в течение тридцати (30) минут.",
              "Мы никогда не храним содержимое загруженных файлов на постоянной основе, не используем ваши загрузки для обучения моделей ИИ и не продаём, не сдаём в аренду и не передаём их третьим лицам для любых целей, кроме как для предоставления результата, который вы запросили."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "В соответствии с Положениями Европейского Союза о защите данных (Регламент (ЕС) 2016/679, «GDPR»), контролёром данных является издатель Сервиса. Для обращений по вопросам конфиденциальности: [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Статус подписки**: текущий тарифный план (бесплатный / Pro / Business), идентификатор клиента Paddle и даты последних продлений.",
              "**Счётчики использования**: агрегированные квоты (например, «3 запуска ИИ сегодня», «420 ежемесячных запусков ИИ использовано») обновляются на вашей учётной записи. Мы **не ведём журналы отдельных запусков**.",
              "**Метаданные задач (временные)**: при создании результата серверным инструментом (например, файл .srt из транскрибирования) мы записываем название инструмента, URL для скачивания результата, исходный язык и время завершения. Эти записи автоматически удаляются через **два (2) часа**. Они никогда не содержат содержимого вашего файла.",
              "**Записи согласий**: дата и время, когда вы приняли эти Условия и нашу Политику конфиденциальности, а также согласие на получение маркетинговых писем. Хранятся в течение срока существования вашей учётной записи плюс пять (5) лет после её удаления в качестве доказательства."
            ]
          },
          {
            "kind": "p",
            "text": "Мы **не собираем**: ваш IP-адрес (кроме временного использования Supabase и нашего хостинг-провайдера для ограничения скорости и логирования безопасности), отпечаток браузера, события поведенческого трекинга, записи экрана или биометрические данные."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Инструменты, работающие только в браузере**: данные не передаются. Файл считывается в память вашим браузером, результат создаётся локально, и вы скачиваете его напрямую. Мы не логируем ничего, связанного с самим файлом.",
              "**AI-транскрибирование / перевод / OCR / анализ фишинга**: файл или текст потоково передаётся в нашу Supabase Edge Function, которая немедленно пересылает его соответствующему провайдеру ИИ (см. раздел 7) для инференса. Результат возвращается вам, а временный буфер загрузки удаляется. Файлы результатов, записанные в наше частное хранилище, доступны по подписанным URL в течение шестидесяти (60) минут и физически удаляются в течение тридцати (30) минут после создания.",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Право на возражение** (GDPR Art. 21) — в любое время возражать против обработки на основе наших законных интересов по причинам, связанным с вашей конкретной ситуацией.",
              ...
              "**Право не подвергаться автоматизированному принятию решений** (GDPR Art. 22) — ни одна из наших обработок не включает полностью автоматизированные решения, которые могут иметь юридические последствия для вас."
            ]
          },
          {
            "kind": "p",
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase** (компания, зарегистрированная в Сингапуре, размещена в ЕС для нашего проекта) — аутентификация, база данных, файловое хранилище и Edge Functions. Получает ваши учётные данные, профильные данные и (временные) любые файлы, загруженные для серверного инструмента. Выступает в роли нашего субподрядчика.",
              "**Mistral AI** (Франция) — инференс больших языковых моделей для перевода, перефразирования, суммаризации, AI-гуманизации, анализа шаблонов фишинга и других текстовых задач; аудиотранскрибирование (Voxtral); OCR и Vision для изображений (Pixtral). Текст или изображение, которые вы отправляете, передаются Mistral для инференса. Mistral взял на себя контрактное обязательство **не использовать входные данные API для обучения своих моделей**.",
              ...
              "**Paddle** (Paddle.com Market Ltd, Великобритания) — наш платёжный агрегатор: обработка платежей, управление подписками и сбор/перечисление НДС/налогов с продаж по всему миру. Мы **никогда не видим и не храним** данные вашей карты. Paddle получает ваш адрес электронной почты, платёжный метод и купленный тарифный план.",
          ...
          {
            "kind": "p",
            "text": "В случаях, когда любой из этих обработчиков работает за пределами Европейской экономической зоны, передача регулируется Стандартными контрактными положениями (SCCs) Европейской комиссии или эквивалентным механизмом передачи."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Необязательные рекламные**: если и когда мы подключаем партнёров по рекламе (в настоящее время в нашем коде упоминается Ezoic, но он не активирован для вашего трафика), мы будем отображать чёткий баннер согласия и устанавливать рекламные cookies только после того, как вы дадите согласие."
            ]
          },
          {
            "kind": "p",
            "text": "В настоящее время мы не используем аналитику, пиксели отслеживания или теги ремаркетинга. Если мы добавим их, баннер cookies выше будет их контролировать."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Платёжные данные** — никогда не видны и не хранятся нами; обработка платёжных карт полностью делегирована Paddle, нашему платёжному агрегатору (соответствует PCI-DSS Level 1).",
              "**Контроль доступа** — политики безопасности на уровне строк предотвращают чтение одним пользователем данных другого; ключи сервисных ролей ограничены Edge Functions.",
              "**Гигиена файлов** — ни один загруженный файл никогда не сохраняется: инструменты, работающие только в браузере, ничего не передают, а серверные инструменты удаляют временные буферы в течение 30 минут.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "В соответствии с GDPR Art. 5(1)(c) мы собираем только данные, строго необходимые для целей, указанных в этой Политике. Конкретно: мы не собираем ваш IP-адрес за пределами временных маршрутных логов, не отслеживаем отпечаток браузера, не используем поведенческую аналитику и никогда не используем файлы, которые вы обрабатываете, для обучения моделей ИИ. Мы не собираем специальные категории данных (Art. 9) или данные, связанные с уголовными преступлениями (Art. 10). Данные хранятся точными и актуальными (Art. 5(1)(d)); вы можете исправить неточности в любое время через панель управления или обратившись на [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "Файлы результатов в хранилище: физически удаляются в течение тридцати (30) минут после создания.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Мы можем время от времени вносить изменения в эту Политику конфиденциальности. Существенные изменения будут объявлены по электронной почте владельцам учётных записей не менее чем за тридцать (30) дней до их вступления в силу. Последняя версия всегда доступна по адресу [https://konvertools.com/privacy](https://konvertools.com/privacy)."
          }
        ]
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**खाता क्रेडेंशियल्स**: आपका ईमेल पता; आपके पासवर्ड का नमकीन, हैश किया गया प्रतिलिपि (Supabase Auth द्वारा प्रबंधित — हम कभी भी सादे पाठ को नहीं देखते या संग्रहीत नहीं करते); यदि आप Google से साइन इन करते हैं तो वैकल्पिक प्रदर्शन नाम और अवतार URL।",
              "**सदस्यता स्थिति**: वर्तमान योजना (निःशुल्क / Pro / Business), Paddle ग्राहक पहचानकर्ता, और आपके नवीनतम नवीकरण की तिथियाँ।",
              "**उपयोग काउंटर्स**: एकत्रित कोटा काउंटर्स (उदाहरण के लिए, \"आज 3 AI रन उपयोग किए गए\", \"मासिक 420 AI रन उपयोग किए गए\") आपके प्रोफ़ाइल पंक्ति पर स्थान में अपडेट किए जाते हैं। हम **प्रति-रन रिकॉर्ड लॉग नहीं करते**।",
              "**जॉब मेटाडेटा (अस्थायी)**: जब कोई सर्वर-सहायता प्राप्त टूल आउटपुट उत्पन्न करता है (उदाहरण के लिए, प्रतिलेखन से .srt फ़ाइल), हम टूल का नाम, परिणाम डाउनलोड URL, स्रोत भाषा, और पूर्णता टाइमस्टैम्प रिकॉर्ड करते हैं। ये पंक्तियाँ स्वचालित रूप से **दो (2) घंटे** के बाद हटा दी जाती हैं। इनमें कभी भी आपकी फ़ाइल की सामग्री शामिल नहीं होती।",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**पासवर्ड उल्लंघन चेकर**: आपका पासवर्ड कभी भी आपके ब्राउज़र से बाहर नहीं जाता। हम इसे स्थानीय रूप से SHA-1 के साथ हैश करते हैं और k-अज्ञातता का उपयोग करके HaveIBeenPwned से क्वेरी करते हैं — केवल हैश के पहले 5 वर्ण भेजे जाते हैं। पासवर्ड और पूर्ण हैश कभी भी प्रसारित नहीं होते।",
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**सहमति** (Art. 6(1)(a)) — विपणन ईमेल, वैकल्पिक विश्लेषिकी या विज्ञापन कुकीज़ (यदि और जब सक्षम किया जाता है), और भविष्य में किसी भी वैकल्पिक एकीकरण।",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**सुधार का अधिकार** (GDPR Art. 16) — अशुद्ध या अपूर्ण डेटा को ठीक करवाएं।",
          ...
          {
            "kind": "p",
            "text": "इन अधिकारों में से किसी का भी प्रयोग करने के लिए, अपने खाते पर पंजीकृत पते से [support@konvertools.com](mailto:support@konvertools.com) पर लिखें। हम GDPR Art. 12(3) के अनुसार एक (1) महीने के भीतर उत्तर देंगे; विशेष रूप से जटिल अनुरोधों के लिए अवधि को दो और महीनों तक बढ़ाया जा सकता है, जिसके मामले में हम आपको पहले महीने के भीतर सूचित करेंगे।"
          },
          {
            "kind": "p",
            "text": "आपके पास **एक पर्यवेक्षी प्राधिकरण के पास शिकायत दर्ज कराने का अधिकार** भी है (GDPR Art. 77)। फ्रांस के उपयोगकर्ताओं के लिए, यह **Commission Nationale de l'Informatique et des Libertés (CNIL)** है — 3 Place de Fontenoy, TSA 80715, 75334 PARIS CEDEX 07, फ्रांस — टेलीफोन +33 (0)1 53 73 22 22 — ऑनलाइन शिकायतें [www.cnil.fr/en/plaintes](https://www.cnil.fr/en/plaintes) पर। अन्य ईयू/ईईए सदस्य राज्यों के उपयोगकर्ताओं के लिए, आप अपने **राष्ट्रीय पर्यवेक्षी प्राधिकरण** के पास शिकायत दर्ज करा सकते हैं (सूची यूरोपीय डेटा संरक्षण बोर्ड द्वारा बनाए रखा जाता है [edpb.europa.eu](https://edpb.europa.eu/about-edpb/about-edpb/members_en))। आप GDPR Art. 79 के तहत न्यायिक उपाय भी तलाश सकते हैं।"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "सेवा प्रदान करने के लिए, हमें निम्नलिखित प्रसंस्करणकर्ताओं के साथ सीमित डेटा साझा करने की आवश्यकता होती है। प्रत्येक की अपनी गोपनीयता नीति है जो यह नियंत्रित करती है कि वे हमारे द्वारा प्राप्त डेटा को कैसे संभालते हैं।"
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase** (सिंगापुर में निगमित, हमारे प्रोजेक्ट के लिए ईयू में होस्ट किया गया) — प्रमाणीकरण, डेटाबेस, फ़ाइल संग्रहण, और Edge Functions। आपके खाता क्रेडेंशियल्स, प्रोफ़ाइल डेटा और (अस्थायी रूप से) किसी भी सर्वर-सहायता प्राप्त टूल के लिए अपलोड की गई फ़ाइल प्राप्त करता है। हमारे उप-प्रसंस्करणकर्ता के रूप में कार्य करता है।",
              "**Mistral AI** (फ्रांस) — बड़े भाषा मॉडल अनुमान: अनुवाद, पुनःलेखन, सारांश, AI मानवीकरण, फ़िशिंग-पैटर्न विश्लेषण, और अन्य पाठ कार्य; ऑडियो प्रतिलेखन (Voxtral); छवि OCR और Vision कार्य (Pixtral)। आपके द्वारा सबमिट किया गया पाठ या छवि अनुमान के लिए Mistral को भेजा जाता है। Mistral ने **API इनपुट का उपयोग अपने मॉडलों को प्रशिक्षित करने के लिए नहीं करने** का अनुबंधात्मक रूप से वचन दिया है।",
              ...
              "**Paddle** (Paddle.com Market Ltd, यूनाइटेड किंगडम) — हमारा व्यापारी अभिलेख: भुगतान प्रसंस्करण, सदस्यता प्रबंधन, और वैश्विक VAT/बिक्री-कर संग्रह और प्रेषण। हम **आपके कार्ड विवरण कभी नहीं देखते या संग्रहीत नहीं करते**। Paddle को आपका ईमेल, भुगतान विधि, और आपने खरीदी गई योजना प्राप्त होती है।",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**वैकल्पिक विज्ञापन**: यदि और जब हम विज्ञापन भागीदारों को सक्षम करते हैं (वर्तमान में Ezoic हमारे कोड में संदर्भित है लेकिन आपके ट्रैफिक के लिए सक्रिय नहीं है), हम एक स्पष्ट सहमति बैनर प्रदर्शित करेंगे और केवल तब विज्ञापन कुकीज़ सेट करेंगे जब आप ऑप्ट-इन करेंगे।"
            ]
          },
          {
            "kind": "p",
            "text": "हम वर्तमान में कोई विश्लेषिकी, ट्रैकिंग पिक्सेल या रीमार्केटिंग टैग नहीं चलाते। यदि हम कोई जोड़ते हैं, तो उपरोक्त कुकी बैनर उन्हें गेट करेगा।"
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**प्रसारण में एन्क्रिप्शन** — सेवा के लिए आने-जाने वाला सभी ट्रैफिक TLS 1.2 या उच्चतर द्वारा संरक्षित है।",
              ...
              "**भुगतान डेटा** — कभी भी हमारे द्वारा नहीं देखा या संग्रहीत नहीं किया जाता; कार्ड भुगतान प्रवाह पूरी तरह से हमारे व्यापारी अभिलेख Paddle (PCI-DSS Level 1 अनुपालन) को सौंपा गया है।",
              "**पहुँच नियंत्रण** — पंक्ति-स्तरीय सुरक्षा नीतियाँ एक उपयोगकर्ता को दूसरे उपयोगकर्ता के डेटा को पढ़ने से रोकती हैं; सेवा-भूमिका कुंजियाँ केवल Edge Functions तक सीमित हैं।",
              "**फ़ाइल स्वच्छता** — कोई भी अपलोड की गई फ़ाइल कभी भी प्रतिधारित नहीं की जाती: ब्राउज़र-केवल टूल कुछ भी प्रसारित नहीं करते, और सर्वर-सहायता प्राप्त टूल तीस (30) मिनट के भीतर अस्थायी बफर्स को हटा देते हैं।",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "GDPR Art. 5(1)(c) के अनुसार, हम केवल इस नीति में निर्धारित उद्देश्यों के लिए आवश्यक डेटा एकत्र करते हैं। ठोस रूप से: हम आपके IP पते को क्षणिक रूटिंग लॉग्स से परे एकत्र नहीं करते, हम आपके ब्राउज़र का फ़िंगरप्रिंट नहीं बनाते, हम व्यवहार संबंधी विश्लेषिकी नहीं चलाते, और हम आपके द्वारा संसाधित किसी भी फ़ाइल का उपयोग AI मॉडलों को प्रशिक्षित करने के लिए नहीं करते। हम विशेष श्रेणी के डेटा (Art. 9) या आपराधिक अपराधों से संबंधित डेटा (Art. 10) एकत्र नहीं करते। डेटा सटीक और अद्यतन रखा जाता है (Art. 5(1)(d)); आप किसी भी समय अपने डैशबोर्ड के माध्यम से या [support@konvertools.com](mailto:support@konvertools.com) पर संपर्क करके किसी भी अशुद्धि को ठीक करवा सकते हैं।"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "जॉब मेटाडेटा: स्वचालित रूप से दो (2) घंटे के बाद हटा दिया जाता है।",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "सेवा **सोलह (16) वर्ष से कम उम्र के बच्चों के लिए निर्देशित नहीं है**। यदि आप इस उम्र से कम हैं तो आपको खाता नहीं बनाना चाहिए। हम जानबूझकर नाबालिगों से डेटा एकत्र नहीं करते; यदि हमें पता चलता है कि हमने ऐसा किया है, तो हम इसे हटा देंगे।"
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Tarayıcı tabanlı araçlar** (görüntü dönüştürücüler, pdf-lib kullanan PDF araçları, FFmpeg.wasm ile çalışan ses ve video dönüştürmeleri, kod araçları, hesap makineleri, QR oluşturucular, parola ihlali kontrolcüsü, çoğu yardımcı program) **tamamen web tarayıcınızda WebAssembly aracılığıyla çalışır**. Dosyanız veya girdiniz hiçbir zaman sunucularımıza iletilmez. Onu okumamızın teknik bir yolu yoktur.",
              "**Sunucu destekli araçlar** (AI transkripsiyonu, AI çevirisi, AI metin görevleri, video altyazılarını yakma, URL tarayıcısı, phishing algılayıcısı, SSL sertifika kontrolcüsü ve diğer bazıları) bir arka uca bir şey göndermeleri gerekir. Her durumda dosya veya metin gerçek zamanlı olarak işlenir ve geçici depolamadan otuz (30) dakika içinde silinir.",
              "Hiçbir yüklenen dosyanın içeriğini kalıcı bir konuma kaydetmiyoruz, dosyalarınızı AI modellerini eğitmek için kullanmıyoruz ve sonuç talep ettiğiniz hizmet dışında üçüncü taraflara satmıyor, kiralamıyor veya paylaşmıyoruz."
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Hesap bilgileri**: e-posta adresiniz; Supabase Auth tarafından yönetilen, tuzlanmış ve özetlenmiş parola kopyası (düz metni hiç görmüyoruz veya saklamıyoruz); Google ile giriş yaparsanız isteğe bağlı görüntü adı ve avatar URL'si.",
              "**Abonelik durumu**: mevcut plan (ücretsiz / Pro / İş), Paddle müşteri tanımlayıcısı ve en son yenileme tarihleriniz.",
              "**Kullanım sayaçları**: profil satırınızda yerinde güncellenen özet kota sayaçları (ör. \"bugün 3 AI çalışması kullanıldı\", \"aylık 420 AI çalışması kullanıldı\"). **Çalışma kaydı tutmuyoruz**.",
              "**İş meta verileri (geçici)**: bir sunucu destekli araç çıktı ürettiğinde (ör. transkripsiyondan .srt dosyası), araç adı, sonuç indirme URL'si, kaynak dil ve tamamlanma zaman damgası kaydedilir. Bu satırlar otomatik olarak **iki (2) saat** sonra silinir. Hiçbir zaman dosyanızın içeriğini içermezler.",
              "**Onay kayıtları**: bu Şartları ve Gizlilik Politikamızı kabul ettiğiniz tarih ve saat ile pazarlama e-postalarına katılmayı tercih edip etmediğiniz. Hesabınızın silinmesinden sonraki beş (5) yıl boyunca yasal kanıt süresi boyunca saklanır."
            ]
          },
          {
            "kind": "p",
            "text": "**Toplamıyoruz**: IP adresinizi (yalnızca Supabase ve barındırma sağlayıcımızın hız sınırlaması ve güvenlik günlüğü için geçici kullanımının ötesinde), tarayıcı parmak izinizi, davranışsal izleme olaylarını, ekran kayıtlarınızı veya herhangi bir biyometrik veriyi topluyoruz."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Tarayıcı tabanlı araçlar**: sıfır iletim. Dosya tarayıcınız tarafından belleğe okunur, sonuç yerel olarak üretilir ve doğrudan indirirsiniz. Dosya hakkında hiçbir şeyi günlüğe kaydetmiyoruz.",
              "**AI transkripsiyonu / çevirisi / OCR / phishing analizi**: dosya veya metin anında Supabase Edge Function'a akar, ardından ilgili AI sağlayıcısına (bölüm 7'ye bakınız) gönderilir. Sonuç size iletilir ve geçici yükleme arabelleği otuz (30) dakika içinde silinir. Özel depolama alanımıza yazılan sonuç dosyaları altmış (60) dakika boyunca imzalı-URL erişimine açıktır ve fiziksel olarak otuz (30) dakika içinde silinir.",
              ...
              "**URL tarayıcısı / SSL kontrolcüsü**: yalnızca girdiğiniz URL veya ana bilgisayar adı iletilir (URL tarayıcısı için Google Safe Browsing'e, SSL kontrolcüsü için canlı TLS bağlantısı açmak için). Çevre sayfa içerikleri değil."
            ]
          }
        ]
      },
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**Sözleşmenin ifası** (Mad. 6(1)(b)) — hesap oluşturduğunuzda ve ücretli özellikleri kullandığınızda, işleme Hizmeti sunmak için gereklidir.",
              ...
              "**Yasal yükümlülük** (Mad. 6(1)(c)) — Fransız vergi hukuku gereği fatura kayıtlarının on yıl boyunca saklanması."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "27 Nisan 2016 tarihli Yönetmelik (AB) 2016/679 (\"GDPR\") kapsamında veri sahibi olarak aşağıdaki haklara sahipsiniz; herhangi bir zamanda ve ücretsiz olarak hesabınıza kayıtlı e-posta adresinden kullanılabilirler:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**Onayın geri çekilmesi hakkı** (GDPR Mad. 7(3)) — onaya dayalı işleme için, onayı herhangi bir zamanda hukuka uygun önceki işlemenin geçerliliğini etkilemeden geri çekebilirsiniz.",
              "**Otomatik karar vermenin konusu olmama hakkı** (GDPR Mad. 22) — işlememizin hiçbiri size yasal sonuçlar doğuran yalnızca otomatik kararlar içermemektedir."
            ]
          },
          {
            "kind": "p",
            "text": "Bu haklardan herhangi birini kullanmak için, hesabınıza kayıtlı e-posta adresinden [support@konvertools.com](mailto:support@konvertools.com) adresine yazın. GDPR Mad. 12(3) gereği bir (1) ay içinde yanıt vereceğiz; özellikle karmaşık talepler için süre iki ay daha uzatılabilir, bu durumda ilk ay içinde sizi bilgilendireceğiz."
          },
          {
            "kind": "p",
            "text": "Ayrıca **bir denetim makamına şikayette bulunma hakkına** sahipsiniz (GDPR Mad. 77). Fransa'daki kullanıcılar için bu, **Bilgi Teknolojileri ve Özgürlükler Ulusal Komisyonu (CNIL)** — 3 Place de Fontenoy, TSA 80715, 75334 PARIS CEDEX 07, Fransa — telefon +33 (0)1 53 73 22 22 — çevrimiçi şikayetler [www.cnil.fr/fr/plaintes](https://www.cnil.fr/fr/plaintes). Diğer AB/EEA üyesi devletlerdeki kullanıcılar, **ulusal denetim makamınıza** şikayette bulunabilirsiniz (liste Avrupa Veri Koruma Kurulu tarafından [edpb.europa.eu](https://edpb.europa.eu/about-edpb/about-edpb/members_tr) adresinde tutulmaktadır). Ayrıca GDPR Mad. 79 uyarınca yargı yoluna başvurabilirsiniz."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase** (Singapur merkezli, projemiz için AB'de barındırılan) — kimlik doğrulama, veritabanı, dosya depolama ve Edge Functions. Hesap bilgilerinizi, profil verilerinizi ve geçici olarak sunucu destekli bir araç için yüklediğiniz herhangi bir dosyayı alır. Alt işleyicimiz olarak hareket eder.",
              "**Mistral AI** (Fransa) — çeviri, yeniden ifade, özetleme, AI insanlaştırıcı, phishing kalıbı analizi ve diğer metin görevleri için büyük dil modeli çıkarımı; ses transkripsiyonu (Voxtral); görüntü OCR ve Vision görevleri (Pixtral). Gönderdiğiniz metin veya görüntü çıkarım için Mistral'e gönderilir. Mistral, API girdilerini modellerini eğitmek için kullanmayacağına dair sözleşmeyle taahhüt etmiştir.",
              ...
              "**HaveIBeenPwned** (Have I Been Pwned LLC) — yalnızca Parola İhlali Kontrolcüsünü kullanırken ve yalnızca SHA-1 özetinizin ilk 5 karakteri (k-anonimlik). Tarayıcınızdan doğrudan sorgulanır, sunucularımız aracılığıyla değil.",
              "**Paddle** (Paddle.com Market Ltd, Birleşik Krallık) — Ödeme Hizmet Sağlayıcımız: ödeme işleme, abonelik yönetimi ve dünya çapında KDV/ satış vergisi tahsilatı ve ödenmesi. **Kart bilgilerinizi hiç görmüyoruz veya saklamıyoruz**. Paddle, e-postanızı, ödeme yönteminizi ve satın aldığınız planı alır.",
              "**Resend** (ABD) — işlemsel e-posta gönderimi (hesap onayı, ödeme makbuzu, parola sıfırlama). E-posta adresinizi ve gönderdiğimiz e-posta içeriğini alır.",
          ...
          {
            "kind": "p",
            "text": "Bu işleyicilerden herhangi biri Avrupa Ekonomik Alanı dışında faaliyet gösteriyorsa, aktarımlar Avrupa Komisyonu'nun Standart Sözleşme Şartları (SCC) veya eşdeğer bir aktarım mekanizması tarafından düzenlenir."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**İsteğe bağlı reklamcılık**: reklam ortaklarını etkinleştirdiğimizde (şu anda kodumuzda Ezoic referans veriliyor ancak trafiğiniz için henüz etkinleştirilmedi), net bir onay banner'ı gösterecek ve yalnızca onay verdiğinizde reklam çerezleri ayarlayacağız."
            ]
          },
          {
            "kind": "p",
      ...
      {
        "id": "security",
        "title": "9. İşlemenin güvenliği (GDPR Mad. 32)",
        "blocks": [
          {
            "kind": "p",
            "text": "GDPR Mad. 32 uyarınca, riske uygun bir güvenlik düzeyi sağlamak için uygun teknik ve organizasyonel önlemler uygularız:"
          },
          {
            "kind": "ul",
            "items": [
              "**İletimde şifreleme** — Hizmete gelen ve giden tüm trafik TLS 1.2 veya üzeri ile korunur.",
              "**Dinlenmede şifreleme** — Supabase, hesabınızın verileri de dahil olmak üzere alt veritabanını AES-256 ile şifreler.",
              "**Parola işleme** — parolanız Supabase Auth tarafından özetlenir ve düz metin olarak saklanmaz. Ayrıca yeni parolalarınızı müşteri tarafında HaveIBeenPwned k-anonimlik API'sine karşı kontrol ederek bilinen ihlal edilmiş parolaları reddederiz.",
              "**Ödeme verileri** — asla görmüyoruz veya saklamıyoruz; kart ödeme akışı tamamen Paddle'a, Ödeme Hizmet Sağlayıcımıza (PCI-DSS Seviye 1 uyumlu) devredilir.",
              "**Erişim kontrolü** — satır düzeyindeki güvenlik politikaları bir kullanıcının diğer bir kullanıcının verilerini okumasını engeller; hizmet rolü anahtarları yalnızca Edge Functions için sınırlandırılmıştır.",
              "**Dosya hijyeni** — yüklenen hiçbir dosya asla saklanmaz: tarayıcı tabanlı araçlar hiçbir şey iletmez ve sunucu destekli araçlar geçici arabellekleri 30 dakika içinde siler.",
              "**Zafiyet yanıtı** — güvenlik sorunları [support@konvertools.com](mailto:support@konvertools.com) adresine güvenilir bir şekilde bildirilebilir."
            ]
          },
          {
            "kind": "p",
            "text": "Bu önlemler rağmen, hiçbir sistem mükemmel şekilde güvenli değildir; herhangi bir çevrimiçi hizmetteki kalıntı riski kabul edersiniz."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "GDPR Mad. 5(1)(c) uyarınca, yalnızca bu Politikada belirtilen amaçlar için kesinlikle gerekli olan verileri toplarız. Somut olarak: IP adresinizi geçici yönlendirme günlüklerinin ötesinde toplamıyoruz, tarayıcınızı parmak izine almayız, davranışsal analitik çalıştırmıyoruz ve işlediğiniz hiçbir dosyayı AI modellerini eğitmek için kullanmıyoruz. Özel kategori verileri (Mad. 9) veya suç niteliğindeki verileri (Mad. 10) toplamıyoruz. Veriler doğru ve güncel tutulur (Mad. 5(1)(d)); herhangi bir yanlışlığı hesabınızın kontrol panelinden veya [support@konvertools.com](mailto:support@konvertools.com) adresine yazarak düzeltebilirsiniz."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "Onay kayıtları: hesabınızın süresi boyunca ve ardından beş (5) yıl boyunca yasal kanıt süresi olarak saklanır."
            ]
          }
        ]
      },
    ...
    "sections": [
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Alat berbantuan server** (transkripsi AI, terjemahan AI, tugas teks AI, pembakaran subtitle video, pemindai URL, detektor phishing, pemeriksa sertifikat SSL, dan sejumlah kecil lainnya) memerlukan pengiriman sesuatu ke backend. Dalam setiap kasus, file atau teks diproses secara real-time dan dihapus dari penyimpanan sementara dalam waktu tiga puluh (30) menit.",
              "Kami tidak pernah menyimpan konten file yang diunggah di lokasi mana pun secara persisten, tidak pernah menggunakan unggahan Anda untuk melatih model AI, serta tidak pernah menjual, menyewakan, atau membagikannya kepada pihak ketiga untuk tujuan apa pun selain menyampaikan hasil yang Anda minta."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Untuk kepentingan Peraturan Umum Perlindungan Data Uni Eropa (Regulation (EU) 2016/679, \"GDPR\"), pengendali data adalah penerbit Layanan. Hubungi untuk pertanyaan privasi apa pun: [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Status langganan**: rencana saat ini (gratis / Pro / Bisnis), pengenal pelanggan Paddle, serta tanggal pembaruan langganan terakhir Anda.",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Transkripsi / terjemahan / OCR / analisis phishing AI**: file atau teks dialirkan ke Supabase Edge Function kami, yang segera meneruskannya ke penyedia AI terkait (lihat bagian 7) untuk inferensi. Hasil dikembalikan kepada Anda dan buffer unggahan sementara dibuang. File hasil yang ditulis ke bucket penyimpanan pribadi kami dapat diakses melalui URL yang ditandatangani selama enam puluh (60) menit dan secara fisik dihapus dalam waktu tiga puluh (30) menit setelah pembuatan.",
              "**Pemeriksa kebocoran kata sandi**: kata sandi Anda tidak pernah meninggalkan peramban Anda. Kami menghash lokalnya dengan SHA-1 dan menanyakan HaveIBeenPwned menggunakan k-anonimitas — hanya lima karakter pertama dari hash yang dikirim. Kata sandi dan hash lengkap tidak pernah ditransmisikan.",
              "**Pemindai URL / pemeriksa SSL**: hanya URL atau nama host yang Anda ketik yang ditransmisikan (ke Google Safe Browsing untuk pemindai URL, atau digunakan untuk membuka koneksi TLS langsung untuk pemeriksa SSL). Tidak ada konten halaman di sekitarnya."
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "kind": "p",
            "text": "Untuk menjalankan hak-hak ini, tulis ke [support@konvertools.com](mailto:support@konvertools.com) dari alamat yang terdaftar di akun Anda. Kami akan menanggapi dalam waktu satu (1) bulan, sebagaimana disyaratkan oleh GDPR Pasal 12(3); periode dapat diperpanjang hingga dua bulan tambahan untuk permintaan yang sangat kompleks, dalam hal ini kami akan memberi tahu Anda dalam bulan pertama."
          },
          {
            "kind": "p",
            "text": "Anda juga memiliki **hak untuk mengajukan pengaduan kepada otoritas pengawas** (GDPR Pasal 77). Untuk pengguna di Prancis, ini adalah **Komisi Nasional untuk Informatika dan Kebebasan (CNIL)** — 3 Place de Fontenoy, TSA 80715, 75334 PARIS CEDEX 07, Prancis — telepon +33 (0)1 53 73 22 22 — pengaduan online di [www.cnil.fr/en/plaintes](https://www.cnil.fr/en/plaintes). Untuk pengguna di negara-negara anggota UE/EEA lainnya, Anda dapat mengajukan pengaduan kepada **otoritas pengawas nasional Anda** (daftarnya tersedia di situs [edpb.europa.eu](https://edpb.europa.eu/about-edpb/about-edpb/members_en)). Anda juga dapat mencari upaya hukum berdasarkan GDPR Pasal 79."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase** (berbadan hukum Singapura, dihosting di UE untuk proyek kami) — otentikasi, basis data, penyimpanan file, dan Edge Functions. Menerima kredensial akun, data profil, serta (sementara) file apa pun yang Anda unggah untuk alat berbantuan server. Bertindak sebagai sub-pemroses kami.",
              ...
              "**HaveIBeenPwned** (Have I Been Pwned LLC) — hanya ketika Anda menggunakan Pemeriksa Kebocoran Kata Sandi, dan hanya lima karakter pertama dari hash SHA-1 kata sandi Anda (k-anonimitas). Dikueri langsung dari peramban Anda, bukan melalui server kami.",
              "**Paddle** (Paddle.com Market Ltd, Inggris Raya) — Merchant of Record kami: pemrosesan pembayaran, manajemen langganan, serta pemungutan dan penyetoran PPN/pajak penjualan global. Kami **tidak pernah melihat atau menyimpan** detail kartu Anda. Paddle menerima email, metode pembayaran, serta rencana yang Anda beli.",
              ...
              "**Vercel** (AS) — jaringan pengiriman konten untuk halaman statis. Menerima metadata lalu lintas web standar (IP, user-agent, URL yang diminta) untuk perutean dan pencegahan penyalahgunaan. Disimpan sesuai dengan kebijakan retensi log Vercel."
            ]
          },
          {
            "kind": "p",
            "text": "Jika salah satu pemroses ini beroperasi di luar Kawasan Ekonomi Eropa, transfer tunduk pada Klausul Kontrak Standar (SCCs) Komisi Eropa atau mekanisme transfer setara lainnya."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Sesuai dengan GDPR Pasal 32, kami menerapkan tindakan teknis dan organisasi yang tepat untuk memastikan tingkat keamanan yang sesuai dengan risikonya:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**Data pembayaran** — tidak pernah dilihat atau disimpan oleh kami; alur pembayaran kartu sepenuhnya didelegasikan ke Paddle, Merchant of Record kami (PCI-DSS Level 1 compliant).",
              ...
              "**Kebersihan file** — tidak ada file yang diunggah yang pernah disimpan: alat berbasis peramban tidak pernah mentransmisikan apa pun, dan alat berbantuan server menghapus buffer sementara dalam waktu 30 menit.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Sesuai dengan GDPR Pasal 5(1)(c), kami hanya mengumpulkan data yang sangat diperlukan untuk tujuan yang ditetapkan dalam Kebijakan ini. Secara konkret: kami tidak mengumpulkan alamat IP Anda di luar log routing sementara, kami tidak melakukan sidik jari peramban Anda, kami tidak menjalankan analitik perilaku, serta kami tidak pernah menggunakan file apa pun yang Anda proses untuk melatih model AI. Kami tidak mengumpulkan data kategori khusus (Pasal 9) atau data yang berkaitan dengan tindak pidana (Pasal 10). Data disimpan akurat dan terkini (Pasal 5(1)(d)); Anda dapat memperbaiki ketidakakuratan kapan saja melalui dasbor Anda atau dengan menghubungi [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
    ...
    "sections": [
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "Chúng tôi không bao giờ lưu trữ nội dung của bất kỳ tệp nào đã tải lên ở bất kỳ vị trí bền vững nào, không bao giờ sử dụng các tệp tải lên của bạn để đào tạo mô hình AI, và không bao giờ bán, cho thuê hoặc chia sẻ chúng với bên thứ ba vì bất kỳ mục đích nào ngoài việc cung cấp kết quả bạn yêu cầu."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Theo quy định của Quy định chung về bảo vệ dữ liệu của EU (Quy định (EU) 2016/679, \"GDPR\"), đơn vị kiểm soát dữ liệu là nhà xuất bản của Dịch vụ. Liên hệ cho bất kỳ yêu cầu về quyền riêng tư: [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Trạng thái đăng ký**: gói hiện tại (miễn phí / Pro / Doanh nghiệp), mã định danh khách hàng Paddle, và ngày gia hạn gần nhất của bạn.",
              "**Bộ đếm sử dụng**: bộ đếm hạn ngạch tổng hợp (ví dụ: \"3 lượt chạy AI hôm nay\", \"420 lượt chạy AI hàng tháng đã sử dụng\") được cập nhật tại chỗ trên hàng hồ sơ của bạn. Chúng tôi **không** ghi lại các bản ghi theo lượt chạy.",
              ...
              "**Bản ghi sự đồng thuận**: ngày và giờ bạn chấp nhận Điều khoản và Chính sách Bảo mật của chúng tôi, và liệu bạn có chọn nhận email tiếp thị hay không. Được lưu giữ trong suốt thời gian tồn tại tài khoản của bạn cộng với khoảng thời gian bằng chứng pháp lý là năm (5) năm sau khi xóa."
            ]
          },
          {
            "kind": "p",
            "text": "Chúng tôi **không** thu thập: địa chỉ IP của bạn (ngoài việc sử dụng tạm thời mà Supabase và nhà cung cấp lưu trữ của chúng tôi thực hiện cho giới hạn tốc độ và nhật ký bảo mật), dấu vân tay trình duyệt, sự kiện theo dõi hành vi, ghi hình màn hình của bạn hoặc bất kỳ dữ liệu sinh trắc học nào."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Như đã nêu trong mục 1, nội dung tệp bạn xử lý không bao giờ được chúng tôi lưu trữ. Vòng đời chính xác là:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**Chuyển ngữ / dịch thuật / OCR AI / phân tích lừa đảo**: tệp hoặc văn bản được truyền theo luồng đến Edge Function của Supabase, nơi ngay lập tức chuyển tiếp đến nhà cung cấp AI liên quan (xem mục 7) để suy luận. Kết quả được trả về cho bạn và bộ đệm tải lên tạm thời bị loại bỏ. Các tệp kết quả được ghi vào nhóm lưu trữ riêng của chúng tôi có thể truy cập qua URL ký kết trong sáu mươi (60) phút và bị xóa vật lý trong vòng ba mươi (30) phút sau khi tạo.",
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**Thực hiện hợp đồng** (Art. 6(1)(b)) — khi bạn tạo tài khoản và sử dụng tính năng trả phí, xử lý là cần thiết để cung cấp Dịch vụ.",
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Quyền truy cập** (GDPR Art. 15) — xác nhận rằng chúng tôi xử lý dữ liệu của bạn và nhận bản sao của nó.",
              "**Quyền sửa chữa** (GDPR Art. 16) — sửa dữ liệu không chính xác hoặc không đầy đủ.",
              "**Quyền xóa / quyền được quên** (GDPR Art. 17) — xóa dữ liệu của bạn khi cơ sở pháp lý xử lý không còn nữa.",
              ...
              "**Quyền phản đối** (GDPR Art. 21) — phản đối bất kỳ lúc nào, trên cơ sở tình huống cụ thể của bạn, đối với xử lý dựa trên lợi ích hợp pháp của chúng tôi.",
              "**Quyền rút lại sự đồng thuận** (GDPR Art. 7(3)) — đối với xử lý dựa trên sự đồng thuận, rút lại bất kỳ lúc nào mà không ảnh hưởng đến tính hợp pháp của xử lý trước đó.",
              "**Quyền không chịu quyết định tự động** (GDPR Art. 22) — không có xử lý nào của chúng tôi liên quan đến quyết định tự động duy nhất tạo ra hiệu lực pháp lý đối với bạn."
            ]
          },
          {
            "kind": "p",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**HaveIBeenPwned** (Have I Been Pwned LLC) — chỉ khi bạn sử dụng Công cụ kiểm tra vi phạm mật khẩu, và chỉ năm ký tự đầu tiên của hàm băm SHA-1 mật khẩu của bạn (phương pháp k-anonymity). Truy vấn trực tiếp từ trình duyệt của bạn, không thông qua máy chủ của chúng tôi.",
              "**Paddle** (Paddle.com Market Ltd, Vương quốc Anh) — Nhà ghi nhận thương mại của chúng tôi: xử lý thanh toán, quản lý đăng ký và thu thuế VAT/doanh thu toàn cầu. Chúng tôi **không bao giờ nhìn thấy hoặc lưu trữ** chi tiết thẻ của bạn. Paddle nhận địa chỉ email, phương thức thanh toán và gói bạn đã mua.",
          ...
          {
            "kind": "p",
            "text": "Bất kỳ nhà xử lý nào trong số này hoạt động bên ngoài Khu vực Kinh tế Châu Âu, việc chuyển dữ liệu được điều chỉnh bởi Các điều khoản hợp đồng tiêu chuẩn (SCCs) của Ủy ban Châu Âu hoặc cơ chế chuyển dữ liệu tương đương."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Quảng cáo tùy chọn**: nếu và khi chúng tôi kích hoạt đối tác quảng cáo (hiện tại Ezoic được tham chiếu trong mã của chúng tôi nhưng chưa được kích hoạt cho lưu lượng truy cập của bạn), chúng tôi sẽ hiển thị biểu ngữ đồng thuận rõ ràng và chỉ thiết lập cookie quảng cáo sau khi bạn chọn nhận."
            ]
          },
          {
            "kind": "p",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Theo GDPR Art. 32, chúng tôi thực hiện các biện pháp kỹ thuật và tổ chức phù hợp để đảm bảo mức độ bảo mật phù hợp với rủi ro:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**Dữ liệu thanh toán** — không bao giờ được chúng tôi nhìn thấy hoặc lưu trữ; quy trình thanh toán thẻ được ủy quyền hoàn toàn cho Paddle, Nhà ghi nhận thương mại của chúng tôi (tuân thủ PCI-DSS Cấp 1).",
              "**Kiểm soát truy cập** — chính sách bảo mật cấp hàng ngăn chặn người dùng này đọc dữ liệu của người dùng khác; khóa vai trò dịch vụ bị hạn chế đối với Edge Functions.",
              ...
              "**Phản ứng lỗ hổng bảo mật** — vấn đề bảo mật có thể được báo cáo bí mật đến [support@konvertools.com](mailto:support@konvertools.com)."
            ]
          },
          {
            "kind": "p",
            "text": "Bất chấp các biện pháp này, không hệ thống nào hoàn toàn an toàn; bạn chấp nhận rủi ro tồn tại vốn có của bất kỳ dịch vụ trực tuyến nào."
          }
        ]
      },
      {
        "id": "minimisation",
        "title": "10. Giảm thiểu dữ liệu và giới hạn mục đích (GDPR Art. 5)",
        "blocks": [
          {
            "kind": "p",
            "text": "Theo GDPR Art. 5(1)(c), chúng tôi chỉ thu thập dữ liệu cần thiết cho các mục đích đã nêu trong Chính sách này. Cụ thể: chúng tôi không thu thập địa chỉ IP của bạn ngoài nhật ký định tuyến tạm thời, chúng tôi không tạo dấu vân tay trình duyệt, chúng tôi không chạy phân tích hành vi, và chúng tôi không bao giờ sử dụng bất kỳ tệp nào bạn xử lý để đào tạo mô hình AI. Chúng tôi không thu thập dữ liệu danh mục đặc biệt (Art. 9) hoặc dữ liệu liên quan đến hành vi phạm tội (Art. 10). Dữ liệu được giữ chính xác và cập nhật (Art. 5(1)(d)); bạn có thể sửa bất kỳ thông tin không chính xác nào bất kỳ lúc nào thông qua bảng điều khiển của mình hoặc bằng cách liên hệ với [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "Tệp kết quả trong nhóm lưu trữ: bị xóa vật lý trong vòng ba mươi (30) phút sau khi tạo.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Mọi câu hỏi về chính sách này hoặc dữ liệu của bạn — bao gồm thực hiện bất kỳ quyền GDPR nào của bạn (xem mục 6) — hãy viết thư đến [support@konvertools.com](mailto:support@konvertools.com). Đây là hộp thư duy nhất của chúng tôi cho các yêu cầu về quyền riêng tư, bảo mật, thanh toán và hỗ trợ chung. Bạn cũng có thể khiếu nại lên Ủy quyền bảo vệ dữ liệu Pháp CNIL (3 Place de Fontenoy, TSA 80715, 75334 Paris Cedex 07 — [www.cnil.fr](https://www.cnil.fr)) hoặc với cơ quan giám sát của quốc gia cư trú của bạn."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Webbläsarbaserade verktyg** (bildkonverterare, PDF-verktyg som använder pdf-lib, ljud- och videokonverteringar med FFmpeg.wasm, kodverktyg, miniräknare, QR-generatorer, lösenordsskyddskontrollen, de flesta verktygen) körs **helt och hållet i din webbläsare via WebAssembly**. Din fil eller indata skickas aldrig till våra servrar. Vi har inga tekniska möjligheter att läsa den.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Den enda personliga data vi lagrar i vår databas är:"
          },
          {
            "kind": "ul",
            "items": [
              "**Kontouppgifter**: din e-postadress; en saltad, hashad kopia av ditt lösenord (hanteras av Supabase Auth — vi ser aldrig eller lagrar aldrig det i klartext); valfritt visningsnamn och avatar-URL om du loggar in med Google.",
              "**Abonnemangstillstånd**: aktuell plan (gratis / Pro / Business), Paddle-kundidentifierare och datum för dina senaste förnyelser.",
              ...
              "**Jobbmetadata (tillfällig)**: när ett serverassisterat verktyg producerar ett resultat (t.ex. en .srt-fil från transkription) registrerar vi verktygets namn, resultatets nedladdnings-URL, källspråket och en slutförningstidpunkt. Dessa rader raderas automatiskt efter **två (2) timmar**. De innehåller aldrig innehållet i din fil.",
              "**Samtyckesposter**: datum och tidpunkt för när du accepterade dessa villkor och vår Integritetspolicy, samt om du valde att tacka ja till marknadsföringsmejl. Bevaras under hela din kontoperiod plus en rättslig bevisperiod på fem (5) år efter radering."
            ]
          },
          {
            "kind": "p",
            "text": "Vi samlar **inte** in: din IP-adress (utom den tillfälliga användning Supabase och vår hosting-leverantör gör av den för hastighetsbegränsning och säkerhetsloggning), din webbläsaravtryck, beteendespårningshändelser, dina skärminspelningar eller någon biometrisk data."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Webbläsarbaserade verktyg**: ingen överföring. Filen läses in i minnet av din webbläsare, resultatet produceras lokalt och du laddar ner det direkt. Vi loggar ingenting om filen själv.",
              ...
              "**Lösenordsskyddskontroll**: ditt lösenord lämnar aldrig din webbläsare. Vi hashar det lokalt med SHA-1 och frågar HaveIBeenPwned med k-anonymitet — endast de första 5 tecknen av hashen skickas. Lösenordet och den fullständiga hashen överförs aldrig.",
              "**URL-skanner / SSL-kontroll**: endast den URL eller värdnamn du skriver in överförs (till Google Safe Browsing för URL-skannern, eller används för att öppna en live TLS-anslutning för SSL-kontrollen). Inget kringliggande sidinnehåll."
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Som registrerad person enligt Förordning (EU) 2016/679 av den 27 april 2016 (\"GDPR\") har du följande rättigheter, som du kan utöva när som helst och utan kostnad från den e-postadress som är registrerad på ditt konto:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**Rätt till radering / glömmelse** (GDPR Art. 17) — få dina uppgifter raderade när de rättsliga grunderna för bearbetning inte längre gäller.",
              ...
              "**Rätt att återkalla samtycke** (GDPR Art. 7(3)) — för bearbetning som baseras på samtycke, återkalla det när som helst utan att påverka lagligheten i tidigare bearbetning.",
              "**Rätt att inte bli föremål för automatiserat beslutsfattande** (GDPR Art. 22) — ingen av vår bearbetning innebär enbart automatiserade beslut som får rättsliga effekter för dig."
            ]
          },
          {
            "kind": "p",
          ...
          {
            "kind": "p",
            "text": "Du har också **rätten att inlämna klagomål till en tillsynsmyndighet** (GDPR Art. 77). För användare i Frankrike är detta **Commission Nationale de l'Informatique et des Libertés (CNIL)** — 3 Place de Fontenoy, TSA 80715, 75334 PARIS CEDEX 07, Frankrike — telefon +33 (0)1 53 73 22 22 — klagomål online på [www.cnil.fr/fr/plaintes](https://www.cnil.fr/fr/plaintes). För användare i andra EU/EES-medlemsstater kan du lämna in ett klagomål till din **nationella tillsynsmyndighet** (listan finns på Europeiska dataskyddsstyrelsens webbplats [edpb.europa.eu](https://edpb.europa.eu/about-edpb/about-edpb/members_en)). Du kan också söka rättslig prövning enligt GDPR Art. 79."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase** (Singapore-baserat, värd i EU för vårt projekt) — autentisering, databas, filförvaring och Edge Functions. Tar emot dina kontolegitimationer, profiluppgifter och (tillfälligt) vilken fil du än laddar upp för ett serverassisterat verktyg. Verkar som vår underleverantör.",
              "**Mistral AI** (Frankrike) — inferens med stora språkmodeller för översättning, omformulering, sammanfattning, den AI-mänskliggöraren, phishingmönsteranalys och andra textuppgifter; ljudtranskription (Voxtral); bild-OCR och Vision-uppgifter (Pixtral). Den text eller bild du skickar vidarebefordras till Mistral för inferens. Mistral har kontraktuellt åtagit sig att **inte** använda API-inmatningar för att träna sina modeller.",
              ...
              "**HaveIBeenPwned** (Have I Been Pwned LLC) — endast när du använder Lösenordsskyddskontrollen, och endast de första 5 tecknen av SHA-1-hashen av ditt lösenord (k-anonymitet). Frågas direkt från din webbläsare, inte via våra servrar.",
              "**Paddle** (Paddle.com Market Ltd, Storbritannien) — vår försäljningspartner: betalningshantering, abonnemangsadministration och global moms/mervärdesskattesamling och redovisning. Vi **ser eller lagrar aldrig** dina kortuppgifter. Paddle tar emot din e-post, betalningsmetod och den plan du köpt.",
              "**Resend** (USA) — transaktionell e-postleverans (kontbekräftelse, betalningskvittens, återställning av lösenord). Tar emot din e-postadress och den e-post som vi skickar.",
          ...
          {
            "kind": "p",
            "text": "Där någon av dessa processorer verkar utanför det Europeiska ekonomiska samarbetsområdet (EES) regleras överföringar av Europeiska kommissionens standardavtalsklausuler (SCC) eller en motsvarande överföringsmekanism."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Nödvändiga**: NEXT_LOCALE (kommer ihåg ditt valda språk) och Supabase-sessioncookies (sb-*-auth-token) när du är inloggad. Dessa kräver inget samtycke enligt GDPR.",
          ...
          {
            "kind": "p",
            "text": "Vi kör för närvarande inga analyser, spårningspixlar eller remarketingtaggar. Om vi lägger till några kommer cookie-bannern ovan att styra dem."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Kryptering i vila** — Supabase krypterar den underliggande databasen (inklusive dina kontouppgifter) med AES-256.",
              ...
              "**Betalningsdata** — aldrig sedda eller lagrade av oss; kortbetalningsflödet är helt delegerat till Paddle, vår försäljningspartner (PCI-DSS nivå 1-kompatibel).",
              "**Åtkomstkontroll** — radnivå säkerhetspolicys förhindrar att en användare läser en annan användares data; service-rollnycklar är begränsade till Edge Functions.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "I enlighet med GDPR Art. 5(1)(c) samlar vi endast in den data som är strikt nödvändig för de ändamål som anges i denna policy. Konkret: vi samlar inte in din IP-adress utöver tillfälliga routingloggar, vi fingeravtrycker inte din webbläsare, vi kör ingen beteendeanalys och vi använder aldrig någon fil du bearbetar för att träna AI-modeller. Vi samlar inte in särskilda kategorier av uppgifter (Art. 9) eller uppgifter som rör brott (Art. 10). Uppgifterna hålls korrekta och aktuella (Art. 5(1)(d)); du kan korrigera eventuella felaktigheter när som helst via din instrumentpanel eller genom att kontakta [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "Profildata: bevaras under hela din kontoperiod, raderas inom trettio (30) dagar efter kontostängning.",
              ...
              "Samtyckesposter: bevaras under hela din kontoperiod plus fem (5) år därefter som rättsligt bevis."
            ]
          }
        ]
      },
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Usługa Konvertools (zwana dalej „Serwisem”) działa jako zestaw narzędzi stawiających prywatność na pierwszym miejscu. Najważniejsze zobowiązanie, jakie podejmujemy, jest następujące:"
          },
          {
            "kind": "ul",
            "items": [
              "**Narzędzia działające wyłącznie w przeglądarce** (konwertery obrazów, narzędzia PDF korzystające z pdf-lib, konwersje audio i wideo zasilane przez FFmpeg.wasm, narzędzia do kodu, kalkulatory, generatory kodów QR, sprawdzacz naruszeń haseł, większość narzędzi pomocniczych) działają **całkowicie wewnątrz przeglądarki internetowej za pomocą WebAssembly**. Twój plik lub dane wejściowe nigdy nie są przesyłane na nasze serwery. Nie mamy technicznych możliwości, aby je odczytać.",
              ...
              "Nigdy nie przechowujemy treści żadnego przesłanego pliku w żadnym trwałym miejscu, nie używamy Twoich przesłanych plików do trenowania modeli AI ani nie sprzedajemy, nie wynajmujemy ani nie udostępniamy ich stronom trzecim w jakimkolwiek celu poza dostarczeniem wyniku, którego zażądałeś."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Na potrzeby Rozporządzenia Parlamentu Europejskiego i Rady (UE) 2016/679 („RODO”) administratorem danych jest wydawca Serwisu. Kontakt w sprawie wszelkich zapytań dotyczących prywatności: [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Dane uwierzytelniające konta**: Twój adres e-mail; sól i skrót hasła (zarządzane przez Supabase Auth — nigdy nie widzimy ani nie przechowujemy hasła w postaci jawnej); opcjonalna nazwa wyświetlana i adres URL awatara, jeśli zalogujesz się przez Google.",
              "**Stan subskrypcji**: aktualny plan (darmowy / Pro / Business), identyfikator klienta Paddle oraz daty ostatnich odnowień.",
              "**Liczniki użycia**: zagregowane liczniki kwot (np. „3 uruchomienia AI dzisiaj”, „420 miesięcznych uruchomień AI użytych”) aktualizowane na Twoim profilu. **Nie rejestrujemy** rekordów dla poszczególnych uruchomień.",
              ...
              "**Rekordy zgody**: data i godzina, o której zaakceptowałeś niniejsze Warunki oraz naszą Politykę prywatności, oraz czy wyraziłeś zgodę na otrzymywanie wiadomości marketingowych. Przechowywane są przez okres istnienia Twojego konta oraz przez okres pięciu (5) lat po jego usunięciu jako dowód prawny."
            ]
          },
          {
            "kind": "p",
            "text": "**Nie gromadzimy**: Twojego adresu IP (poza tymczasowym użyciem przez Supabase i naszego dostawcę hostingu w celach ograniczania liczby zapytań i logowania zabezpieczeń), odcisku przeglądarki, zdarzeń śledzenia zachowań, nagrań ekranu ani żadnych danych biometrycznych."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Sprawdzacz naruszeń haseł**: Twoje hasło nigdy nie opuszcza przeglądarki. Lokalnie haszujemy je algorytmem SHA-1 i zapytujemy HaveIBeenPwned przy użyciu k-anonimowości — przesyłane są tylko pierwsze 5 znaków skrótu. Hasło i pełny skrót nigdy nie są transmitowane.",
              "**Skaner adresów URL / sprawdzacz SSL**: przesyłany jest jedynie adres URL lub nazwa hosta, którą wpisujesz (do Google Safe Browsing w przypadku skanera adresów URL lub do otwarcia połączenia TLS w przypadku sprawdzacza SSL). Żadna zawartość otaczającej strony."
            ]
          }
        ]
      },
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Zgoda** (Art. 6(1)(a)) — wiadomości marketingowe, opcjonalne pliki cookie analityczne lub reklamowe (jeśli i kiedy będą włączone) oraz wszelkie przyszłe opcjonalne integracje.",
              "**Obowiązek prawny** (Art. 6(1)(c)) — przechowywanie zapisów rozliczeniowych zgodnie z wymogami prawa podatkowego Francji (zazwyczaj dziesięć lat)."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Jako osoba, której dane dotyczą, na mocy Rozporządzenia (UE) 2016/679 z dnia 27 kwietnia 2016 r. („RODO”), przysługują Ci następujące prawa, które możesz wykonywać w dowolnym momencie i bezpłatnie za pośrednictwem adresu e-mail zarejestrowanego w Twoim koncie:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**Prawo do usunięcia / prawo do bycia zapomnianym** (RODO Art. 17) — mieć swoje dane usunięte, gdy podstawy prawne przetwarzania przestaną obowiązywać.",
              "**Prawo do ograniczenia przetwarzania** (RODO Art. 18) — tymczasowo wstrzymać przetwarzanie w trakcie rozstrzygania sporu.",
              "**Prawo do przenoszenia danych** (RODO Art. 20) — otrzymać swoje dane w ustrukturyzowanym, nadającym się do odczytu maszynowego formacie.",
              ...
              "**Prawo do wycofania zgody** (RODO Art. 7(3)) — w przypadku przetwarzania opartego na zgodzie, wycofaj ją w dowolnym momencie bez wpływu na zgodność wcześniejszego przetwarzania z prawem.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Świadczenie Usługi wymaga udostępnienia ściśle ograniczonych danych następującym procesorom. Każdy z nich posiada własną politykę prywatności regulującą sposób, w jaki obsługują dane otrzymane od nas."
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase** (zarejestrowany w Singapurze, hostowany w UE dla naszego projektu) — uwierzytelnianie, baza danych, magazyn plików oraz funkcje Edge. Otrzymuje Twoje dane uwierzytelniające konta, dane profilu oraz (przejściowo) dowolny plik, który przesyłasz do narzędzia wspomaganego serwerowo. Działa jako nasz podprocesor.",
              "**Mistral AI** (Francja) — wnioskowanie przy użyciu dużego modelu językowego w zakresie tłumaczenia, parafrazowania, streszczania, ludzkiego stylu AI, analizy wzorców phishingu oraz innych zadań tekstowych; transkrypcja audio (Voxtral); OCR i zadania wizyjne (Pixtral). Tekst lub obraz, który przesyłasz, jest wysyłany do Mistral w celu wnioskowania. Mistral zobowiązał się umownie **nie używać danych wejściowych API do trenowania swoich modeli**.",
              ...
              "**HaveIBeenPwned** (Have I Been Pwned LLC) — wyłącznie podczas korzystania ze sprawdzacza naruszeń haseł, i to jedynie pierwszych 5 znaków skrótu SHA-1 Twojego hasła (k-anonimowość). Zapytanie jest wykonywane bezpośrednio z przeglądarki, nie przez nasze serwery.",
              "**Paddle** (Paddle.com Market Ltd, Zjednoczone Królestwo) — nasz Sprzedawca Rejestrujący: przetwarzanie płatności, zarządzanie subskrypcjami oraz globalne gromadzenie i przekazywanie podatków VAT/od sprzedaży. **Nigdy nie widzimy ani nie przechowujemy** Twoich danych karty. Paddle otrzymuje Twój adres e-mail, metodę płatności oraz plan, który kupiłeś.",
              ...
              "**Vercel** (USA) — sieć dostarcy treści dla stron statycznych. Otrzymuje standardowe metadane ruchu sieciowego (IP, user-agent, żądany adres URL) w celach routingu i zapobiegania nadużyciom. Przechowywane zgodnie z polityką retencji logów Vercela."
            ]
          },
          {
            "kind": "p",
            "text": "W przypadku gdy którykolwiek z tych procesorów działa poza Europejskim Obszarem Gospodarczym, transfery są regulowane przez Standardowe Klauzule Umowne (SCCs) Komisji Europejskiej lub równoważny mechanizm transferowy."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Opcjonalne reklamowe**: jeśli i kiedy włączymy partnerów reklamowych (obecnie w naszym kodzie jest referencja do Ezoic, ale nie jest jeszcze aktywowana dla Twojego ruchu), wyświetlimy wyraźny baner zgody i ustawimy pliki cookie reklamowe dopiero po wyrażeniu zgody przez Ciebie."
            ]
          },
          {
            "kind": "p",
            "text": "Obecnie nie uruchamiamy żadnych analiz, pikseli śledzenia ani tagów remarketingowych. Jeśli dodamy jakiekolwiek, powyższy baner cookie je zablokuje."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Obsługa haseł** — Twoje hasło jest haszowane przez Supabase Auth i nigdy nie jest przechowywane w postaci jawnej. Dodatkowo sprawdzamy nowe hasła po stronie klienta przy użyciu klienta API HaveIBeenPwned k-anonimowości, aby odrzucić znane naruszone hasła.",
              "**Dane płatności** — nigdy nie są widziane ani przechowywane przez nas; proces płatności kartą jest w pełni delegowany do Paddle, naszego Sprzedawcy Rejestrującego (PCI-DSS Level 1 compliant).",
              "**Kontrola dostępu** — polityki bezpieczeństwa na poziomie wierszy uniemożliwiają jednemu użytkownikowi odczytanie danych innego użytkownika; klucze roli usługi są ograniczone do funkcji Edge.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Zgodnie z RODO Art. 5(1)(c) gromadzimy jedynie dane ściśle konieczne do celów określonych w niniejszej Polityce. Konkretnie: nie gromadzimy Twojego adresu IP poza efemerycznymi logami routingu, nie fingerprintujemy przeglądarki, nie prowadzimy analizy zachowań oraz nigdy nie używamy żadnego przetwarzanego przez Ciebie pliku do trenowania modeli AI. Nie gromadzimy danych dotyczących szczególnych kategorii (Art. 9) ani danych dotyczących czynów zabronionych (Art. 10). Dane są utrzymywane w stanie dokładnym i aktualnym (Art. 5(1)(d)); możesz skorygować ewentualne nieścisłości w dowolnym momencie za pośrednictwem panelu lub kontaktując się pod adresem [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "Zapisy rozliczeniowe: przechowywane przez dziesięć (10) lat, aby spełnić obowiązki podatkowe Francji.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Serwis **nie jest skierowany do dzieci poniżej szesnastego (16) roku życia**. Jeśli nie ukończyłeś tego wieku, nie możesz utworzyć konta. Nie gromadzimy wiedzy o niepełnoletnich; jeśli dowiemy się, że zgromadziliśmy takie dane, usuniemy je."
          }
        ]
      },
      {
    ...
    "sections": [
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "Ми ніколи не зберігаємо вміст завантажених файлів у постійному місці, не використовуємо ваші завантаження для навчання моделей AI та не продаємо, не здаємо в оренду та не передаємо їх третім сторонам з будь-якою метою, окрім надання результату, який ви запросили."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Згідно з Положеннями Європейського регламенту про захист даних (Regulation (EU) 2016/679, «GDPR»), контролером даних є видавець Сервісу. Для звернень з питань конфіденційності: [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Облікові дані для входу**: ваша електронна адреса; сольований та хешований варіант вашого пароля (керований Supabase Auth — ми ніколи не бачимо та не зберігаємо пароль у відкритому вигляді); за бажанням — ім'я для відображення та URL-адреса аватара, якщо ви входите через Google.",
              "**Стан підписки**: поточний тарифний план (безкоштовний / Pro / Business), ідентифікатор клієнта Paddle та дати ваших останніх поновлень.",
              "**Лічильники використання**: агреговані лічильники квот (наприклад, «3 запуски AI сьогодні», «420 щомісячних запусків AI використано») оновлюються безпосередньо у вашому профілі. Ми **не ведемо записи на рівні окремих запусків**.",
              "**Метадані завдань (тимчасові)**: коли інструмент з підтримкою сервера генерує результат (наприклад, файл .srt після транскрибування), ми записуємо назву інструменту, URL-адресу для завантаження результату, вихідну мову та час завершення. Ці рядки автоматично видаляються через **дві (2) години**. Вони ніколи не містять вміст вашого файлу.",
              "**Записи про згоду**: дата та час, коли ви прийняли ці Умови та нашу Політику конфіденційності, а також чи ви дали згоду на отримання маркетингових листів. Зберігаються протягом терміну існування вашого облікового запису плюс п'ять (5) років після видалення для юридичних доказів."
            ]
          },
          {
            "kind": "p",
            "text": "Ми **не збираємо**: вашу IP-адресу (окрім тимчасового використання Supabase та нашого хостинг-провайдера для обмеження швидкості та логування безпеки), відбиток вашого браузера, події поведінкового трекінгу, записи вашого екрана чи будь-які біометричні дані."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**AI-транскрибування / переклад / OCR / аналіз фішингу**: файл або текст передається у наш Supabase Edge Function, який миттєво перенаправляє його відповідному постачальнику AI (див. розділ 7) для виконання. Результат повертається вам, а тимчасовий буфер завантаження видаляється. Результативні файли, які записуються у наш приватний сховище, доступні за підписаними URL-адресами протягом шістдесяти (60) хвилин і фізично видаляються протягом тридцяти (30) хвилин після генерації.",
              "**Перевірка паролів на витік**: ваш пароль ніколи не залишає ваш браузер. Ми хешуємо його локально за допомогою SHA-1 і запитуємо HaveIBeenPwned за допомогою k-анонімності — передається лише перші 5 символів хешу. Пароль та повний хеш ніколи не передаються.",
              "**Сканер URL-адрес / перевірка SSL**: передається лише URL-адреса або ім'я хоста, які ви вводите (до Google Safe Browsing для сканера URL-адрес або для відкриття TLS-з'єднання для перевірки SSL). Жоден інший вміст сторінки."
            ]
          }
        ]
      },
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Згода** (Art. 6(1)(a)) — маркетингові листи, необов'язкові аналітичні або рекламні cookies (за наявності).",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Як суб'єкт даних відповідно до Регламенту (EU) 2016/679 від 27 квітня 2016 року («GDPR»), ви маєте такі права, які можете реалізувати в будь-який час безкоштовно з електронної адреси, зареєстрованої у вашому обліковому записі:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**Право на перенесення даних** (GDPR Art. 20) — отримати свої дані у структурованому, машинозчитуваному форматі.",
              "**Право на заперечення** (GDPR Art. 21) — у будь-який час заперечити обробці даних на підставі наших законних інтересів, посилаючись на вашу конкретну ситуацію.",
              "**Право відкликати згоду** (GDPR Art. 7(3)) — для обробки на підставі згоди ви можете відкликати її в будь-який час без впливу на законність попередньої обробки.",
              "**Право не бути об'єктом рішень, прийнятих виключно на основі автоматизованої обробки** (GDPR Art. 22) — жодна з наших обробок не передбачає рішень, які мають юридичні наслідки для вас та приймаються виключно автоматизовано."
            ]
          },
          {
            "kind": "p",
            "text": "Щоб реалізувати будь-яке з цих прав, напишіть на [support@konvertools.com](mailto:support@konvertools.com) з електронної адреси, зареєстрованої у вашому обліковому записі. Ми відповімо протягом одного (1) місяця, як вимагає GDPR Art. 12(3); термін може бути продовжений ще на два місяці для особливо складних запитів, про що ми повідомимо протягом першого місяця."
          },
          {
            "kind": "p",
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase** (зареєстрований у Сінгапурі, розміщений у ЄС для нашого проєкту) — автентифікація, база даних, файловий хостинг та Edge Functions. Отримує ваші облікові дані, профільні дані та (тимчасово) будь-який файл, який ви завантажуєте для інструменту з підтримкою сервера. Виступає нашим суб-обробником.",
              "**Mistral AI** (Франція) — виконання великомовних моделей для перекладу, перефразування, резюмування, AI-гуманізації, аналізу шаблонів фішингу та інших текстових завдань; аудіо-транскрибування (Voxtral); OCR та візуальні завдання (Pixtral). Текст або зображення, які ви надсилаєте, передаються Mistral для виконання. Mistral взяв на себе договірне зобов'язання **не використовувати вхідні дані API для навчання своїх моделей**.",
              "**Google Safe Browsing** (Google LLC, США) — лише під час використання сканера URL-адрес або детектора фішингу. Передаються лише URL-адреси, які ви надсилаєте (або посилання, вилучені з електронного листа, який ви вставляєте). Це єдиний сторонній сервіс безпеки, який ми використовуємо.",
              ...
              "**Paddle** (Paddle.com Market Ltd, Сполучене Королівство) — наш Merchant of Record: обробка платежів, керування підпискою та збір та сплата ПДВ/податку з продажів у всьому світі. Ми **ніколи не бачимо та не зберігаємо** ваші дані картки. Paddle отримує вашу електронну адресу, спосіб оплати та тарифний план, який ви придбали.",
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Обов'язкові**: NEXT_LOCALE (зберігає обрану вами мову) та cookies сесії Supabase (sb-*-auth-token) під час авторизації. Вони не потребують згоди згідно з GDPR.",
          ...
          {
            "kind": "p",
            "text": "Наразі ми не використовуємо жодних аналітичних систем, трекінгових пікселів чи ремаркетингових тегів. Якщо ми додамо будь-які з них, банер згоди вище буде контролювати їх."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Обробка паролів** — ваш пароль хешується Supabase Auth і ніколи не зберігається у відкритому вигляді. Ми додатково перевіряємо нові паролі за допомогою клієнтського API k-анонімності HaveIBeenPwned, щоб відхиляти відомі зламані паролі.",
              "**Платіжні дані** — ніколи не бачаться та не зберігаються нами; обробка платежів повністю делегована Paddle, нашому Merchant of Record (відповідає стандарту PCI-DSS Level 1).",
              "**Контроль доступу** — політики безпеки на рівні рядків запобігають читанню даними одного користувача даних іншого; ключі для службових ролей обмежені Edge Functions.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Відповідно до GDPR Art. 5(1)(c), ми збираємо лише ті дані, які суворо необхідні для цілей, визначених у цій Політиці. Конкретно: ми не збираємо вашу IP-адресу, окрім ефемерних логів маршрутизації, не збираємо відбиток вашого браузера, не ведемо поведінковий аналіз та ніколи не використовуємо файли, які ви обробляєте, для навчання моделей AI. Ми не збираємо спеціальні категорії даних (Art. 9) або дані про кримінальні правопорушення (Art. 10). Дані зберігаються точними та актуальними (Art. 5(1)(d)); ви можете виправити неточності в будь-який час через свій кабінет або надіславши запит на [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "Бухгалтерські записи: зберігаються протягом десяти (10) років для дотримання французьких податкових зобов'язань.",
              "Записи про згоду: зберігаються протягом терміну існування вашого облікового запису плюс п'ять (5) років після цього як юридичні докази."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Сервіс **не призначений для дітей молодше шістнадцяти (16) років****. Якщо вам менше цього віку, ви не маєте права створювати обліковий запис. Ми свідомо не збираємо дані від неповнолітніх; у разі виявлення таких даних ми їх видалимо."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "За будь-яких питань щодо цієї Політики або ваших даних — включаючи реалізацію будь-яких прав згідно з GDPR (див. розділ 6) — напишіть на [support@konvertools.com](mailto:support@konvertools.com). Цей єдиний поштовий ящик є нашою точкою контакту для запитів щодо конфіденційності, безпеки, оплати та загальної підтримки. Ви також можете подати скаргу до французького органу захисту даних CNIL (3 Place de Fontenoy, TSA 80715, 75334 Paris Cedex 07 — [www.cnil.fr](https://www.cnil.fr)) або до наглядового органу вашої країни проживання."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Službu Konvertools (dále jen „Služba“) provozujeme jako nástroj prioritizující ochranu soukromí. Naše nejdůležitější závazek zní takto:"
          },
          {
            "kind": "ul",
            "items": [
              "**Nástroje běžící pouze v prohlížeči** (konvertory obrázků, nástroje PDF využívající pdf-lib, konverze audia a videa poháněné FFmpeg.wasm, nástroje pro práci s kódem, kalkulačky, generátory QR kódů, kontrola prolomených hesel, většina utilit) běží **zcela uvnitř vašeho webového prohlížeče prostřednictvím WebAssembly**. Váš soubor nebo vstupní data nikdy nejsou odesílána na naše servery. Nemáme žádný technický prostředek, jak je přečíst.",
              "**Nástroje využívající server** (AI přepis, AI překlad, AI textové úlohy, vhození titulků do videa, skenování URL, detektor phishingu, kontrola SSL certifikátů a několik dalších) vyžadují odeslání nějakých dat na backend. V každém případě je soubor nebo text zpracováván v reálném čase a z dočasného úložiště je smazán do třiceti (30) minut.",
              "Nikdy neukládáme obsah žádného nahraného souboru v žádném trvalém umístění, nikdy nepoužíváme vaše nahraná data k výcviku AI modelů a nikdy je neprodáváme, nepronajímáme ani nesdílíme s třetími stranami za žádným účelem kromě doručení výsledku, který jste si vyžádali."
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Přihlašovací údaje**: vaše e-mailová adresa; solený a hašovaný záznam vašeho hesla (spravovaný službou Supabase Auth — my samotní nevidíme ani neukládáme heslo v nezašifrované podobě); volitelný zobrazovaný název a URL k vašemu avataru, pokud se přihlásíte pomocí Google.",
              "**Stav předplatného**: aktuální plán (zdarma / Pro / Business), identifikátor zákazníka Paddle a data vašich posledních obnov.",
              "**Počítadla využití**: agregovaná kvóta využití (např. „Dnes jste použili 3 AI běhy“, „Celkem 420 AI běhů měsíčně“) aktualizovaná na vašem profilu. **Neukládáme** záznamy o jednotlivých bězích.",
              "**Metadata úloh (dočasná data)**: když nástroj využívající server vyprodukuje výsledek (např. soubor .srt z přepisu), zaznamenáme název nástroje, URL pro stažení výsledku, zdrojový jazyk a čas dokončení. Tyto řádky jsou automaticky odstraněny po **dvou (2) hodinách**. Nikdy neobsahují obsah vašeho souboru.",
          ...
          {
            "kind": "p",
            "text": "**Neukládáme**: vaši IP adresu (kromě dočasného využití službou Supabase a naším poskytovatelem hostingu pro omezení rychlosti a bezpečnostní logování), otisk prohlížeče, sledovací události chování, záznamy z obrazovky ani žádná biometrická data."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Nástroje běžící pouze v prohlížeči**: žádný přenos dat. Soubor je přečten do paměti vaším prohlížečem, výsledek je vyprodukován lokálně a vy si jej stáhnete přímo. O souboru samotném nic nezaznamenáváme.",
              "**AI přepis / překlad / OCR / analýza phishingu**: soubor nebo text je streamován do naší Edge Funkce Supabase, která jej okamžitě předá příslušnému AI poskytovateli (viz část 7) pro inferenci. Výsledek je vrácen vám a dočasný úložný prostor je smazán. Výsledné soubory uložené v našem privátním úložišti jsou přístupné prostřednictvím podepsaných URL po dobu šedesáti (60) minut a fyzicky smazány do třiceti (30) minut od vygenerování.",
              "**Kontrola prolomených hesel**: vaše heslo nikdy neopustí váš prohlížeč. Lokálně jej zašifrujeme pomocí SHA-1 a dotazujeme se služby HaveIBeenPwned pomocí k-anonymity — odesílány jsou pouze první 4 znaky haše. Heslo a plný haš nikdy nejsou přenášeny.",
              "**Skenování URL / kontrola SSL**: přenášen je pouze URL nebo název hostitele, který zadáte (k Google Safe Browsing pro skenování URL, nebo k otevření živého TLS spojení pro kontrolu SSL). Žádný okolní obsah stránky."
            ]
          }
        ]
      },
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Legitimní zájmy** (čl. 6 odst. 1 písm. f)) — prevence podvodů, zmírnění zneužívání, základní bezpečnostní logování a zlepšování Služby.",
              "**Souhlas** (čl. 6 odst. 1 písm. a)) — marketingové e-maily, volitelné analytické nebo reklamní cookies (pokud a kdykoliv budou povoleny) a případné budoucí volitelné integrace.",
              "**Právní povinnost** (čl. 6 odst. 1 písm. c)) — uchovávání záznamů o platbách dle francouzského daňového práva (obvykle deset let)."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Jako subjekt údajů podle Nařízení Evropského parlamentu a Rady (EU) 2016/679 ze dne 27. dubna 2016 („GDPR“) máte následující práva, která můžete uplatnit kdykoliv a zdarma prostřednictvím e-mailové adresy registrované na vašem účtu:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "**Právo na vymazání / právo být zapomenut** (GDPR čl. 17) — nechat svá data smazat, pokud pominuly právní důvody pro jejich zpracování.",
              ...
              "**Právo vznést námitku** (GDPR čl. 21) — kdykoliv vznést námitku proti zpracování založenému na našich legitimních zájmech, a to z důvodů souvisejících s vaší konkrétní situací.",
              "**Právo odvolat souhlas** (GDPR čl. 7 odst. 3) — pro zpracování založené na souhlasu jej kdykoliv odvolat bez ovlivnění zákonnosti předchozího zpracování.",
          ...
          {
            "kind": "p",
            "text": "Chcete-li uplatnit některá z těchto práv, napište na [support@konvertools.com](mailto:support@konvertools.com) z adresy registrované na vašem účtu. Odpovíme do jednoho (1) měsíce, jak vyžaduje GDPR čl. 12 odst. 3; lhůta může být prodloužena o další dva měsíce v případě zvláště složitých žádostí, v takovém případě vás budeme informovat do prvního měsíce."
          },
          {
            "kind": "p",
            "text": "Máte také **právo podat stížnost u dozorového orgánu** (GDPR čl. 77). Pro uživatele ve Francii se jedná o **Commission Nationale de l'Informatique et des Libertés (CNIL)** — 3 Place de Fontenoy, TSA 80715, 75334 PARIS CEDEX 07, Francie — telefon +33 (0)1 53 73 22 22 — online stížnosti na [www.cnil.fr/en/plaintes](https://www.cnil.fr/en/plaintes). Pro uživatele v jiných členských státech EU/EEA můžete podat stížnost u svého **národního dozorového orgánu** (seznam vede Evropská rada pro ochranu údajů na [edpb.europa.eu](https://edpb.europa.eu/about-edpb/about-edpb/members_en)). Můžete také vyhledat soudní opravný prostředek podle GDPR čl. 79."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "**Supabase** (společnost založená v Singapuru, hostovaná v EU pro náš projekt) — autentizace, databáze, úložiště souborů a Edge Funkce. Přijímá vaše přihlašovací údaje, profilová data a (dočasně) jakýkoliv soubor, který nahrajete pro nástroj využívající server. Působí jako náš sub-zpracovatel.",
              "**Mistral AI** (Francie) — inference velkých jazykových modelů pro překlad, parafrázování, shrnování, AI humanizaci, analýzu vzorů phishingu a další textové úlohy; přepis audia (Voxtral); OCR a úlohy zpracování obrazu (Pixtral). Text nebo obrázek, který odešlete, je odeslán Mistralu pro inferenci. Mistral se smluvně zavázal **nepoužívat vstupy z API k výcviku svých modelů**.",
              "**Google Safe Browsing** (Google LLC, USA) — pouze při používání Skeneru URL nebo Detektoru phishingu. Přenášen je pouze URL, které zadáte (nebo odkazy extrahované z e-mailu, který vložíte). Toto je jediná třetí strana poskytující bezpečnostní služby, kterou používáme.",
              "**HaveIBeenPwned** (Have I Been Pwned LLC) — pouze při používání Kontroly prolomených hesel a pouze prvních 5 znaků haše vašeho hesla SHA-1 (k-anonymita). Dotazováno přímo z vašeho prohlížeče, nikoliv prostřednictvím našich serverů.",
              "**Paddle** (Paddle.com Market Ltd, Spojené království) — náš obchodní zástupce: zpracování plateb, správa předplatného a celosvětové vybírání a odvádění DPH/spotřebních daní. **Nikdy nevidíme ani neukládáme** vaše platební údaje. Paddle přijímá vaši e-mailovou adresu, platební metodu a plán, který jste si zakoupili.",
              ...
              "**Vercel** (USA) — síť pro doručování obsahu pro statické stránky. Přijímá standardní metadata webového provozu (IP, user-agent, požadovaná URL) pro směrování a prevenci zneužívání. Uchováváno v souladu s politikou uchovávání logů Vercelu."
            ]
          },
          {
            "kind": "p",
            "text": "Pokud kterýkoliv z těchto zpracovatelů působí mimo Evropský hospodářský prostor, jsou přenosy řízeny Standardními smluvními doložkami (SCCs) Evropské komise nebo obdobným mechanismem pro přenos údajů."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "**Volitelné reklamní**: pokud a kdykoliv povolíme partnerské reklamní služby (v současnosti je v našem kódu referována Ezoic, ale zatím není aktivována pro váš provoz), zobrazíme jasný banner pro souhlas a cookies pro reklamu nastavíme pouze po vašem souhlasu."
            ]
          },
          {
            "kind": "p",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "V souladu s GDPR čl. 32 implementujeme přiměřená technická a organizační opatření k zajištění úrovně zabezpečení odpovídající riziku:"
          },
          {
            "kind": "ul",
            "items": [
              "**Šifrování v přenosu** — veškerý provoz do a z Služby je chráněn pomocí TLS 1.2 nebo vyšší.",
              "**Šifrování v klidu** — Supabase šifruje základní databázi (včetně vašich účtových údajů) pomocí AES-256.",
              "**Zpracování hesel** — vaše heslo je hašováno službou Supabase Auth a nikdy není uloženo v nezašifrované podobě. Dále kontrolujeme nová hesla proti API k-anonymity HaveIBeenPwned na straně klienta, abychom odmítli známá prolomená hesla.",
              "**Platební údaje** — nikdy je nevidíme ani neukládáme; platební proces je plně delegován na Paddle, našeho obchodního zástupce (PCI-DSS Level 1 compliant).",
          ...
          {
            "kind": "p",
            "text": "Přes tato opatření není žádný systém dokonale zabezpečen; přijímáte zbytková rizika inherentní jakékoliv online službě."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "V souladu s GDPR čl. 5 odst. 1 písm. c) shromažďujeme pouze údaje nezbytné pro účely stanovené v této Zásadě. Konkrétně: nesbíráme vaši IP adresu mimo dočasné směrovací logy, neprovádíme otiskování vašeho prohlížeče, neprovádíme behaviorální analytiku a nikdy nepoužíváme žádný soubor, který zpracováváte, k výcviku AI modelů. Nesbíráme zvláštní kategorii údajů (čl. 9) ani údaje týkající se trestných činů (čl. 10). Údaje jsou udržovány přesné a aktuální (čl. 5 odst. 1 písm. d); případné nepřesnosti můžete kdykoliv opravit prostřednictvím svého profilu nebo kontaktováním [support@konvertools.com](mailto:support@konvertools.com)."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Tuto Zásadu ochrany osobních údajů můžeme čas od času upravit. Podstatné změny budou oznámeny držitelům účtů e-mailem alespoň třicet (30) dnů před jejich nabytím účinnosti. Nejnovější verze je vždy k dispozici na [https://konvertools.com/privacy](https://konvertools.com/privacy)."
          }
        ]
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**Dans la mesure maximale permise par la loi, l'Éditeur décline toute responsabilité pour tout dommage de quelque nature que ce soit résultant de votre utilisation ou de votre incapacité à utiliser le Service.** En particulier, vous reconnaissez et acceptez que l'Éditeur ne sera pas responsable de :"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "les défaillances de services tiers (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, hébergeurs) ;",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "tenter de surcharger, de rétro-ingénierie, de scraper, d'abuser des limites de taux ou d'interférer de quelque manière que ce soit avec le fonctionnement ou la disponibilité du Service ;",
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Modifications des prix** : nous pouvons modifier les prix avec un préavis de 30 jours. Les abonnés existants conservent leur prix actuel jusqu'à leur prochaine date de renouvellement.",
              "**Taxes** : Paddle est le Marchand d'enregistrement pour tous les achats et agit en tant que vendeur enregistré. Il calcule, collecte et reverse toute TVA ou taxe de vente due dans votre juridiction, de sorte que le prix que vous payez à la caisse inclut déjà toute taxe applicable."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Le nom, le logo, le code, la conception, la documentation, la structure de la base de données et le contenu agrégé du Service sont la propriété exclusive de l'Éditeur et sont protégés par le droit français et international de la propriété intellectuelle. Aucune licence ne vous est accordée en dehors de celle strictement nécessaire pour utiliser le Service comme prévu. Vous ne pouvez pas reproduire, modifier, désassembler ou créer des œuvres dérivées du Service ou de l'une de ses parties, sauf dans la mesure expressément autorisée par la loi applicable."
          }
        ]
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Konvertools ofrece un catálogo de utilidades de conversión de archivos, herramientas de procesamiento de documentos e imágenes, utilidades de texto asistidas por IA, herramientas de seguridad indicativas (verificador de correos electrónicos, detector de phishing, escáner de URLs, verificador de certificados SSL, verificador de filtraciones de contraseñas) y utilidades para desarrolladores. La mayoría de las herramientas se ejecutan completamente en su navegador; algunas requieren procesamiento en servidor. El Servicio se ofrece **\"tal cual\" y \"según disponibilidad\"** sin ninguna garantía de ningún tipo, expresa o implícita, incluyendo comerciabilidad, idoneidad para un propósito particular o no infracción."
          }
        ]
      },
      {
        "id": "liability",
        "title": "3. Limitación de responsabilidad — lea detenidamente",
        "blocks": [
          {
            "kind": "p",
            "text": "**En la máxima medida permitida por la ley, el Editor rechaza cualquier responsabilidad por daños de cualquier tipo derivados de su uso o incapacidad de usar el Servicio.** En particular, usted reconoce y acepta que el Editor no será responsable de:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "fallos de servicios de terceros (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, proveedores de alojamiento);",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "intentar sobrecargar, ingeniería inversa, extraer datos, abusar de los límites de velocidad o interferir de otro modo con el funcionamiento o disponibilidad del Servicio;",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Usted conserva todos los derechos, título e interés sobre los archivos y textos que envíe al Servicio. Nos concede una licencia estrictamente limitada, no exclusiva, mundial y libre de regalías para procesarlos únicamente con el fin de proporcionar la herramienta que solicitó. Esta licencia finaliza en el momento en que el resultado se le devuelve (herramientas asistidas por servidor) o nunca llega a existir (herramientas solo de navegador, ya que su archivo nunca nos llega). No reclamamos ni utilizaremos su contenido para entrenar modelos de IA."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Impuestos**: Paddle actúa como el Comerciante de Registro para todas las compras y como vendedor de registro. Calcula, recauda y remite cualquier IVA o impuesto sobre ventas aplicable en su jurisdicción, por lo que el precio que paga en el pago ya incluye cualquier impuesto aplicable."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "El nombre, logo, código, diseño, documentación, estructura de la base de datos y contenido agregado del Servicio son propiedad exclusiva del Editor y están protegidos por las leyes de propiedad intelectual francesas e internacionales. No se le concede ninguna licencia más allá de lo estrictamente necesario para usar el Servicio según lo previsto. No puede reproducir, modificar, descompilar ni crear obras derivadas del Servicio o de cualquier parte del mismo, salvo que la ley aplicable lo permita expresamente."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Si alguna disposición de estos Términos se considera inválida o inaplicable, las disposiciones restantes mantendrán su plena vigencia. Nuestra falta de aplicación de cualquier derecho o disposición no constituye una renuncia a dicho derecho. Estos Términos (junto con la Política de Privacidad y cualquier término específico del plan referenciado en la compra) constituyen el acuerdo completo entre usted y el Editor con respecto al Servicio."
          }
        ]
      }
    ]
    ...
    "sections": [
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "falhas em serviços de terceiros (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, provedores de hospedagem);",
          ...
          {
            "kind": "p",
            "text": "**Ferramentas de segurança**: o Scanner de URLs, o Detector de Phishing, o Verificador de E-mails, o Verificador de Certificados SSL e o Verificador de Violações de Senhas são fornecidos **apenas para fins informativos e indicativos**. Eles agregam sinais de terceiros (Google Safe Browsing, DNS público, HaveIBeenPwned, handshakes TLS ao vivo) e heurísticas de modelos de linguagem de grande porte. Eles **não constituem garantia de segurança, validade ou ausência de risco**. Novas páginas de phishing surgem mais rápido do que os bancos de dados de reputação conseguem catalogar; um e-mail que passa nos nossos testes pode ainda estar inativo ou fraudulento; um certificado SSL válido não certifica o conteúdo de um site. O Editor declina expressamente toda a responsabilidade por quaisquer danos resultantes de um e-mail de phishing que o Serviço considerou seguro, um link inseguro que o Serviço não conseguiu identificar, um e-mail transacional enviado a um endereço que o Serviço marcou como válido ou qualquer decisão de segurança tomada com base nestas ferramentas. O Usuário assume total responsabilidade por tais decisões."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Imposto**: a Paddle é o Comerciante de Registro para todas as compras e atua como vendedor de registro. Ela calcula, coleta e remete quaisquer IVA ou impostos sobre vendas devidos na sua jurisdição, de modo que o preço que você paga no checkout já inclui quaisquer impostos aplicáveis."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "O nome, logotipo, código, design, documentação, estrutura de banco de dados e conteúdo agregado do Serviço são propriedade exclusiva do Editor e estão protegidos pelas leis de propriedade intelectual francesas e internacionais. Nenhuma licença é concedida a você além do estritamente necessário para usar o Serviço conforme pretendido. Você não pode reproduzir, modificar, descompilar ou criar obras derivadas do Serviço ou de qualquer parte dele, exceto conforme expressamente permitido pela lei aplicável."
          }
        ]
      },
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Konvertools bietet einen Katalog an Datei-Konvertierungsprogrammen, Dokumenten- und Bildbearbeitungstools, KI-gestützten Textprogrammen, indikativen Sicherheitstools (E-Mail-Prüfer, Phishing-Detektor, URL-Scanner, SSL-Zertifikatsprüfer, Passwort-Breach-Checker) sowie Entwickler-Tools. Die meisten Tools laufen vollständig in Ihrem Browser ab; einige erfordern eine serverseitige Verarbeitung. Der Dienst wird **„wie er ist“ und „wie verfügbar“** ohne jegliche ausdrückliche oder stillschweigende Gewährleistung angeboten, einschließlich der Marktgängigkeit, Eignung für einen bestimmten Zweck oder Rechtsmangelfreiheit."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**Soweit gesetzlich zulässig, schließt der Herausgeber jede Haftung für Schäden jedweder Art aus, die aus Ihrer Nutzung oder der Unmöglichkeit der Nutzung des Dienstes entstehen.** Insbesondere erkennen Sie an und stimmen zu, dass der Herausgeber nicht haftet für:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "Ausfälle von Drittanbietern (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, Hosting-Anbieter);",
              "mittelbare, zufällige, besondere, Folgeschäden oder Strafschäden jedweder Art;",
              "einen Gesamtbetrag, der den von Ihnen in den zwölf (12) Monaten vor dem haftungsauslösenden Ereignis tatsächlich an uns gezahlten Gebühren übersteigt, begrenzt auf einhundert (100) Euro für Nutzer des kostenlosen Tarifs."
            ]
          },
          {
            "kind": "p",
            "text": "**Sicherheitstools**: Der URL-Scanner, der Phishing-Detektor, der E-Mail-Prüfer, der SSL-Zertifikatsprüfer und der Passwort-Breach-Checker werden **ausschließlich zu Informations- und Indikationszwecken** bereitgestellt. Sie aggregieren Signale von Drittanbietern (Google Safe Browsing, öffentliches DNS, HaveIBeenPwned, Live-TLS-Handshakes) sowie heuristische Ansätze von Sprachmodellen. Sie **stellen keine Garantie für Sicherheit, Gültigkeit oder Risikofreiheit** dar. Neue Phishing-Seiten entstehen schneller, als Reputationsdatenbanken sie erfassen können; eine E-Mail, die unsere Prüfungen besteht, kann dennoch inaktiv oder betrügerisch sein; ein gültiges SSL-Zertifikat bestätigt nicht den Inhalt einer Website. Der Herausgeber lehnt jede Haftung für Schäden ab, die aus einer Phishing-E-Mail entstehen, die der Dienst als sicher eingestuft hat, einem unsicheren Link, den der Dienst nicht erkannt hat, einer Transaktions-E-Mail, die an eine Adresse gesendet wurde, die der Dienst als gültig markiert hat, oder einer Sicherheitsentscheidung, die auf Basis dieser Tools getroffen wurde. Der Nutzer trägt die alleinige Verantwortung für solche Entscheidungen."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "Dateien zu verarbeiten, für die Sie keine entsprechenden Rechte besitzen (urheberrechtlich geschützte Werke ohne Genehmigung, personenbezogene Daten, die Sie nicht verarbeiten dürfen, klassifizierte Informationen);",
              "Betrug, Geldwäsche, die Finanzierung von Terrorismus oder andere strafbare Handlungen zu begehen oder zu erleichtern;",
              "die KI-Humanisierungs-Tools, die KI-Text-Tools oder andere Funktionen zu nutzen, um zu plagiieren, eine dritte Partei zu täuschen, Bewertungssysteme (akademische, Personalabteilungen, Werbenetzwerke) in einer Weise zu manipulieren, die gegen deren Regeln verstößt, oder auf sonstige Weise gegen geltendes Recht zu verstoßen;",
              "den Dienst zu überlasten, zu reverse-engineeren, zu scrapen, die Ratenlimits zu missbrauchen oder auf sonstige Weise den Betrieb oder die Verfügbarkeit des Dienstes zu beeinträchtigen;",
              "Quoten, Zahlungsanforderungen oder andere Beschränkungen zu umgehen;",
              "mehrere Konten zu erstellen, um die kostenlosen Tarifquoten zu vervielfachen, oder ein Konto mit mehr Personen zu teilen, als Ihr Tarif erlaubt."
            ]
          },
          {
            "kind": "p",
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**Tarife**: Kostenlos (€0), Pro (€25/Monat oder €210/Jahr), Business (€79/Monat oder €664/Jahr). Die Funktionen und Quoten der Tarife sind wie auf unserer [Preisseite](/pricing) zum Zeitpunkt des Kaufs beschrieben. Wir behalten uns vor, die Tariffunktionen mit 30-tägiger Vorankündigung zu ändern.",
              ...
              "**Steuern**: Paddle ist der Merchant of Record für alle Käufe und fungiert als Verkäufer. Es berechnet, erhebt und überweist alle in Ihrer Rechtsordnung fällige MwSt. oder Umsatzsteuer, sodass der Preis, den Sie bei der Kasse zahlen, bereits alle anfallenden Steuern enthält."
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Diese Bedingungen unterliegen dem Recht Frankreichs. Jegliche Streitigkeit, die sich aus oder im Zusammenhang mit diesen Bedingungen oder dem Dienst ergibt, unterliegt der ausschließlichen Zuständigkeit der Gerichte von Paris, Frankreich, sofern nicht das zwingende Klagerecht eines Verbrauchers in seinem Wohnsitzland gemäß EU-Recht oder nationalem Recht Vorrang hat. Bevor Sie rechtliche Schritte einleiten, stimmen Sie zu, eine einvernehmliche Streitbeilegung durch eine Nachricht an [support@konvertools.com](mailto:support@konvertools.com) zu versuchen. EU-Verbraucher können auch die Online-Streitbeilegungsplattform der Europäischen Kommission unter [ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr) nutzen."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Falls eine Bestimmung dieser Bedingungen für unwirksam oder nicht durchsetzbar erklärt wird, bleiben die übrigen Bestimmungen in vollem Umfang wirksam. Unsere Nichtausübung eines Rechts oder einer Bestimmung stellt keinen Verzicht darauf dar. Diese Bedingungen (zusammen mit der Datenschutzerklärung und allen bei Kauf referenzierten tarifbezogenen Bedingungen) bilden die gesamte Vereinbarung zwischen Ihnen und dem Herausgeber in Bezug auf den Dienst."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "I presenti Termini di Servizio (i \"Termini\") costituiscono un accordo vincolante tra l'utente (l'\"Utente\") e il titolare di Konvertools (l'\"Editore\", \"noi\", \"nostro\") in merito all'utilizzo del sito web Konvertools e di tutti gli strumenti, API e servizi correlati (collettivamente il \"Servizio\"). Creando un account, spuntando la casella di accettazione al momento della registrazione o semplicemente utilizzando qualsiasi strumento del Servizio, si conferma di aver letto, compreso e accettato integralmente questi Termini, unitamente alla nostra Politica sulla Privacy."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**Nei limiti massimi consentiti dalla legge, l'Editore declina qualsiasi responsabilità per danni di qualsiasi tipo derivanti dall'uso o dall'impossibilità di utilizzare il Servizio.** In particolare, l'Utente riconosce e accetta che l'Editore non sarà responsabile per:"
          },
          {
            "kind": "ul",
            "items": [
              "perdita di dati, file corrotti o errati, o conversioni non riuscite;",
              "decisioni, finanziarie, aziendali o di altro tipo, prese dall'Utente in base ai risultati di qualsiasi strumento;",
              "tempi di inattività, latenza o indisponibilità temporanea di qualsiasi funzionalità;",
              "guasti di servizi di terze parti (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, provider di hosting);",
              "danni indiretti, incidentali, speciali, consequenziali o punitivi di qualsiasi tipo;",
              "qualsiasi importo complessivo superiore alle tariffe effettivamente pagate all'Editore nei dodici (12) mesi precedenti l'evento che ha dato origine alla richiesta di risarcimento, con un limite massimo di cento (100) euro per gli utenti del piano gratuito."
            ]
          },
          {
            "kind": "p",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "utilizzare l'umanizzatore AI, gli strumenti di testo AI o qualsiasi altra funzionalità per plagiare, ingannare un terzo, manipolare sistemi di valutazione (accademici, di reclutamento, di reti pubblicitarie) in modo da violare le loro regole, o fuorviare in qualsiasi modo che violi la legge applicabile;",
          ...
          {
            "kind": "p",
            "text": "L'Editore potrà sospendere o terminare immediatamente l'account dell'Utente senza preavviso qualora abbia ragionevoli motivi per ritenere che l'Utente abbia violato questa sezione, senza diritto a alcun rimborso."
          }
        ]
      },
      {
        "id": "content",
        "title": "5. I Suoi contenuti",
        "blocks": [
          {
            "kind": "p",
            "text": "L'Utente conserva tutti i diritti, la titolarità e l'interesse sui file e sui testi che invia al Servizio. Si concede all'Editore una licenza limitata, gratuita, mondiale e non esclusiva per elaborarli unicamente al fine di fornire lo strumento richiesto. Tale licenza termina nel momento in cui il risultato viene restituito all'Utente (strumenti assistiti da server) o non viene mai concessa (strumenti solo lato browser, poiché il file non viene mai trasmesso a noi). L'Editore non acquisisce, né acquisirà, la proprietà dei contenuti dell'Utente né li utilizzerà per addestrare modelli di IA."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**Piani**: Gratuito (€0), Pro (€25/mese o €210/anno), Business (€79/mese o €664/anno). Le funzionalità e le quote dei piani sono descritte nella nostra pagina [Prezzi](/pricing) al momento dell'acquisto. L'Editore si riserva il diritto di modificare le funzionalità dei piani con un preavviso di 30 giorni.",
              "**Rinnovo automatico**: gli abbonamenti mensili e annuali si rinnovano automaticamente alla stessa cadenza fino alla cancellazione. È possibile annullare in qualsiasi momento dal proprio pannello di controllo; la cancellazione avrà effetto alla fine del periodo di fatturazione corrente. L'accesso al Servizio sarà mantenuto fino a tale data.",
              "**Diritto di recesso (UE)**: ai sensi dell'Articolo L. 221-28 del Codice del Consumo francese, qualora l'Utente utilizzi attivamente il Servizio durante il periodo iniziale di 14 giorni per il recesso, si esprime il consenso esplicito all'esecuzione immediata del contratto e si rinuncia al diritto di recesso. Se non sono state utilizzate funzionalità a pagamento, è possibile recedere entro 14 giorni inviando una email a [support@konvertools.com](mailto:support@konvertools.com) e l'Editore procederà con il rimborso integrale entro 14 giorni.",
              ...
              "**Modifiche dei prezzi**: l'Editore può modificare i prezzi con un preavviso di 30 giorni. Gli abbonati esistenti mantengono il prezzo attuale fino alla data di rinnovo successiva.",
              "**Tasse**: Paddle è il Merchant of Record per tutti gli acquisti e agisce come venditore ufficiale. Calcola, riscuote e versa qualsiasi IVA o tassa sulle vendite dovuta nella giurisdizione dell'Utente, pertanto il prezzo pagato al checkout include già le eventuali tasse applicabili."
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "L'Utente si impegna a indennizzare e tenere indenne l'Editore da qualsiasi richiesta, perdita, danno, responsabilità, costo o spesa (inclusi gli onorari legali ragionevoli) derivante da (a) violazione dei presenti Termini da parte dell'Utente, (b) violazione di qualsiasi legge o diritto di terze parti da parte dell'Utente, o (c) qualsiasi contenuto inviato al Servizio dall'Utente."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "L'Editore può modificare i presenti Termini di volta in volta. Le modifiche sostanziali verranno comunicate tramite email agli utenti registrati almeno trenta (30) giorni prima della loro entrata in vigore. Continuando a utilizzare il Servizio dopo tale periodo, si accettano i Termini modificati. L'ultima versione è sempre disponibile all'indirizzo [https://konvertools.com/terms](https://konvertools.com/terms)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "L'Utente può terminare il proprio account in qualsiasi momento dal proprio pannello di controllo. L'Editore può terminare o sospendere l'account immediatamente e senza preavviso qualora l'Utente violi i presenti Termini, abusi del Servizio o non paghi un abbonamento ricorrente. Al termine dell'account, i dati vengono cancellati entro trenta (30) giorni, ad eccezione dei registri di fatturazione e dei consensi conservati come descritto nella nostra Politica sulla Privacy."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Se una disposizione dei presenti Termini viene ritenuta invalida o non applicabile, le restanti disposizioni rimangono pienamente valide. La mancata applicazione di un diritto o di una disposizione da parte nostra non costituisce una rinuncia a tale diritto. I presenti Termini (unitamente alla Politica sulla Privacy e a eventuali termini specifici del piano richiamati al momento dell'acquisto) costituiscono l'intero accordo tra l'Utente e l'Editore in merito al Servizio."
          }
        ]
      }
    ]
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**Voor zover wettelijk toegestaan, sluit de Uitgever elke aansprakelijkheid uit voor schade van welke aard dan ook die voortvloeit uit uw gebruik van, of het onvermogen om gebruik te maken van, de Dienst.** In het bijzonder erkent en gaat u akkoord met het volgende: de Uitgever is niet aansprakelijk voor:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "storingen bij derden (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, hostingproviders);",
              "indirecte, incidentele, speciale, gevolg- of punitieve schade van welke aard dan ook;",
              "een totaalbedrag dat hoger is dan de kosten die u daadwerkelijk aan ons heeft betaald in de twaalf (12) maanden voorafgaand aan het voorval dat aanleiding geeft tot de claim, met een maximum van honderd (100) euro voor gebruikers met een gratis abonnement."
            ]
          },
          {
            "kind": "p",
            "text": "**Beveiligingstools**: de URL-scanner, de phishingdetector, de e-mailverifier, de SSL-certificaatcontrole en de wachtwoordbreukcontrole worden **uitsluitend voor informatieve en indicatieve doeleinden** aangeboden. Ze aggregatie signalen van derden (Google Safe Browsing, openbare DNS, HaveIBeenPwned, live TLS-handshakes) en heuristieken van grote-taalmodellen. Ze **vormen geen garantie voor veiligheid, geldigheid of afwezigheid van risico**. Nieuwe phishingpagina's verschijnen sneller dan reputatiedatabases ze kunnen catalogiseren; een e-mail die onze controles doorstaat, kan nog steeds inactief of frauduleus zijn; een geldig SSL-certificaat certificeert niet de inhoud van een site. De Uitgever wijst elke aansprakelijkheid uitdrukkelijk af voor schade die voortvloeit uit een phishing-e-mail die de Dienst als veilig heeft aangemerkt, een onveilige link die de Dienst niet heeft geïdentificeerd, een transactie-e-mail die naar een adres is verzonden dat de Dienst als geldig heeft gemarkeerd, of een beveiligingsbeslissing die is genomen op basis van deze tools. De Gebruiker draagt de volledige verantwoordelijkheid voor dergelijke beslissingen."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "bestanden te verwerken waarvoor u niet de benodigde rechten heeft ( auteursrechtelijk beschermde werken zonder toestemming, persoonsgegevens waar u niet toe bevoegd bent, geclassificeerde informatie);",
              "fraude, witwassen van geld, financiering van terrorisme of andere criminele activiteiten te faciliteren of te plegen;",
              "de AI-humaniser, de AI-teksttools of een andere functie te gebruiken om te plagiaat te plegen, een derde partij te misleiden, evaluatiesystemen (academisch, werving, advertentienetwerken) te manipuleren op een manier die in strijd is met hun regels, of op enigerlei wijze te misleiden in strijd met toepasselijk recht;",
              "pogingen te doen om de Dienst te overbelasten, te reverse-engineeren, te scrapen, tariefbeperkingen te misbruiken of op andere wijze de werking of beschikbaarheid van de Dienst te verstoren;",
              "quota's, betalingsvereisten of andere beperkingen te omzeilen;",
              "meerdere accounts aan te maken om de quota's van het gratis abonnement te verhogen, of een account te delen met meer personen dan uw abonnement toestaat."
            ]
          },
          {
            "kind": "p",
            "text": "We kunnen uw account onmiddellijk en zonder voorafgaande kennisgeving opschorten of beëindigen als we redelijke gronden hebben om aan te nemen dat u deze sectie heeft overtreden, zonder recht op restitutie van welke aard dan ook."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "U behoudt alle rechten, titel en belang in de bestanden en tekst die u naar de Dienst uploadt. U verleent ons een strikt beperkte, royaltyvrije, wereldwijde licentie om deze uitsluitend te verwerken om de tool te leveren die u heeft aangevraagd. Deze licentie eindigt op het moment dat het resultaat aan u wordt teruggegeven (servergeassisteerde tools) of nooit tot stand komt (browser-only tools, aangezien uw bestand ons nooit bereikt). We claimen geen eigendom van uw inhoud en zullen deze ook niet gebruiken om AI-modellen te trainen."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**Plannen**: Gratis (€0), Pro (€25/maand of €210/jaar), Business (€79/maand of €664/jaar). De functies en quota's van de abonnementen zijn zoals beschreven op onze [Prijzenpagina](/pricing) op het moment van aankoop. We behouden ons het recht voor om abonnementen met 30 dagen voorafgaande kennisgeving te wijzigen.",
              "**Automatische verlenging**: maand- en jaarabonnementen verlengen automatisch totdat ze worden geannuleerd. U kunt op elk moment annuleren via uw dashboard; de annulering treedt in werking aan het einde van de huidige factureringsperiode. U behoudt toegang tot die datum.",
              "**Ontbindingsrecht (EU)**: op grond van Artikel L. 221-28 van de Franse Consumentenwet, als u de Dienst actief gebruikt tijdens de initiële ontbindingsperiode van 14 dagen, stemt u er uitdrukkelijk mee in dat de overeenkomst onmiddellijk wordt uitgevoerd en dat u afstand doet van uw ontbindingsrecht. Als u geen betaalde functie heeft gebruikt, kunt u binnen 14 dagen annuleren door een e-mail te sturen naar [support@konvertools.com](mailto:support@konvertools.com) en wij zullen binnen 14 dagen een volledige restitutie verrichten.",
              "**Geen gedeeltelijke restituties**: buiten bovenstaand ontbindingscenario zijn reeds betaalde kosten voor de huidige factureringsperiode niet restitueerbaar.",
              ...
              "**Belasting**: Paddle is de Merchant of Record voor alle aankopen en fungeert als verkoper. Het berekent, int en draagt elke verschuldigde BTW of omzetbelasting in uw rechtsgebied af, zodat de prijs die u bij de checkout betaalt reeds eventuele toepasselijke belasting bevat."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "De naam, het logo, de code, het ontwerp, de documentatie, de database-structuur en de geaggregeerde inhoud van de Dienst zijn het exclusieve eigendom van de Uitgever en worden beschermd door Franse en internationale intellectuele-eigendomswetgeving. U krijgt geen licentie verleend, behalve wat strikt noodzakelijk is om de Dienst te gebruiken zoals bedoeld. U mag de Dienst of een deel daarvan niet reproduceren, wijzigen, decompileren of afgeleide werken maken, tenzij dit uitdrukkelijk is toegestaan door toepasselijk recht."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "U gaat ermee akkoord de Uitgever schadeloos te stellen en vrij te houden van elke claim, schade, aansprakelijkheid, kosten of kostenpost (inclusief redelijke juridische kosten) die voortvloeit uit (a) uw schending van deze Voorwaarden, (b) uw overtreding van een wet of recht van een derde, of (c) inhoud die u naar de Dienst heeft geüpload."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Deze Voorwaarden vallen onder het Franse recht. Elke geschil dat voortvloeit uit of verband houdt met deze Voorwaarden of de Dienst wordt onderworpen aan de exclusieve bevoegdheid van de rechtbanken van Parijs, Frankrijk, tenzij een consument zijn verplichte actierecht in zijn land van verblijf kan uitoefenen op grond van Europese of toepasselijke nationale wetgeving. Voordat u juridische stappen onderneemt, gaat u ermee akkoord om te proberen het geschil op een vriendelijke manier op te lossen door een bericht te sturen naar [support@konvertools.com](mailto:support@konvertools.com). EU-consumenten kunnen ook gebruikmaken van het platform voor online geschillenbeslechting van de Europese Commissie op [ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Als een bepaling van deze Voorwaarden ongeldig of niet afdwingbaar wordt geacht, blijven de overige bepalingen volledig van kracht. Het niet afdwingen van een recht of bepaling door ons is geen afstand van dat recht. Deze Voorwaarden (samen met het Privacybeleid en eventuele abonnementsspecifieke voorwaarden die bij aankoop van toepassing zijn) vormen de volledige overeenkomst tussen u en de Uitgever met betrekking tot de Dienst."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "本利用規約（以下「本規約」といいます）は、お客様（以下「ユーザー」といいます）とKonvertoolsの提供元（以下「提供元」、「当社」、「弊社」といいます）との間の、Konvertoolsウェブサイトおよび関連するすべてのツール、API、サービス（以下総称して「サービス」といいます）のご利用に関する拘束力のある契約です。アカウントの作成、登録時の同意チェックボックスへのチェック、またはサービス内のいずれかのツールのご利用により、ユーザーは本規約を完全に読み、理解し、受け入れたことを確認したものとします。また、本規約とあわせて当社のプライバシーポリシーにも同意したものとします。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Konvertoolsは、ファイル変換ユーティリティ、文書・画像処理ツール、AI支援テキストユーティリティ、セキュリティ検証ツール（メール検証、フィッシング検出、URLスキャナー、SSL証明書チェッカー、パスワード漏洩チェッカー）、および開発者向けユーティリティのカタログを提供します。ほとんどのツールはブラウザ上で完全に実行されますが、一部のツールはサーバー処理を必要とします。サービスは、**「現状有姿」および「利用可能な状態で」**提供され、商品性、特定目的への適合性、または非侵害性を含む、いかなる種類の明示的または黙示的な保証もありません。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**法令により最大限許容される範囲で、提供元は、サービスのご利用またはご利用できないことにより生じるいかなる種類の損害についても責任を負いません。** 特に、ユーザーは以下の事項について同意し、承諾するものとします。"
          },
          {
            "kind": "ul",
            "items": [
              "データの損失、破損または不正なファイル、変換の失敗;",
              "ツールの出力に基づく判断、財務上・事業上その他の意思決定;",
              "ダウンタイム、レイテンシー、または機能の一時的な利用不可;",
              "サードパーティサービスの障害（Supabase、Mistral、Google Safe Browsing、HaveIBeenPwned、Paddle、Resend、ホスティングプロバイダー）;",
              "間接的、偶発的、特別、結果的、または懲罰的損害を含むいかなる種類の損害;",
              "請求の原因となった事象が発生する前12か月間にユーザーが当社に実際に支払った料金を超える金額、無料プラン利用者の場合は100ユーロを上限とします。"
            ]
          },
          {
            "kind": "p",
            "text": "**セキュリティツール**: URLスキャナー、フィッシング検出器、メール検証、SSL証明書チェッカー、パスワード漏洩チェッカーは、**情報提供および参考目的のみ**で提供されます。これらのツールは、Google Safe Browsing、パブリックDNS、HaveIBeenPwned、ライブTLSハンドシェイクなどのサードパーティのシグナルと大規模言語モデルのヒューリスティックを集約します。これらは**安全性、有効性、リスクの不存在を保証するものではありません**。新しいフィッシングページは、評判データベースがカタログ化するよりも速く出現します。検査を通過したメールであっても、未使用または不正な場合があります。SSL証明書が有効であっても、サイトの内容を保証するものではありません。提供元は、サービスが安全と判断したフィッシングメール、サービスが特定できなかった安全でないリンク、サービスが有効と判断したアドレスに送信されたトランザクションメール、またはこれらのツールに基づくセキュリティ判断に起因するいかなる損害についても、明示的に責任を負わないものとします。ユーザーは、これらの判断についての責任を単独で負うものとします。"
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "サービスの動作または可用性を妨害または低下させる目的で、過負荷をかけたり、リバースエンジニアリングを行ったり、スクレイピングを行ったり、レート制限を悪用したり、その他の方法で干渉すること;",
              "割り当てられたクォータ、支払い要件、またはその他の制限を回避すること;",
              "無料プランのクォータを複数のアカウントで不正に利用したり、プランで許可された以上の個人がアカウントを共有したりすること。"
            ]
          },
          {
            "kind": "p",
            "text": "当社は、本項に違反したと合理的な理由があると判断した場合、アカウントを直ちに通知なしで停止または終了することがあり、いかなる種類の返金も受けられません。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "ユーザーは、サービスに送信するファイルおよびテキストに関するすべての権利、所有権、利益を保持します。ユーザーは、要求されたツールを提供するために必要な範囲で、当社に対し、厳格に制限された、無償の、世界的なライセンスを付与します。このライセンスは、結果がユーザーに返却された瞬間（サーバー処理が必要なツール）に終了するか、ブラウザのみで実行されるツールの場合はそもそも発生しません（ファイルが当社に送信されないため）。当社は、ユーザーのコンテンツの所有権を主張することはなく、AIモデルのトレーニングにも使用しません。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "アカウントを作成するには、少なくとも16歳以上でなければなりません。ユーザーは、資格情報を機密に保持する責任を負い、アカウント下で発生したいかなる行為についても責任を負います。不正アクセスが疑われる場合は、直ちに[support@konvertools.com](mailto:support@konvertools.com)までご連絡ください。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**プラン**: 無料（0ユーロ）、Pro（月額25ユーロまたは年額210ユーロ）、Business（月額79ユーロまたは年額664ユーロ）。プランの機能およびクォータは、購入時の[料金ページ](/pricing)に記載のとおりです。当社は、30日間の事前通知をもってプランの機能を変更する権利を有します。",
              "**自動更新**: 月額および年額のサブスクリプションは、キャンセルされるまで同じ頻度で自動更新されます。ダッシュボードからいつでもキャンセルできます。キャンセルは現在の請求期間の終了時に有効となります。それまでは引き続きアクセスできます。",
              "**EUにおける解約権（撤回権）**: フランス消費者法第L. 221-28条に基づき、初回の14日間の解約期間中にサービスを能動的に利用した場合、契約の即時履行に明示的に同意したものとみなされ、解約権を放棄したものとします。有償機能を利用していない場合は、[support@konvertools.com](mailto:support@konvertools.com)までメールを送信することで14日以内に解約でき、当社は14日以内に全額返金いたします。",
              "**部分返金不可**: 上記の解約シナリオを除き、現在の請求期間に支払われた料金は返金されません。",
              "**価格改定**: 当社は30日間の事前通知をもって価格を改定することがあります。既存のサブスクライバーは、次回の更新日まで現在の価格が適用されます。",
              "**税金**: Paddleはすべての購入に関するマーチャント・オブ・レコードであり、販売記録の売り手として機能します。Paddleは、お客様の管轄地で適用されるVATまたは売上税を計算、徴収、納付するため、チェックアウト時に支払う価格にはすでに適用される税金が含まれています。"
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "サービスの名称、ロゴ、コード、デザイン、ドキュメント、データベース構造、および集約されたコンテンツは、提供元の排他的な所有物であり、フランスおよび国際的な知的財産法によって保護されています。サービスを意図したとおりに利用するために厳格に必要な場合を除き、ユーザーにライセンスは付与されません。ユーザーは、適用法によって明示的に許可されている場合を除き、サービスまたはその一部を複製、改変、逆コンパイル、派生的著作物を作成することはできません。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "ユーザーは、以下に起因するいかなる請求、損失、損害、責任、費用（合理的な弁護士費用を含む）について、提供元を免責し、損害から保護することに同意します。（a）本規約の違反、（b）法令または第三者の権利の違反、（c）サービスに送信したコンテンツ。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "当社は、本規約を随時改定することがあります。実質的な変更については、有効になる少なくとも30日前にアカウント保持者にメールで通知します。この期間を経過した後もサービスをご利用いただくことで、改定後の規約に同意したものとみなされます。最新版は常に[https://konvertools.com/terms](https://konvertools.com/terms)でご確認いただけます。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "ユーザーは、いつでもダッシュボードからアカウントを解約できます。当社は、本規約に違反した場合、サービスを悪用した場合、または定期的なサブスクリプション料金の支払いがなかった場合、直ちにアカウントを解約または停止することがあります。解約後、当社のプライバシーポリシーに記載のとおり、請求記録および同意記録を除き、30日以内にデータが削除されます。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "本規約はフランス法に準拠します。本規約またはサービスに関連する紛争については、EU消費者の居住国における消費者の強制的な権利行使が適用される場合を除き、フランス・パリの裁判所を専属的管轄裁判所とします。法的措置を開始する前に、[support@konvertools.com](mailto:support@konvertools.com)に書面で連絡し、紛争を友好的かつ円満に解決することに同意します。EUの消費者は、欧州委員会のオンライン紛争解決プラットフォーム[ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr)も利用できます。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "本規約のいずれかの条項が無効または執行不能と判断された場合でも、他の条項は完全に有効のままです。当社が権利または条項を執行しないことは、その権利の放棄を意味しません。本規約（購入時に参照されるプラン固有の条項を含む）およびプライバシーポリシーは、サービスに関するユーザーと提供元との間の完全な合意を構成します。"
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "本《服务条款》（以下简称“条款”）构成您（以下称“您”或“用户”）与 Konvertools 的发布者（以下称“发布者”、“我们”或“本公司”）之间的一项具有约束力的协议，涵盖您对 Konvertools 网站及其所有相关工具、API 和服务（统称为“服务”）的使用。通过创建账户、在注册时勾选接受框或仅使用服务中的任何工具，您即确认已完整阅读、理解并接受本条款的全部内容，同时一并接受我们的隐私政策。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Konvertools 提供一系列文件转换实用工具、文档与图像处理工具、AI 辅助文本工具、指示性安全工具（邮箱验证器、钓鱼网站检测器、URL 扫描器、SSL 证书检查器、密码泄露检查器）以及开发者实用工具。大多数工具完全在您的浏览器中执行；部分工具需要服务器处理。服务以“**原样**”和“**按现状**”提供，不附带任何明示或暗示的保证，包括但不限于适销性、适用于特定用途或不侵权。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**在法律允许的最大范围内，发布者对您使用或无法使用服务而产生的任何损害概不承担责任。**具体而言，您承认并同意发布者无需对以下情况承担责任："
          },
          {
            "kind": "ul",
            "items": [
              "数据丢失、文件损坏或转换失败；",
              "基于任何工具输出所做出的决策（包括财务、商业决策等）；",
              "服务的停机、延迟或临时不可用；",
              "第三方服务故障（Supabase、Mistral、Google Safe Browsing、HaveIBeenPwned、Paddle、Resend、托管服务提供商）；",
              "间接、附带、特殊、后果性或惩罚性损害赔偿；",
              "任何超过您在引发索赔事件前十二（12）个月内实际向我们支付的费用的累计金额，免费用户的上限为一百（100）欧元。"
            ]
          },
          {
            "kind": "p",
            "text": "**安全工具**：URL 扫描器、钓鱼网站检测器、邮箱验证器、SSL 证书检查器及密码泄露检查器仅供**参考和指示性使用**。它们汇总第三方信号（Google Safe Browsing、公共 DNS、HaveIBeenPwned、实时 TLS 握手）和大语言模型启发式方法。这些工具**不构成安全性、有效性或无风险的保证**。新的钓鱼网页出现的速度远超信誉数据库的收录速度；通过我们检查的邮件仍可能无效或存在欺诈；SSL 证书有效并不代表网站内容的安全性。发布者明确拒绝对任何因服务判定为安全的钓鱼邮件、未识别的不安全链接、被服务标记为有效的地址发送的交易邮件或基于这些工具做出的任何安全决策所导致的损害承担责任。用户应对上述决策承担全部责任。"
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "规避配额、付费要求或其他限制；",
              "创建多个账户以增加免费额度或将一个账户共享给超出您套餐允许的人员。"
            ]
          },
          {
            "kind": "p",
            "text": "如我们有合理理由相信您违反本条款，我们可立即无通知暂停或终止您的账户，且无权获得任何形式的退款。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "您对提交至服务的文件和文本保留所有权利、所有权和利益。您授予我们一项严格限制的、免版税的、全球性许可，仅用于处理您的内容以提供您请求的工具。该许可在将结果返回给您时（服务器辅助工具）立即终止，或在浏览器工具中从不生效（您的文件不会传输至我们）。我们不会、也不会主张对您的内容拥有所有权，或将其用于训练 AI 模型。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "您必须年满十六（16）周岁才能创建账户。您对保管好凭证负责，并对在您账户下发生的任何活动负责。如发现任何未经授权的访问，请立即通过 [support@konvertools.com](mailto:support@konvertools.com) 通知我们。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**套餐**：免费（€0）、专业版（€25/月或€210/年）、商业版（€79/月或€664/年）。套餐功能和配额以购买时我方 [定价页面](/pricing) 上的说明为准。我们保留在提前 30 天通知的情况下修改套餐功能的权利。",
              "**自动续费**：月度和年度订阅将自动续费，直至取消。您可随时通过仪表板取消订阅；取消将在当前计费周期结束时生效。您将保留访问权限直至该日期。",
              "**撤回权（欧盟）**：根据《法国消费者法》第 L. 221-28 条，在初始 14 天撤回期内主动使用服务的，您明确同意立即履行合同并放弃撤回权。如您未使用任何付费功能，可在 14 天内通过发送邮件至 [support@konvertools.com](mailto:support@konvertools.com) 撤回，我们将在 14 天内全额退款。",
              "**不予部分退款**：除上述撤回情形外，当前计费周期内已支付的费用概不退款。",
              "**价格变更**：我们可在提前 30 天通知的情况下修改价格。现有订阅用户在下次续费前将维持当前价格。",
              "**税费**：Paddle 作为所有购买的商户记录，并作为销售记录方。它计算、收取并缴纳您所在司法管辖区应缴的任何增值税或销售税，因此您在结账时支付的价格已包含任何适用税费。"
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "服务的名称、徽标、代码、设计、文档、数据库结构及汇总内容均为发布者的独家财产，受法国及国际知识产权法保护。除为使用服务所必需的严格限制外，您无权复制、修改、反编译或创建服务或其任何部分的衍生作品，法律另有明确规定的除外。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "您同意对以下情况向发布者进行赔偿并使其免受损害：（a）您违反本条款；（b）您违反任何法律或第三方权利；（c）您向服务提交的任何内容所引发的任何索赔、损失、损害、责任、成本或费用（包括合理的律师费）。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "我们可能不时修改本条款。重大变更将至少在生效前三十（30）天通过邮件通知账户持有人。在该期限后继续使用服务即表示您接受修改后的条款。最新版本始终可在 [https://konvertools.com/terms](https://konvertools.com/terms) 获取。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "您可随时通过仪表板终止账户。如您违反本条款、滥用服务或未支付订阅费用，我们可立即暂停或终止您的账户。账户终止后，您的数据将在三十（30）天内删除，但计费记录和同意记录将按隐私政策所述保留。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "本条款受法国法律管辖。与本条款或服务相关的任何争议应提交法国巴黎法院专属管辖，但欧盟或适用的国内法赋予消费者在其居住国享有的强制性诉讼权利除外。在提起法律诉讼前，您同意通过书面方式尝试友好解决争议，发送至 [support@konvertools.com](mailto:support@konvertools.com)。欧盟消费者还可使用欧盟委员会的在线争议解决平台 [ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr)。"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "如本条款的任何条款被认定为无效或不可执行，其余条款仍完全有效。我们未行使任何权利或条款不构成对该权利的放弃。本条款（连同隐私政策及购买时引用的特定套餐条款）构成您与发布者之间关于服务的完整协议。"
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "본 서비스 약관(이하 \"약관\")은 귀하(이하 \"사용자\")와 Konvertools의 발행자(이하 \"발행자\", \"우리\", \"저희\") 간의 Konvertools 웹사이트 및 모든 관련 도구, API 및 서비스(이하 \"서비스\") 사용에 관한 구속력 있는 계약을 형성합니다. 계정을 생성하거나, 가입 시 수락 체크박스를 클릭하거나, 서비스 내의 도구를 단순히 사용할 때, 귀하는 본 약관 전체를 읽고 이해했으며, 개인정보 보호정책과 함께 전적으로 수락했음을 확인합니다."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Konvertools는 파일 변환 유틸리티, 문서 및 이미지 처리 도구, AI 지원 텍스트 유틸리티, 지표 보안 도구(이메일 확인자, 피싱 탐지기, URL 스캐너, SSL 인증서 확인기, 비밀번호 유출 확인기) 및 개발자 유틸리티로 구성된 카탈로그를 제공합니다. 대부분의 도구는 브라우저 내에서 완전히 실행되며, 일부는 서버 처리가 필요합니다. 서비스는 **\"있는 그대로\"** 및 **\"사용 가능한 상태로\"** 제공되며, 명시적 또는 묵시적 보증(상품성, 특정 목적 적합성, 비침해 포함)을 포함하여 어떠한 종류의 보증도 없습니다."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**법이 허용하는 최대한의 범위에서, 발행자는 서비스 사용 또는 사용 불가로 인한 모든 종류의 손해에 대한 책임을 부인합니다.** 특히, 귀하는 다음 사항을 인정하고 동의합니다. 발행자는 다음에 대해 책임을 지지 않습니다."
          },
          {
            "kind": "ul",
            "items": [
              ...
              "서비스의 가동 중단, 지연 또는 일시적 이용 불가;",
              "서드파티 서비스 장애(Supsabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, 호스팅 제공업체);",
              "간접적, 우발적, 특별, 결과적 또는 징벌적 손해;",
              "사건 발생 12개월 전 귀하가 지불한 실제 요금을 초과하는 금액(무료-tier 사용자의 경우 100유로 한도)."
            ]
          },
          {
            "kind": "p",
            "text": "**보안 도구**: URL 스캐너, 피싱 탐지기, 이메일 확인자, SSL 인증서 확인기 및 비밀번호 유출 확인기는 **정보 제공 및 지표 목적**으로만 제공됩니다. 이들은 서드파티 신호(Google Safe Browsing, 공개 DNS, HaveIBeenPwned, 실시간 TLS 핸드셰이크) 및 대규모 언어 모델 기반 추론을 집계합니다. 이들은 **안전성, 유효성 또는 위험 부재에 대한 보증을 구성하지 않습니다**. 새로운 피싱 페이지는 평판 데이터베이스가 카탈로그화할 수 있는 것보다 더 빠르게 나타나며, 확인을 통과한 이메일이 여전히 비활성 또는 사기성일 수 있습니다. SSL 인증서가 유효하다고 해서 사이트의 콘텐츠가 안전하다는 의미는 아닙니다. 발행자는 이러한 도구에 따라 내린 보안 결정으로 인해 발생한 모든 피해에 대해 명시적으로 책임을 거부합니다. 사용자는 이러한 결정에 대한 전적인 책임을 집니다."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "사기, 돈세탁, 테러 자금 조달 또는 기타 범죄 활동의 facilitation;",
              "AI 인간화 도구, AI 텍스트 도구 또는 기타 기능을 사용하여 표절, 제3자를 기만, 학술, 채용, 광고 네트워크 등 평가 시스템을 규정을 위반하는 방식으로 조작, 또는 적용 가능한 법률을 위반하는 방식으로 오도;",
              "서비스의 운영 또는 가용성을 방해하거나 과부하, 리버스 엔지니어링, 스크래핑, 비율 제한 남용을 시도하거나 기타 간섭;",
              "할당량, 결제 요구 사항 또는 기타 제한을 우회;",
              "무료-tier 할당량을 늘리기 위해 다중 계정을 생성하거나, 계획에서 허용하는 것보다 더 많은 개인 간 계정 공유."
            ]
          },
          {
            "kind": "p",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "귀하는 서비스에 제출한 파일 및 텍스트에 대한 모든 권리, 소유권 및 이익을 보유합니다. 귀하는 요청한 도구를 제공하기 위한 목적으로만 처리하기 위해 전 세계적으로, 무상으로, 엄격히 제한된 라이선스를 발행자에게 부여합니다. 이 라이선스는 결과가 귀하에게 반환되는 즉시 종료됩니다(서버 지원 도구) 또는 브라우저 전용 도구의 경우 파일이 저희에게 전송되지 않으므로 라이선스가 발생하지 않습니다. 저희는 귀하의 콘텐츠를 소유권을 주장하지 않으며, AI 모델 학습에 사용하지 않습니다."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "계정을 생성하려면 최소 16세 이상이어야 합니다. 귀하는 자신의 인증 정보를 비밀로 유지할 책임이 있으며, 계정에서 발생하는 모든 활동에 대해 책임을 집니다. [support@konvertools.com](mailto:support@konvertools.com)으로 즉시 알리십시오."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**플랜**: 무료(€0), Pro(월 €25 또는 연 €210), Business(월 €79 또는 연 €664). 플랜 기능 및 할당량은 구매 시 [가격 페이지](/pricing)에서 설명한 대로입니다. 저희는 30일 전에 플랜 기능을 변경할 권리를 보유합니다.",
              "**자동 갱신**: 월별 및 연간 구독은 취소할 때까지 동일한 주기로 자동 갱신됩니다. 언제든지 대시보드에서 취소할 수 있으며, 취소는 현재 결제 기간이 종료될 때 적용됩니다. 해당 날짜까지 액세스 권한을 유지합니다.",
              "**철회 권리(EU)**: 프랑스 소비자법 제 L. 221-28조에 따라, 초기 14일 철회 기간 동안 서비스를 적극적으로 사용할 경우 계약의 즉시 이행을 명시적으로 동의하며, 철회권을 포기합니다. 유료 기능을 사용하지 않은 경우 [support@konvertools.com](mailto:support@konvertools.com)으로 이메일을 보내 14일 이내 철회할 수 있으며, 저희는 14일 이내 전액 환불을 발행합니다.",
              "**부분 환불 불가**: 위 철회 시나리오 외에는 현재 결제 기간에 이미 지불된 요금은 환불되지 않습니다.",
              "**가격 변경**: 저희는 30일 전에 가격을 변경할 수 있습니다. 기존 구독자는 다음 갱신일까지 현재 가격을 유지합니다.",
              "**세금**: Paddle은 모든 구매의 Merchant of Record로, 구매의 판매자로서 역할을 하며, 귀하의 관할권에서 부과되는 부가가치세 또는 판매세를 계산, 징수 및 납부합니다. 따라서 결제 시 지불하는 가격에 해당 세금이 이미 포함되어 있습니다."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "서비스의 이름, 로고, 코드, 디자인, 문서, 데이터베이스 구조 및 집계된 콘텐츠는 발행자의 독점 재산으로, 프랑스 및 국제 지적 재산법에 의해 보호됩니다. 서비스 사용 목적에 strictly 필요한 경우를 제외하고는 어떠한 라이선스도 부여되지 않습니다. 적용 가능한 법률에 의해 명시적으로 허용된 경우를 제외하고는 서비스의 복제, 수정, 디컴파일 또는 파생 작업을 수행할 수 없습니다."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "귀하는 다음 사항으로부터 발생하는 모든 청구, 손실, 손해, 책임, 비용 또는 비용(합리적인 법적 수수료 포함)에 대해 발행자를 면책하고 무해하도록 동의합니다: (a) 본 약관 위반, (b) 법 또는 제3자 권리 위반, (c) 서비스에 제출한 콘텐츠."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "저희는 때때로 약관을 개정할 수 있습니다. 실질적인 변경 사항은 계정 보유자에게 약관 발효 30일 전에 이메일로 통보됩니다. 해당 기간 후에도 서비스를 계속 사용하면 개정된 약관에 동의하는 것으로 간주됩니다. 최신 버전은 항상 [https://konvertools.com/terms](https://konvertools.com/terms)에서 확인할 수 있습니다."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "언제든지 대시보드에서 계정을 종료할 수 있습니다. 본 약관을 위반하거나, 서비스를 남용하거나, 정기 구독료를 미납할 경우 즉시 예고 없이 계정을 종료 또는 정지할 수 있습니다. 종료 시 개인정보 보호정책에 설명된 대로 보관된 결제 기록 및 동의 기록을 제외하고 30일 이내에 데이터가 삭제됩니다."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "본 약관은 프랑스 법률에 따라 규율됩니다. 본 약관 또는 서비스와 관련하여 발생하는 분쟁은 유럽 연합 또는 적용 가능한 국내법에 따라 소비자의 강제적 권리가 우선하는 경우를 제외하고는 프랑스 파리 법원의 전속 관할권에 제출됩니다. 법적 조치를 시작하기 전에 [support@konvertools.com](mailto:support@konvertools.com)으로 서면으로 분쟁을amicable하게 해결하려고 노력하기로 동의합니다. EU 소비자는 [ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr)에서 유럽 위원회의 온라인 분쟁 해결 플랫폼을 사용할 수도 있습니다."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "본 약관의 어느 조항이 무효 또는 집행 불가능하다고 판단되더라도 나머지 조항은 전적으로 유효합니다. 저희의 권리 또는 조항의 집행 실패는 해당 권리의 포기로 간주되지 않습니다. 본 약관(개인정보 보호정책 및 구매 시 참조된 플랜별 약관과 함께)은 서비스에 관한 귀하와 발행자 간의 전체 계약을 구성합니다."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "تشكل هذه الشروط العامة للخدمة (\"الشروط\") اتفاقية ملزمة بينك (\"المستخدم\") والناشر لـ Konvertools (\"الناشر\"، \"نحن\"، \"لدينا\") فيما يتعلق باستخدامك لموقع Konvertools وجميع الأدوات والخدمات ذات الصلة (بما في ذلك \"الخدمة\"). من خلال إنشاء حساب، أو تحديد مربع القبول عند التسجيل، أو ببساطة باستخدام أي أداة على الخدمة، فإنك تؤكد أنك قد قرأت وفهمت وقبلت هذه الشروط بالكامل، إلى جانب سياستنا العامة."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "توفر Konvertools كتالوجاً لأدوات تحويل الملفات، وأدوات معالجة المستندات والصور، وأدوات النص المدعومة بالذكاء الاصطناعي، وأدوات الأمان الإرشادية (محقق البريد الإلكتروني، كاشف التصيد، ماسح الروابط، فاحص شهادة SSL، فاحص اختراق كلمات المرور) وأدوات المطورين. تنفذ معظم الأدوات بالكامل في متصفحك؛ بينما تتطلب بعضها معالجة على الخادم. تُقدم الخدمة **\"كما هي\" و\"كما متوفرة\"** دون أي ضمان من أي نوع، سواء كان ذلك صريحاً أو ضمنياً، بما في ذلك القابلية للتسويق، أو الملاءمة لغرض معين، أو عدم التعدي."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**إلى الحد الأقصى المسموح به بموجب القانون، يتنازل الناشر عن أي مسؤولية عن الأضرار من أي نوع ناجمة عن استخدامك، أو عدم قدرتك على استخدام، الخدمة.** على وجه الخصوص، أنت تقر وتوافق على أن الناشر لن يكون مسؤولاً عن:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "فشل الخدمات التابعة لجهات خارجية (Supabase، Mistral، Google Safe Browsing، HaveIBeenPwned، Paddle، Resend، مزودي الاستضافة)؛",
              "الأضرار غير المباشرة، العرضية، الخاصة، اللاحقة أو العقابية من أي نوع؛",
              "أي مبلغ إجمالي يتجاوز الرسوم التي دفعتها إلينا فعلياً في الاثني عشر (12) شهراً السابقة للحدث الذي أدى إلى المطالبة، مع سقف قدره مائة (100) يورو للمستخدمين من المستوى المجاني."
            ]
          },
          {
            "kind": "p",
            "text": "**أدوات الأمان**: ماسح الروابط، وكاشف التصيد، ومحقق البريد الإلكتروني، وفاحص شهادة SSL، وفاحص اختراق كلمات المرور تُقدم **لأغراض إرشادية واستدلالية فقط**. فهي تجمع إشارات من جهات خارجية (Google Safe Browsing، DNS العام، HaveIBeenPwned، مصافحات TLS الحية) وقياسات نماذج اللغة الكبيرة. لا تشكل هذه الأدوات **ضماناً للسلامة أو الصحة أو عدم وجود مخاطر**. تظهر صفحات التصيد الجديدة أسرع من قدرة قواعد البيانات على تصنيفها؛ قد يكون البريد الإلكتروني الذي يجتاز فحصنا لا يزال غير نشط أو احتيالياً؛ لا يضمن صلاحية شهادة SSL محتوى الموقع. يتنازل الناشر صراحة عن أي مسؤولية عن أي ضرر ناتج عن بريد إلكتروني تصيدي اعتبرته الخدمة آمناً، أو رابط غير آمن فشلت في تحديده، أو بريد إلكتروني معاملاتي أُرسل إلى عنوان اعتبرته الخدمة صالحاً، أو أي قرار أمني اتخذ بناءً على هذه الأدوات. يتحمل المستخدم المسؤولية الكاملة عن مثل هذه القرارات."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "استخدام أدوات الذكاء الاصطناعي (مثل أداة التحويل البشري، وأدوات النص المدعومة بالذكاء الاصطناعي) أو أي ميزة أخرى للانتحال، أو لخداع طرف ثالث، أو للتلاعب بأنظمة التقييم (الأكاديمية، التوظيف، شبكات الإعلانات) بما يخالف قواعدها، أو لإضفاء طابع خادع بأي طريقة تنتهك القانون المعمول به؛",
              "محاولة تحميل الخدمة، أو الهندسة العكسية، أو الاستخلاص، أو تجاوز حدود المعدل، أو التدخل بأي طريقة في تشغيل الخدمة أو توافرها؛",
              "التحايل على الحصص أو متطلبات الدفع أو أي قيود أخرى مفروضة؛",
              "إنشاء حسابات متعددة لتكثيف حصص المستوى المجاني، أو مشاركة حساب عبر أكثر من فرد مما يسمح به اشتراكك."
            ]
          },
          {
            "kind": "p",
            "text": "يجوز لنا تعليق أو إنهاء حسابك فوراً ودون إشعار إذا كان لدينا أسباب معقولة للاعتقاد بأنك انتهكت هذا القسم، دون أي حق في استرداد أي مبلغ."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "أنت تحتفظ بجميع الحقوق، والملكية، والفائدة في الملفات والنصوص التي تقدمها إلى الخدمة. تمنحنا ترخيصاً محدوداً للغاية، ومجانياً، وعالمياً لمعالجة هذه الملفات والنصوص solely لتقديم الأداة التي طلبتها. ينتهي هذا الترخيص فوراً عند إرجاع النتيجة إليك (الأدوات المعتمدة على الخادم) أو لا ينشأ أصلاً (الأدوات التي تعمل في المتصفح فقط، حيث لا تصل ملفاتك إلينا أبداً). نحن لا نطالب، ولن نطالب، بملكية محتواك، ولا نستخدمه لتدريب نماذج الذكاء الاصطناعي."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "يجب أن يكون عمرك ستة عشر (16) عاماً على الأقل لإنشاء حساب. أنت مسؤول عن الحفاظ على سرية بيانات اعتمادك وأي نشاط يحدث تحت حسابك. أخبرنا فوراً عبر البريد الإلكتروني [support@konvertools.com](mailto:support@konvertools.com) بأي وصول غير مصرح به مشتبه به."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**الخطط**: مجاني (€0)، احترافي (€25/شهر أو €210/سنة)، أعمال (€79/شهر أو €664/سنة). يتم وصف ميزات الخطط والحصص على [صفحة التسعير الخاصة بنا](/pricing) وقت الشراء. نحتفظ بحق تعديل ميزات الخطط مع إشعار مدته 30 يوماً.",
              "**التجديد التلقائي**: يتم تجديد الاشتراكات الشهرية والسنوية تلقائياً بنفس وتيرتها حتى الإلغاء. يمكنك الإلغاء في أي وقت من لوحة التحكم الخاصة بك؛ يدخل الإلغاء حيز التنفيذ في نهاية فترة الفوترة الحالية. ستحتفظ بالوصول حتى ذلك التاريخ.",
              "**حق الانسحاب (الاتحاد الأوروبي)**: بموجب المادة L. 221-28 من قانون المستهلك الفرنسي، عندما تستخدم الخدمة بنشاط خلال فترة الانسحاب الأولية التي مدتها 14 يوماً، فإنك توافق صراحة على التنفيذ الفوري للعقد وتتنازل عن حقك في الانسحاب. إذا لم تستخدم أي ميزة مدفوعة، يمكنك الانسحاب خلال 14 يوماً عبر إرسال بريد إلكتروني إلى [support@konvertools.com](mailto:support@konvertools.com) وسنقوم برد المبلغ بالكامل خلال 14 يوماً.",
              "**لا استرداد جزئي**: خارج سيناريو الانسحاب المذكور أعلاه، فإن الرسوم المدفوعة بالفعل للفترة الفواتيرية الحالية غير قابلة للاسترداد.",
              ...
              "**الضريبة**: Paddle هي جهة البيع المسجلة لجميع المشتريات وتعمل كبائع مسجل. إنها تحسب وتجمع وتحول أي ضريبة VAT أو ضريبة مبيعات مستحقة في ولايتك القضائية، لذا فإن السعر الذي تدفعه عند الدفع يشمل أي ضريبة مطبقة."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "الاسم، والشعار، والكود، والتصميم، والتوثيق، وهيكل قاعدة البيانات والمحتوى المجمّع للخدمة هي ملكية حصرية للناشر وتحميها قوانين الملكية الفكرية الفرنسية والدولية. لا يُمنح لك أي ترخيص سوى ما هو ضروري بشكل صارم لاستخدام الخدمة كما هو مقصود. لا يجوز لك استنساخ أو تعديل أو فك تشفير أو إنشاء أعمال مشتقة من الخدمة أو أي جزء منها، إلا إذا كان ذلك مسموحاً به صراحة بموجب القانون المعمول به."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "يجوز لنا تعديل هذه الشروط من وقت لآخر. سيتم إشعار التغييرات الجوهرية عبر البريد الإلكتروني لحاملي الحسابات قبل ثلاثين (30) يوماً على الأقل من سريانها. من خلال مواصلة استخدام الخدمة بعد هذه الفترة، فإنك تقبل الشروط المعدلة. النسخة الأحدث متاحة دائماً على [https://konvertools.com/terms](https://konvertools.com/terms)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "يجوز لك إنهاء حسابك في أي وقت من لوحة التحكم الخاصة بك. يجوز لنا إنهاء أو تعليق حسابك فوراً ودون إشعار إذا انتهكت هذه الشروط، أو أسأت استخدام الخدمة، أو فشلت في دفع اشتراك متكرر. عند الإنهاء، يتم حذف بياناتك خلال ثلاثين (30) يوماً، باستثناء سجلات الفوترة وسجلات الموافقة التي يتم الاحتفاظ بها كما هو موضح في سياستنا العامة."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "تخضع هذه الشروط لقوانين فرنسا. أي نزاع ينشأ عن أو فيما يتعلق بهذه الشروط أو الخدمة يخضع للاختصاص الحصري لمحاكم باريس، فرنسا، باستثناء حق المستهلك الإلزامي في بلده الأصلي بموجب قانون الاتحاد الأوروبي أو القانون الوطني المعمول به. قبل الشروع في أي إجراء قانوني، соглашаетесь попытаться разрешить спор мирным путем, написав на [support@konvertools.com](mailto:support@konvertools.com). могут также воспользоваться платформой Европейской комиссии по разрешению споров в Интернете по адресу [ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "إذا تم اعتبار أي بند من هذه الشروط باطلاً أو غير قابل للتنفيذ، остальные положения остаются в полной силе. عدم تطبيقنا لأي حق أو شرط لا يشكل تنازلاً عن ذلك الحق. تشكل هذه الشروط (إلى جانب السياسة العامة وأي شروط محددة للخطة المشار إليها عند الشراء) الاتفاق الكامل بينك وبين الناشر فيما يتعلق بالخدمة."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Настоящие Условия обслуживания (далее — «Условия») представляют собой обязательное соглашение между вами (далее — «Пользователь») и издателем Konvertools (далее — «Издатель», «мы», «нас») в отношении использования вами веб-сайта Konvertools и всех связанных инструментов, API и услуг (совокупно именуемых «Услуга»). Создавая учётную запись, отмечая флажок принятия при регистрации или просто используя любой инструмент на Услуге, вы подтверждаете, что ознакомились, поняли и полностью принимаете настоящие Условия, а также нашу Политику конфиденциальности."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Konvertools предоставляет каталог утилит для конвертации файлов, инструменты обработки документов и изображений, утилиты с поддержкой ИИ, индикативные инструменты безопасности (проверка электронной почты, детектор фишинга, сканер URL, проверка SSL-сертификатов, проверка утечек паролей) и инструменты для разработчиков. Большинство инструментов работают полностью в вашем браузере; часть требует серверной обработки. Услуга предоставляется **«как есть»** и **«доступна»** без каких-либо гарантий любого рода, явных или подразумеваемых, включая пригодность для продажи, соответствие конкретной цели или отсутствие нарушений."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**В максимальной степени, допустимой законом, Издатель снимает с себя ответственность за любой ущерб, возникший в результате использования вами Услуги или невозможности её использования.** В частности, вы признаёте и соглашаетесь с тем, что Издатель не несёт ответственности за:"
          },
          {
            "kind": "ul",
            "items": [
              "потерю данных, повреждённые или некорректные файлы, неудачные конвертации;",
              "решения, финансовые, деловые или иные, принятые вами на основе результатов работы любого инструмента;",
              "простои, задержки или временную недоступность любой функции;",
              "сбои сторонних сервисов (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, хостинг-провайдеры);",
              "косвенный, случайный, специальный, косвенный или штрафной ущерб любого рода;",
              "любую совокупную сумму, превышающую плату, фактически уплаченную вами нам в течение двенадцати (12) месяцев, предшествующих событию, повлёкшему претензию, с лимитом в сто (100) евро для пользователей бесплатного уровня."
            ]
          },
          {
            "kind": "p",
            "text": "**Инструменты безопасности**: Сканер URL, Детектор фишинга, Проверка электронной почты, Проверка SSL-сертификатов и Проверка утечек паролей предоставляются **исключительно в информационных и индикативных целях**. Они агрегируют сторонние сигналы (Google Safe Browsing, публичные DNS, HaveIBeenPwned, живые TLS-рукопожатия) и эвристику на основе больших языковых моделей. Они **не являются гарантией безопасности, достоверности или отсутствия риска**. Новые фишинговые страницы появляются быстрее, чем базы репутации успевают их каталогизировать; электронное письмо, прошедшее проверку, может оказаться неактивным или мошенническим; наличие действующего SSL-сертификата не подтверждает достоверность содержимого сайта. Издатель прямо отказывается от любой ответственности за любой вред, возникший в результате фишингового письма, которое Услуга сочла безопасным, небезопасной ссылки, которую Услуга не смогла идентифицировать, транзакционного письма, отправленного на адрес, который Услуга пометила как действительный, или любого решения о безопасности, принятого на основе этих инструментов. Пользователь несет единоличную ответственность за такие решения."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Вы соглашаетесь **не** использовать Услугу для:"
          },
          {
            "kind": "ul",
            "items": [
              "загрузки, обработки или распространения контента, который является незаконным в вашей юрисдикции или во Франции;",
              "обработки файлов, на которые у вас нет необходимых прав (произведения, защищённые авторским правом без разрешения, персональные данные, к обработке которых вы не уполномочены, засекреченная информация);",
              "совершения или содействия мошенничеству, отмыванию денег, финансированию терроризма или любой преступной деятельности;",
              "использования инструментов для «человезации» текстов, ИИ-инструментов или любых других функций для плагиата, обмана третьих лиц, манипуляции системами оценки (академическими, рекрутинговыми, рекламными сетями) в нарушение их правил, или введения в заблуждение любым способом, противоречащим применимому законодательству;",
              "попыток перегрузить систему, обратного инжиниринга, скрапинга, нарушения лимитов запросов или иного вмешательства в работу или доступность Услуги;",
              "обхода квот, требований оплаты или любых других ограничений, установленных в Услуге;",
              "создания нескольких учётных записей для увеличения квот бесплатного уровня или совместного использования одной учётной записи несколькими лицами сверх допустимого по вашему тарифу."
            ]
          },
          {
            "kind": "p",
            "text": "Мы можем немедленно приостановить или заблокировать вашу учётную запись без предварительного уведомления, если у нас есть разумные основания полагать, что вы нарушили данный раздел, без права на возмещение уплаченных сумм."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Вы сохраняете все права, титул и интерес в отношении файлов и текста, которые вы отправляете в Услугу. Вы предоставляете нам строго ограниченную, безвозмездную, всемирную лицензию на их обработку исключительно для предоставления запрошенного вами инструмента. Эта лицензия прекращает своё действие в момент возврата результата вам (инструменты с серверной обработкой) или не возникает вовсе (инструменты, работающие только в браузере, поскольку ваш файл до нас не доходит). Мы не претендуем и не будем претендовать на право собственности на ваш контент и не используем его для обучения ИИ-моделей."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Автоматическое продление**: ежемесячные и годовые подписки продлеваются автоматически в том же режиме до момента отмены. Вы можете отменить подписку в любой момент через личный кабинет; отмена вступает в силу по окончании текущего расчётного периода. Вы сохраняете доступ до этой даты.",
              "**Право на отказ (ЕС)**: в соответствии со статьёй L. 221-28 Французского потребительского кодекса, если вы активно используете Услугу в течение первоначального 14-дневного периода отказа, вы прямо соглашаетесь на немедленное исполнение договора и отказываетесь от права на отказ. Если вы не использовали ни одну из платных функций, вы можете отказаться в течение 14 дней, отправив письмо на [support@konvertools.com](mailto:support@konvertools.com), и мы вернём вам полную сумму в течение 14 дней.",
              ...
              "**Налоги**: Paddle выступает Merchant of Record для всех покупок и является продавцом по записи. Он рассчитывает, взимает и перечисляет любой НДС или налог с продаж, применимый в вашей юрисдикции, поэтому цена, которую вы видите при оформлении заказа, уже включает любой применимый налог."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Название, логотип, код, дизайн, документация, структура базы данных и агрегированный контент Услуги являются исключительной собственностью Издателя и защищены французским и международным законодательством об интеллектуальной собственности. Вам предоставляется только та лицензия, которая строго необходима для использования Услуги по назначению. Вы не вправе воспроизводить, изменять, декомпилировать Услугу или создавать производные произведения на её основе или на основе любой её части, кроме случаев, прямо разрешённых применимым законом."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Вы соглашаетесь возмещать Издателю любой ущерб, убытки, обязательства, расходы (включая разумные юридические гонорары), возникшие в результате (a) вашего нарушения настоящих Условий, (b) вашего нарушения любого закона или прав третьих лиц, или (c) любого контента, который вы отправили в Услугу."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Мы можем время от времени изменять настоящие Условия. Существенные изменения будут доведены до сведения владельцев учётных записей по электронной почте не менее чем за тридцать (30) дней до их вступления в силу. Продолжая использовать Услугу после этого периода, вы принимаете изменённые Условия. Последняя версия всегда доступна по адресу [https://konvertools.com/terms](https://konvertools.com/terms)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Вы можете в любой момент удалить свою учётную запись через личный кабинет. Мы можем немедленно приостановить или заблокировать вашу учётную запись без предварительного уведомления, если вы нарушили настоящие Условия, злоупотребили Услугой или не оплатили текущую подписку. После прекращения действия ваши данные удаляются в течение тридцати (30) дней, за исключением платёжных и записей о согласии, которые хранятся в соответствии с нашей Политикой конфиденциальности."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Если какое-либо положение настоящих Условий признано недействительным или неисполнимым, остальные положения сохраняют полную силу. Наше неисполнение какого-либо права или положения не является отказом от этого права. Настоящие Условия (вместе с Политикой конфиденциальности и любыми специфическими условиями тарифных планов, упомянутыми при покупке) составляют полное соглашение между вами и Издателем в отношении Услуги."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "ये सेवा की शर्तें (\"शर्तें\") आपके (\"उपयोगकर्ता\") और Konvertools के प्रकाशक (\"प्रकाशक\", \"हम\", \"हमें\") के बीच एक बाध्यकारी समझौता है, जो Konvertools वेबसाइट और उससे संबंधित सभी टूल, API और सेवाओं (सामूहिक रूप से \"सेवा\") के आपके उपयोग के संबंध में है। एक खाता बनाकर, साइन-अप पर स्वीकृति चेकबॉक्स पर टिक करके, या सेवा पर किसी भी टूल का उपयोग करके, आप पुष्टि करते हैं कि आपने इन शर्तों को पूरी तरह से पढ़ लिया है, समझ लिया है और स्वीकार कर लिया है, साथ ही हमारी गोपनीयता नीति के साथ भी।"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**जहाँ तक कानून द्वारा अनुमति दी गई है, प्रकाशक सेवा के आपके उपयोग या उपयोग में असमर्थता से उत्पन्न होने वाले किसी भी प्रकार के नुकसान के लिए उत्तरदायित्व को अस्वीकार करता है।** विशेष रूप से, आप स्वीकार करते हैं और सहमत होते हैं कि प्रकाशक उत्तरदायी नहीं होगा:"
          },
          {
            "kind": "ul",
            "items": [
              "डेटा हानि, दूषित या गलत फ़ाइलें, या विफल कनवर्ज़न के लिए;",
              "उपकरण के आउटपुट के आधार पर आप द्वारा लिए गए निर्णय, वित्तीय, व्यावसायिक या अन्यथा;",
              "किसी भी सुविधा का डाउनटाइम, विलंबता, या अस्थायी अनुपलब्धता;",
              "तृतीय-पक्ष सेवा विफलताएँ (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, होस्टिंग प्रदाता);",
              "अप्रत्यक्ष, आकस्मिक, विशेष, परिणामी या दंडात्मक नुकसान किसी भी प्रकार के;",
              "घटना के कारण दावे के लिए, पिछले बारह (12) महीनों में आपके द्वारा वास्तव में भुगतान की गई फीस से अधिक कोई भी कुल राशि, मुफ्त-स्तरीय उपयोगकर्ताओं के लिए सौ (100) यूरो तक सीमित।"
            ]
          },
          {
            "kind": "p",
            "text": "**सुरक्षा उपकरण**: URL स्कैनर, फ़िशिंग डिटेक्टर, ईमेल सत्यापनकर्ता, SSL प्रमाणपत्र चेकर और पासवर्ड उल्लंघन चेकर **केवल सूचनात्मक और संकेतक उद्देश्यों के लिए** प्रदान किए जाते हैं। वे तृतीय-पक्ष संकेतों (Google Safe Browsing, सार्वजनिक DNS, HaveIBeenPwned, लाइव TLS हैंडशेक) और बड़े भाषा-मॉडल अनुमान एकत्र करते हैं। वे **सुरक्षा, वैधता या जोखिम की अनुपस्थिति की गारंटी नहीं देते हैं**। नई फ़िशिंग पृष्ठ प्रतिष्ठा डेटाबेस की तुलना में तेजी से दिखाई देते हैं; एक ईमेल जो हमारे जांचों को पास कर लेता है, फिर भी निष्क्रिय या धोखाधड़ी वाला हो सकता है; एक वैध SSL प्रमाणपत्र साइट की सामग्री को प्रमाणित नहीं करता है। प्रकाशक इन उपकरणों के आधार पर लिए गए किसी भी नुकसान के लिए स्पष्ट रूप से उत्तरदायित्व से इनकार करता है। उपयोगकर्ता ऐसे निर्णयों के लिए पूरी तरह से उत्तरदायी है।"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "आप सेवा का उपयोग करने के लिए सहमत हैं **नहीं** करते:"
          },
          {
            "kind": "ul",
            "items": [
              "अपने अधिकार क्षेत्र या फ्रांस में अवैध सामग्री अपलोड, प्रसंस्करण या वितरित करना;",
              "ऐसे फ़ाइलों को संसाधित करना जिनके लिए आपके पास आवश्यक अधिकार नहीं हैं (अनधिकृत कॉपीराइटेड कार्य, व्यक्तिगत डेटा जिसे आप संसाधित करने के अधिकारी नहीं हैं, वर्गीकृत जानकारी);",
              "धोखाधड़ी, मनी लॉन्ड्रिंग, आतंकवाद के वित्तपोषण या किसी भी आपराधिक गतिविधि को करना या सुविधा प्रदान करना;",
              ...
              "एकाधिक खाते बनाना ताकि मुफ्त-स्तरीय कोटा बढ़ाया जा सके, या अपने प्लान द्वारा अनुमत व्यक्तियों से अधिक व्यक्तियों के बीच एक खाता साझा करना।"
            ]
          },
          {
            "kind": "p",
            "text": "यदि हमें उचित आधार मिलते हैं कि आपने इस अनुभाग का उल्लंघन किया है, तो हम बिना किसी सूचना के तुरंत आपके खाते को निलंबित या समाप्त कर सकते हैं, और किसी भी प्रकार के प्रतिपूर्ति के हकदार नहीं होंगे।"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "आप सेवा में प्रस्तुत फ़ाइलों और पाठ के सभी अधिकार, शीर्षक और हित बरकरार रखते हैं। आप हमें केवल आपके द्वारा अनुरोधित टूल को वितरित करने के उद्देश्य से उन्हें संसाधित करने के लिए एक सख्ती से सीमित, रॉयल्टी-मुक्त, वैश्विक लाइसेंस प्रदान करते हैं। यह लाइसेंस तुरंत समाप्त हो जाता है जब परिणाम आपको वापस कर दिया जाता है (सर्वर-सहायता प्राप्त टूल) या बिल्कुल भी अस्तित्व में नहीं आता (ब्राउज़र-केवल टूल, क्योंकि आपकी फ़ाइल कभी हमारे पास नहीं पहुँचती)। हम आपके कंटेंट का मालिकाना अधिकार नहीं रखते हैं और न ही इसे AI मॉडल को प्रशिक्षित करने के लिए उपयोग करेंगे।"
          }
        ]
      },
      {
      ...
      {
        "id": "subscriptions",
        "title": "7. सदस्यताएँ, बिलिंग और प्रतिपूर्ति",
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**योजनाएँ**: मुफ्त (€0), प्रो (€25/माह या €210/वर्ष), व्यवसाय (€79/माह या €664/वर्ष)। योजना सुविधाओं और कोटा का वर्णन हमारे [मूल्य निर्धारण पृष्ठ](/pricing) पर खरीद के समय किया गया है। हम 30 दिनों के नोटिस के साथ योजना सुविधाओं में संशोधन करने का अधिकार सुरक्षित रखते हैं।",
              "**स्वतः नवीनीकरण**: मासिक और वार्षिक सदस्यताएँ उसी क्रम में स्वतः नवीनीकृत होती हैं जब तक रद्द नहीं की जाती। आप अपने डैशबोर्ड से किसी भी समय रद्द कर सकते हैं; रद्द करने का प्रभाव वर्तमान बिलिंग अवधि के अंत में होता है। आपको उस तिथि तक पहुंच बरकरार रहती है।",
              "**वापसी का अधिकार (ईयू)**: फ्रेंच उपभोक्ता संहिता के अनुच्छेद L. 221-28 के तहत, जब आप प्रारंभिक 14-दिवसीय वापसी अवधि के दौरान सक्रिय रूप से सेवा का उपयोग करते हैं, तो आप स्पष्ट रूप से अनुबंध के तत्काल निष्पादन के लिए सहमत होते हैं और वापसी के अपने अधिकार को त्याग देते हैं। यदि आपने किसी भुगतान सुविधा का उपयोग नहीं किया है, तो आप 14 दिनों के भीतर [support@konvertools.com](mailto:support@konvertools.com) पर ईमेल करके वापसी कर सकते हैं और हम 14 दिनों के भीतर पूर्ण प्रतिपूर्ति जारी करेंगे।",
              "**आंशिक प्रतिपूर्ति नहीं**: उपरोक्त वापसी परिदृश्य के अलावा, वर्तमान बिलिंग अवधि के लिए पहले से भुगतान की गई फीस गैर-प्रतिपूर्ति योग्य हैं।",
              ...
              "**कर**: Paddle सभी खरीदारी के लिए व्यापारी रिकॉर्ड है और विक्रेता रिकॉर्ड के रूप में कार्य करता है। यह आपके अधिकार क्षेत्र में देय किसी भी VAT या बिक्री कर की गणना, संग्रह और प्रेषण करता है, इसलिए चेकआउट पर आप जो कीमत चुकाते हैं वह पहले से ही लागू कर को शामिल कर चुकी होती है।"
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "सेवा का नाम, लोगो, कोड, डिज़ाइन, दस्तावेज़ीकरण, डेटाबेस संरचना और एकत्रित सामग्री प्रकाशक की विशेष संपत्ति है और फ्रांसीसी और अंतर्राष्ट्रीय बौद्धिक-संपदा कानून द्वारा संरक्षित है। आपको सेवा का उपयोग करने के लिए आवश्यक के अलावा कोई लाइसेंस प्रदान नहीं किया जाता है। आप सेवा या उसके किसी भी हिस्से की प्रतिलिपि, संशोधन, डी-कंपाइल या व्युत्पन्न कार्य नहीं बना सकते, सिवाय इसके कि लागू कानून द्वारा स्पष्ट रूप से अनुमति दी गई हो।"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "आप सहमत हैं कि आप प्रकाशक को किसी भी दावे, हानि, क्षति, उत्तरदायित्व, लागत या व्यय (उचित कानूनी शुल्क सहित) से क्षतिपूर्ति करेंगे और उसे हानिरहित रखेंगे जो उत्पन्न होता है (a) इन शर्तों के आपके उल्लंघन से, (b) कानून या किसी तीसरे पक्ष के अधिकार के आपके उल्लंघन से, या (c) सेवा में प्रस्तुत आपकी किसी भी सामग्री से।"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "आप अपने डैशबोर्ड से किसी भी समय अपना खाता समाप्त कर सकते हैं। यदि आप इन शर्तों का उल्लंघन करते हैं, सेवा का दुरुपयोग करते हैं, या आवर्ती सदस्यता का भुगतान करने में विफल रहते हैं, तो हम तुरंत और बिना सूचना के आपका खाता समाप्त या निलंबित कर सकते हैं। समाप्ति पर आपका डेटा तीस (30) दिनों के भीतर हटा दिया जाता है, सिवाय बिलिंग रिकॉर्ड और सहमति रिकॉर्ड के जिन्हें हमारी गोपनीयता नीति में वर्णित अनुसार रखा जाता है।"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "ये शर्तें फ्रांस के कानूनों द्वारा शासित होती हैं। इन शर्तों या सेवा से उत्पन्न होने वाले किसी भी विवाद को पेरिस, फ्रांस के न्यायालयों के विशेष अधिकार क्षेत्र में प्रस्तुत किया जाएगा, सिवाय जहां यूरोपीय संघ या लागू राष्ट्रीय कानून के तहत उपभोक्ता के निवास देश में उनके अनिवार्य अधिकार कार्यवाही का अधिकार प्रभावी रहता है। कानूनी कार्रवाई शुरू करने से पहले, आप [support@konvertools.com](mailto:support@konvertools.com) को लिखकर विवाद को सौहार्दपूर्ण ढंग से हल करने का प्रयास करने के लिए सहमत होते हैं। ईयू उपभोक्ता यूरोपीय आयोग के ऑनलाइन विवाद समाधान प्लेटफॉर्म [ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr) का भी उपयोग कर सकते हैं।"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "यदि इन शर्तों का कोई प्रावधान अमान्य या अप्रवर्तनीय पाया जाता है, तो शेष प्रावधान पूर्ण प्रभाव में बने रहते हैं। हमारे द्वारा किसी अधिकार या प्रावधान को लागू न करना उस अधिकार का परित्याग नहीं है। ये शर्तें (गोपनीयता नीति और खरीद के समय संदर्भित किसी भी योजना-विशिष्ट शर्तों के साथ) सेवा के संबंध में आप और प्रकाशक के बीच पूर्ण समझौता constitute करती हैं।"
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Bu Hizmet Koşulları (\"Koşullar\"), sizin (\"Kullanıcı\") ile Konvertools'un yayıncısı (\"Yayımcı\", \"biz\", \"bizim\") arasında, Konvertools web sitesi ve tüm ilgili araçlar, API'ler ve hizmetler (topluca \"Hizmet\") kullanımınızla ilgili olarak bağlayıcı bir anlaşma oluşturur. Bir hesap oluşturduğunuzda, kayıt sırasında kabul onay kutusunu işaretlediğinizde veya Hizmet'teki herhangi bir aracı basitçe kullandığınızda, bu Koşulları tamamen okuduğunuzu, anladığınızı ve kabul ettiğinizi, ayrıca Gizlilik Politikamızla birlikte doğruladığınızı teyit etmiş olursunuz."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Konvertools, dosya dönüştürme yardımcı programları, belge ve görüntü işleme araçları, AI destekli metin araçları, gösterge niteliğinde güvenlik araçları (e-posta doğrulayıcı, phishing tespit aracı, URL tarayıcı, SSL sertifika denetleyicisi, parola ihlali denetleyicisi) ve geliştirici araçları olmak üzere bir katalog sunmaktadır. Araçların çoğu tamamen tarayıcınızda çalışır; bazıları sunucu işlemesi gerektirir. Hizmet, **\"olduğu gibi\"** ve **\"mevcut olduğu şekilde\"** sunulmakta olup, herhangi bir açık veya zımni garanti, ticari uygunluk, belirli bir amaca uygunluk veya ihlal etmeme dahil olmak üzere herhangi bir tür garanti içermez."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**Yasal olarak izin verilen maksimum ölçüde, Yayımcı, Hizmet'in kullanımından veya kullanamamanızdan kaynaklanan herhangi bir zarar için sorumluluğu reddeder.** Özellikle, aşağıdakilerden kaynaklanan zararlar için Yayımcı'nın sorumlu olmayacağını kabul ve taahhüt edersiniz:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "herhangi bir özelliğin duraklaması, gecikmesi veya geçici olarak kullanılamaması;",
              "üçüncü taraf hizmet başarısızlıkları (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, barındırma sağlayıcıları);",
              "dolaylı, rastlantısal, özel, sonuçsal veya cezai zararlar dahil olmak üzere herhangi bir tür zarar;",
              "iddia doğuran olayın meydana geldiği tarihten önceki on iki (12) ay boyunca bize ödediğiniz ücretleri aşan herhangi bir toplam tutar, ücretsiz katmanda kullanıcılar için yüz (100) avro ile sınırlıdır."
            ]
          },
          {
            "kind": "p",
            "text": "**Güvenlik araçları**: URL Tarayıcı, Phishing Tespit Aracı, E-posta Doğrulayıcı, SSL Sertifika Denetleyicisi ve Parola İhlali Denetleyicisi yalnızca **bilgi ve gösterge amaçlı** olarak sunulmaktadır. Bu araçlar üçüncü taraf sinyallerini (Google Safe Browsing, genel DNS, HaveIBeenPwned, canlı TLS el sıkışmaları) ve büyük dil modeli sezgilerini bir araya getirir. **Güvenlik, geçerlilik veya riskin bulunmadığına dair bir garanti oluşturmazlar.** Yeni phishing sayfaları, itibar veritabanlarının kataloglayabileceğinden daha hızlı ortaya çıkar; kontrolümüzden geçen bir e-posta hala aktif olmayan veya sahte olabilir; geçerli bir SSL sertifikası bir sitenin içeriğini doğrulamaz. Yayımcı, Hizmet'in güvenli olduğunu belirlediği bir phishing e-postasından, Hizmet'in tanımlayamadığı güvensiz bir bağlantıdan, Hizmet'in geçerli olarak işaretlediği bir adrese gönderilen bir işlem e-postasından veya bu araçlara dayanarak alınan herhangi bir güvenlik kararından kaynaklanan herhangi bir zarar için açıkça sorumluluğu reddeder. Kullanıcı, bu tür kararların tek sorumluluğunu üstlenir."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Hizmet'i aşağıdakileri yapmak için kullanmayı kabul edersiniz **kabul etmezsiniz**:"
          },
          {
            "kind": "ul",
            "items": [
              "hukukunuzun veya Fransa'nın yasa dışı olduğunu bildiğiniz içerikleri yüklemek, işlemek veya dağıtmak;",
              ...
              "kotaları, ödeme gerekliliklerini veya uygulanan diğer kısıtlamaları aşmaya çalışmak;",
              "ücretsiz katmanda kullanıcı sayısını artırmak için birden fazla hesap oluşturmak veya hesabınızı planınızın izin verdiğinden daha fazla kişi tarafından kullanmak."
            ]
          },
          {
            "kind": "p",
            "text": "Bu bölümü ihlal ettiğinize dair makul gerekçelerimiz olması durumunda, hesabınızı herhangi bir uyarı yapılmaksızın derhal askıya alabilir veya sonlandırabiliriz ve herhangi bir tür geri ödeme hakkına sahip olmayacaksınız."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Hizmet'e gönderdiğiniz dosya ve metinlerin tüm haklarına, unvanına ve mülkiyetine siz sahip olursunuz. Bu dosyaları yalnızca talep ettiğiniz aracı sunmak amacıyla işlemek üzere, size sıkı sıkıya sınırlı, ücretsiz, dünya çapında bir lisans vermektesiniz. Bu lisans, sonucu size iade edildiği anda sona erer (sunucu destekli araçlar) veya hiç oluşmaz (tarayıcıda yalnızca çalışan araçlar, çünkü dosyanız bize ulaşmaz). İçeriğinizin sahipliğini iddia etmiyoruz, AI modellerini eğitmek için kullanmıyoruz ve kullanmayacağız."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Hesap oluşturmak için en az on altı (16) yaşında olmalısınız. Kimlik bilgilerinizin gizliliğinden ve hesabınız altında gerçekleşen herhangi bir faaliyetten siz sorumlusunuz. Yetkisiz erişimin herhangi bir şüphesi durumunda derhal [support@konvertools.com](mailto:support@konvertools.com) adresinden bizi bilgilendirin."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**Planlar**: Ücretsiz (€0), Pro (€25/ay veya €210/yıl), İş (€79/ay veya €664/yıl). Plan özellikleri ve kota sınırları satın alma sırasında [Fiyatlandırma sayfamızda](/pricing) açıklandığı şekildedir. Plan özelliklerini 30 gün önceden haber vererek değiştirme hakkımız saklıdır.",
              ...
              "**İptal hakkı (AB)**: Fransız Tüketici Kanunu'nun L. 221-28 maddesi uyarınca, ilk 14 günlük iptal süresi içinde Hizmet'i aktif olarak kullanmanız durumunda sözleşmenin hemen uygulanmasına açıkça rıza gösterir ve iptal hakkından feragat edersiniz. Ücretli bir özelliği kullanmadıysanız, [support@konvertools.com](mailto:support@konvertools.com) adresine e-posta göndererek 14 gün içinde iptal edebilir ve 14 gün içinde tam iade yaparız.",
              "**Kısmi iadeler yok**: Yukarıdaki iptal senaryosu dışında, cari faturalandırma dönemine ait ücretler iade edilmez.",
              "**Fiyat değişiklikleri**: 30 gün önceden haber vererek fiyatları değiştirebiliriz. Mevcut aboneler, bir sonraki yenileme tarihlerine kadar mevcut fiyatlarını korurlar.",
              "**Vergi**: Paddle, tüm satın almalar için Ödeme Kaydı Merkezi olarak hareket eder ve kayıtlı satıcı konumundadır. Vergi hesaplar, toplar ve ait olduğu yargı alanındaki herhangi bir KDV veya satış vergisini tahsil eder, bu nedenle ödeme sırasında ödediğiniz fiyat zaten ilgili vergiyi içerir."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Hizmet'in adı, logosu, kodu, tasarımı, dokümantasyonu, veritabanı yapısı ve toplu içeriği Yayımcı'nın münhasır mülkiyetindedir ve Fransız ve uluslararası fikri mülkiyet hukuku tarafından korunmaktadır. Size yalnızca Hizmet'i amaçlandığı şekilde kullanmanız için gerekli olanın ötesinde bir lisans verilmemektedir. Uygulanabilir hukuk tarafından açıkça izin verilmediği sürece, Hizmet'in veya herhangi bir bölümünün kopyasını oluşturamaz, değiştiremez, tersine mühendislik uygulayamaz veya türev çalışmalarını oluşturamazsınız."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Bu Koşulların ihlali (a), herhangi bir yasanın veya üçüncü taraf hakkının ihlali (b) veya Hizmet'e gönderdiğiniz herhangi bir içeriğinizden (c) kaynaklanan herhangi bir talep, kayıp, zarar, sorumluluk, maliyet veya giderden (makul avukatlık ücretleri dahil) kaynaklanan herhangi bir talep, kayıp, zarar, sorumluluk, maliyet veya giderden Yayımcı'yı tazmin edecek ve zararsız kılacaksınız."
          }
        ]
      },
      {
        "id": "changes",
        "title": "10. Koşulların Değiştirilmesi",
        "blocks": [
          {
            "kind": "p",
            "text": "Bu Koşulları zaman zaman değiştirebiliriz. Önemli değişiklikler, etkili olmalarından en az otuz (30) gün önce hesap sahiplerine e-posta yoluyla bildirilecektir. Bu süreden sonra Hizmet'i kullanmaya devam etmeniz, değiştirilmiş Koşulları kabul etmiş sayılırsınız. En son versiyon her zaman [https://konvertools.com/terms](https://konvertools.com/terms) adresinde mevcuttur."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Hesabınızı herhangi bir zamanda hesabınızdan sonlandırabilirsiniz. Koşulları ihlal etmeniz, Hizmet'i kötüye kullanmanız veya yinelenen bir aboneliği ödememeniz durumunda hesabınızı derhal ve herhangi bir uyarı yapılmaksızın sonlandırabilir veya askıya alabiliriz. Sonlandırma sırasında faturalandırma kayıtları ve Gizlilik Politikamızda açıklanan rıza kayıtları hariç olmak üzere verileriniz otuz (30) gün içinde silinir."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Bu Koşullar Fransa hukukuna tabidir. Bu Koşullardan veya Hizmet'ten kaynaklanan herhangi bir anlaşmazlık, Avrupa Birliği veya uygulanabilir ulusal hukuk uyarınca tüketicinin yerleşik olduğu ülkede tüketicinin yasal hakları saklı kalmak kaydıyla, Paris mahkemelerinin münhasır yetkisine tabi olacaktır. Hukuki işlem başlatmadan önce, anlaşmazlığı [support@konvertools.com](mailto:support@konvertools.com) adresine yazarak dostane şekilde çözmeyi kabul edersiniz. AB tüketicileri ayrıca anlaşmazlıklarını Avrupa Komisyonu'nun Çevrimiçi Anlaşmazlık Çözüm platformu [ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr) üzerinden de çözebilirler."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Bu Koşulların herhangi bir hükmü geçersiz veya uygulanamaz bulunursa, kalan hükümler tamamen yürürlükte kalır. Hakkımızın veya hükmün herhangi bir şekilde uygulanmaması, o hakkın feragati anlamına gelmez. Bu Koşullar (Gizlilik Politikası ve satın alma sırasında referans verilen plan spesifik koşullarıyla birlikte) sizin ve Yayımcı arasındaki Hizmet'e ilişkin tüm anlaşmayı oluşturur."
          }
        ]
      }
    ]
    ...
    "sections": [
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "kegagalan layanan pihak ketiga (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, penyedia hosting);",
          ...
          {
            "kind": "p",
            "text": "**Alat keamanan**: Pemindai URL, Detektor Phishing, Pemeriksa Email, Pemeriksa Sertifikat SSL, dan Pemeriksa Kebocoran Kata Sandi disediakan **hanya untuk tujuan informatif dan indikatif**. Alat-alat ini mengumpulkan sinyal dari pihak ketiga (Google Safe Browsing, DNS publik, HaveIBeenPwned, penanganan TLS langsung) serta heuristik model bahasa besar. Alat-alat ini **bukan merupakan jaminan keamanan, validitas, atau ketidakberisikoan**. Halaman phishing baru muncul lebih cepat daripada database reputasi dapat mengkatalogkannya; email yang lolos pemeriksaan kami mungkin masih tidak aktif atau palsu; sertifikat SSL yang valid tidak menjamin konten suatu situs. Penerbit secara tegas menolak segala tanggung jawab atas kerugian apa pun yang timbul dari email phishing yang dinyatakan aman oleh Layanan, tautan tidak aman yang gagal diidentifikasi, email transaksional yang dikirim ke alamat yang ditandai valid oleh Layanan, atau keputusan keamanan apa pun yang diambil berdasarkan alat-alat ini. Pengguna menanggung tanggung jawab penuh atas keputusan tersebut."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "mencoba membebani, melakukan rekayasa balik, scraping, menyalahgunakan batas laju, atau mengganggu operasi atau ketersediaan Layanan;",
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Pajak**: Paddle adalah pedagang catatan untuk semua pembelian dan bertindak sebagai penjual catatan. Paddle menghitung, memungut, dan menyetorkan pajak pertambahan nilai (PPN) atau pajak penjualan yang berlaku di yurisdiksi Anda, sehingga harga yang Anda bayar pada saat checkout sudah termasuk pajak yang berlaku."
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Anda dapat menghentikan akun Anda kapan saja melalui dasbor Anda. Kami dapat menghentikan atau menangguhkan akun Anda segera dan tanpa pemberitahuan jika Anda melanggar Ketentuan, menyalahgunakan Layanan, atau gagal membayar langganan berulang. Setelah pemutusan, data Anda akan dihapus dalam tiga puluh (30) hari, kecuali catatan penagihan dan catatan persetujuan yang disimpan sebagaimana dijelaskan dalam Kebijakan Privasi kami."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Các Điều khoản Dịch vụ (\"Điều khoản\") này tạo thành một thỏa thuận ràng buộc giữa bạn (\"Người dùng\") và nhà xuất bản Konvertools (\"Nhà xuất bản\", \"chúng tôi\", \"chúng tôi\") liên quan đến việc sử dụng trang web Konvertools và tất cả các công cụ, API và dịch vụ liên quan (gọi chung là \"Dịch vụ\"). Bằng cách tạo tài khoản, đánh dấu vào ô chấp nhận khi đăng ký hoặc đơn giản là sử dụng bất kỳ công cụ nào trên Dịch vụ, bạn xác nhận rằng bạn đã đọc, hiểu và chấp nhận toàn bộ các Điều khoản này, cùng với Chính sách Bảo mật của chúng tôi."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "vượt quá hạn ngạch, yêu cầu thanh toán hoặc bất kỳ hạn chế nào khác;",
          ...
          {
            "kind": "p",
            "text": "Chúng tôi có thể tạm ngưng hoặc chấm dứt tài khoản của bạn ngay lập tức và không cần thông báo nếu chúng tôi có lý do chính đáng để tin rằng bạn đã vi phạm mục này, mà không có quyền yêu cầu hoàn tiền dưới bất kỳ hình thức nào."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Bạn giữ tất cả quyền, tiêu đề và lợi ích đối với các tệp và văn bản bạn gửi đến Dịch vụ. Bạn cấp cho chúng tôi một giấy phép giới hạn, không bản quyền, toàn cầu để xử lý chúng chỉ nhằm cung cấp công cụ bạn yêu cầu. Giấy phép này chấm dứt ngay khi kết quả được trả về cho bạn (công cụ hỗ trợ bởi máy chủ) hoặc không bao giờ tồn tại (công cụ chỉ trình duyệt, vì tệp của bạn không bao giờ đến được chúng tôi). Chúng tôi không, và sẽ không, tuyên bố quyền sở hữu đối với nội dung của bạn hoặc sử dụng nó để đào tạo mô hình AI."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Bạn phải ít nhất mười sáu (16) tuổi để tạo tài khoản. Bạn chịu trách nhiệm giữ bí mật thông tin đăng nhập của mình và mọi hoạt động xảy ra dưới tài khoản của bạn. Thông báo ngay cho chúng tôi qua email [support@konvertools.com](mailto:support@konvertools.com) về bất kỳ truy cập trái phép nào được nghi ngờ."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**Gói dịch vụ**: Miễn phí (€0), Pro (€25/tháng hoặc €210/năm), Doanh nghiệp (€79/tháng hoặc €664/năm). Các tính năng và hạn ngạch của gói được mô tả trên trang [Bảng giá của chúng tôi](/pricing) tại thời điểm mua. Chúng tôi có quyền sửa đổi tính năng gói với thông báo trước 30 ngày.",
              ...
              "**Quyền rút lui (EU)**: theo Điều L. 221-28 của Bộ luật Tiêu dùng Pháp, khi bạn chủ động sử dụng Dịch vụ trong giai đoạn rút lui ban đầu 14 ngày, bạn đồng ý biểu thị sự chấp thuận hợp đồng ngay lập tức và từ bỏ quyền rút lui của mình. Nếu bạn chưa sử dụng bất kỳ tính năng trả phí nào, bạn có thể rút lui trong vòng 14 ngày bằng cách gửi email đến [support@konvertools.com](mailto:support@konvertools.com) và chúng tôi sẽ hoàn tiền đầy đủ trong vòng 14 ngày.",
              "**Không hoàn tiền một phần**: ngoài trường hợp rút lui nêu trên, phí đã thanh toán cho kỳ thanh toán hiện tại không được hoàn trả.",
              ...
              "**Thuế**: Paddle là Đơn vị Xử lý Thanh toán cho tất cả các giao dịch mua và hoạt động như người bán ghi nhận. Họ tính toán, thu thập và nộp bất kỳ VAT hoặc thuế doanh thu nào áp dụng tại nơi cư trú của bạn, vì vậy giá bạn thanh toán tại thời điểm thanh toán đã bao gồm bất kỳ khoản thuế nào áp dụng."
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Các Điều khoản này chịu sự điều chỉnh bởi luật pháp Pháp. Bất kỳ tranh chấp phát sinh từ hoặc liên quan đến các Điều khoản này hoặc Dịch vụ sẽ được đưa ra trước thẩm quyền độc quyền của tòa án Paris, Pháp, trừ trường hợp quyền hành động bắt buộc của người tiêu dùng tại quốc gia cư trú của họ theo luật Liên minh Châu Âu hoặc luật quốc gia áp dụng có hiệu lực. Trước khi khởi kiện, bạn đồng ý cố gắng giải quyết tranh chấp một cách thân thiện bằng cách viết thư đến [support@konvertools.com](mailto:support@konvertools.com). Người tiêu dùng EU cũng có thể sử dụng nền tảng Giải quyết Tranh chấp Trực tuyến của Ủy ban Châu Âu tại [ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Nếu bất kỳ điều khoản nào của các Điều khoản này bị coi là vô hiệu hoặc không thể thực thi, các điều khoản còn lại vẫn có hiệu lực đầy đủ. Việc chúng tôi không thực thi bất kỳ quyền hoặc điều khoản nào không phải là sự từ bỏ quyền đó. Các Điều khoản này (cùng với Chính sách Bảo mật và bất kỳ điều khoản cụ thể theo gói được tham chiếu khi mua) cấu thành toàn bộ thỏa thuận giữa bạn và Nhà xuất bản liên quan đến Dịch vụ."
          }
        ]
      }
    ]
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Konvertools tillhandahåller en katalog över filkonverteringsverktyg, dokument- och bildbehandlingsverktyg, AI-baserade textverktyg, indikativa säkerhetsverktyg (e-postverifierare, phishingdetektor, URL-skanner, SSL-certifikatkontroll, lösenordsläckagekontroll) samt utvecklarverktyg. De flesta verktyg körs helt i din webbläsare; vissa kräver serverbearbetning. Tjänsten tillhandahålls **\"som den är\" och \"tillgänglig\"** utan någon form av garanti, uttrycklig eller underförstådd, inklusive garanti för säljbarhet, lämplighet för ett särskilt ändamål eller icke-intrång."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**I den utsträckning lagen tillåter det, friskriver sig Utgivaren från allt ansvar för skador av något slag som uppstår till följd av ditt användande av, eller oförmåga att använda, Tjänsten.** I synnerhet erkänner och godtar du att Utgivaren inte ska vara ansvarig för:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "nedtid, latens eller tillfällig otillgänglighet av någon funktion;",
              "fel hos tredje parts tjänster (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, värdtjänstleverantörer);",
              "indirekta, tillfälliga, särskilda, följd- eller straffskador av något slag;",
              "något sammanlagt belopp som överstiger de avgifter du faktiskt har betalat till oss under de tolv (12) månader som föregår händelsen som ger upphov till kravet, med ett tak på ett hundra (100) euro för användare på gratisplanen."
            ]
          },
          {
            "kind": "p",
            "text": "**Säkerhetsverktyg**: URL-skannern, Phishingdetektorn, E-postverifieraren, SSL-certifikatkontrollen och Lösenordsläckagekontrollen tillhandahålls **enbart för informations- och indikativa ändamål**. De aggregerar signaler från tredje part (Google Safe Browsing, offentlig DNS, HaveIBeenPwned, live TLS-handskakningar) och heuristiska analyser från stora språkmodeller. De **konstituerar inte en garanti för säkerhet, giltighet eller frånvaro av risk**. Nya phishing-sidor uppstår snabbare än ryktesdatabaser kan katalogisera dem; en e-post som passerar våra kontroller kan ändå vara inaktiv eller bedräglig; ett giltigt SSL-certifikat certifierar inte en webbplats innehåll. Utgivaren friskriver sig uttryckligen från allt ansvar för skador som uppstår till följd av en phishing-e-post som Tjänsten bedömde som säker, en osäker länk som Tjänsten missade, en transaktions-e-post som skickades till en adress som Tjänsten markerade som giltig, eller något säkerhetsbeslut som fattats på grundval av dessa verktyg. Användaren bär ensamt ansvaret för sådana beslut."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Du godtar att **inte** använda Tjänsten för att:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "försöka överbelasta, återskapa, skrapa, missbruka hastighetsbegränsningar eller på annat sätt störa driften eller tillgängligheten av Tjänsten;",
              "undvika kvoter, betalningskrav eller andra begränsningar som finns;",
              "skapa flera konton för att utöka gratisplanens kvoter eller dela ett konto med fler personer än vad ditt abonnemang tillåter."
            ]
          },
          {
            "kind": "p",
            "text": "Vi kan omedelbart och utan föregående meddelande suspendera eller avsluta ditt konto om vi har rimlig grund att tro att du har brutit mot detta avsnitt, utan rätt till återbetalning av något slag."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Du behåller alla rättigheter, äganderätt och intresse i de filer och texter du skickar till Tjänsten. Du ger oss en strikt begränsad, avgiftsfri, global licens att bearbeta dem enbart för att leverera det verktyg du begärt. Denna licens upphör att gälla i samma ögonblick som resultatet returneras till dig (serverassisterade verktyg) eller aldrig träder i kraft alls (webbläsarbaserade verktyg, eftersom din fil aldrig når oss). Vi gör inte, och kommer inte att, göra anspråk på äganderätten till ditt innehåll eller använda det för att träna AI-modeller."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Du måste vara minst sexton (16) år för att skapa ett konto. Du ansvarar för att hålla dina inloggningsuppgifter konfidentiella och för all aktivitet som sker under ditt konto. Meddela oss omedelbart via [support@konvertools.com](mailto:support@konvertools.com) om du misstänker obehörig åtkomst."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "items": [
              ...
              "**Inga delvisa återbetalningar**: utanför ovanstående ångerscenario är avgifter som redan betalats för den aktuella faktureringsperioden icke-återbetalningsbara.",
              "**Prisförändringar**: vi kan ändra priser med 30 dagars varsel. Befintliga abonnenter behåller sitt nuvarande pris fram till nästa förnyelsedatum.",
              "**Skatt**: Paddle är den juridiska säljaren för alla köp och agerar som säljare. Den beräknar, samlar in och redovisar all moms eller försäljningsskatt som ska betalas i din jurisdiktion, så det pris du betalar vid utcheckningen redan inkluderar eventuell tillämplig skatt."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Namn, logotyp, kod, design, dokumentation, databasstruktur och aggregerat innehåll i Tjänsten är Utgivarens exklusiva egendom och skyddas av fransk och internationell immaterialrättslig lagstiftning. Ingen licens beviljas dig utöver vad som strikt krävs för att använda Tjänsten enligt dess avsedda syfte. Du får inte reproducera, modifiera, dekompilera eller skapa härledda verk av Tjänsten eller någon del av den, utom i den utsträckning som uttryckligen tillåts enligt tillämplig lag."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Du åtar dig att hålla Utgivaren oskadlig och ersätta den för alla krav, förluster, skador, ansvar, kostnader eller utgifter (inklusive rimliga advokatkostnader) som uppstår till följd av (a) ditt brott mot dessa Villkor, (b) ditt brott mot någon lag eller tredje parts rättigheter, eller (c) något innehåll som du skickat till Tjänsten."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Du kan när som helst säga upp ditt konto från din kontrollpanel. Vi kan säga upp eller suspendera ditt konto omedelbart och utan föregående meddelande om du bryter mot dessa Villkor, missbrukar Tjänsten eller inte betalar ett återkommande abonnemang. Vid uppsägning raderas dina data inom trettio (30) dagar, förutom fakturerings- och samtyckesregister som behålls enligt vår Integritetspolicy."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Om någon bestämmelse i dessa Villkor befinns ogiltig eller oenforcebar, förblir de återstående bestämmelserna fullt gällande. Vårt underlåtenhet att genomdriva någon rättighet eller bestämmelse utgör inte ett avstående från den rätten. Dessa Villkor (tillsammans med Integritetspolicyn och eventuella plan-specifika villkor som refereras vid köp) utgör hela avtalet mellan dig och Utgivaren beträffande Tjänsten."
          }
        ]
      }
    ]
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Konvertools oferuje katalog narzędzi do konwersji plików, przetwarzania dokumentów i obrazów, narzędzi tekstowych wspomaganych sztuczną inteligencją, narzędzi bezpieczeństwa o charakterze orientacyjnym (weryfikator poczty e-mail, wykrywacz phishingu, skaner adresów URL, sprawdzacz certyfikatów SSL, sprawdzacz naruszeń haseł) oraz narzędzi dla programistów. Większość narzędzi działa wyłącznie w przeglądarce użytkownika; niektóre wymagają przetwarzania po stronie serwera. Usługa jest świadczona **„tak, jak jest” i „tak, jak dostępna”** bez żadnych gwarancji, wyraźnych lub dorozumianych, w tym dotyczących przydatności handlowej, przydatności do określonego celu lub braku naruszenia praw własności intelektualnej."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**W maksymalnym zakresie dozwolonym przez obowiązujące prawo, Wydawca zrzeka się wszelkiej odpowiedzialności za szkody wszelkiego rodzaju wynikające z korzystania z Usługi lub niemożności jej korzystania.** W szczególności uznajesz i zgadzasz się, że Wydawca nie ponosi odpowiedzialności za:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "awarie usług stron trzecich (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, dostawcy hostingu);",
              "szkody pośrednie, incydentalne, specjalne, następcze lub karne jakiegokolwiek rodzaju;",
              "jakąkolwiek łączną kwotę przekraczającą opłaty, które rzeczywiście uiściłeś na naszą rzecz w ciągu dwunastu (12) miesięcy poprzedzających zdarzenie stanowiące podstawę roszczenia, z ograniczeniem do stu (100) euro w przypadku użytkowników korzystających z darmowego poziomu."
            ]
          },
          {
            "kind": "p",
            "text": "**Narzędzia bezpieczeństwa**: skaner adresów URL, wykrywacz phishingu, weryfikator poczty e-mail, sprawdzacz certyfikatów SSL oraz sprawdzacz naruszeń haseł są świadczone **wyłącznie w celach informacyjnych i orientacyjnych**. Agregują one sygnały pochodzące od stron trzecich (Google Safe Browsing, publiczny DNS, HaveIBeenPwned, aktywne uzgadnianie TLS) oraz heurystyki oparte na dużych modelach językowych. **Nie stanowią one gwarancji bezpieczeństwa, ważności lub braku ryzyka.** Nowe strony phishingowe pojawiają się szybciej, niż bazy reputacji są w stanie je skatalogować; adres e-mail, który przeszedł nasze kontrole, może nadal być nieaktywny lub oszukańczy; ważny certyfikat SSL nie potwierdza treści strony. Wydawca wyraźnie zrzeka się wszelkiej odpowiedzialności za jakiekolwiek szkody wynikające z phishingowego e-maila, który Usługa uznała za bezpieczny, niebezpiecznego linku, którego Usługa nie zidentyfikowała, transakcyjnego e-maila wysłanego na adres uznany przez Usługę za ważny lub jakiejkolwiek decyzji dotyczącej bezpieczeństwa podjętej na podstawie tych narzędzi. Użytkownik ponosi wyłączną odpowiedzialność za takie decyzje."
          }
        ]
      },
      {
        "id": "acceptable-use",
        "title": "4. Dopuszczalne korzystanie",
        "blocks": [
          {
            "kind": "p",
            "text": "Zobowiązujesz się **nie** używać Usługi do:"
          },
          {
            "kind": "ul",
            "items": [
              "przesyłania, przetwarzania lub rozpowszechniania treści nielegalnych na terenie Twojej jurysdykcji lub we Francji;",
              "przetwarzania plików, do których nie posiadasz odpowiednich praw (chronionych utworów bez zezwolenia, danych osobowych, do których nie jesteś uprawniony, informacji niejawnych);",
              ...
              "korzystania z narzędzi do humanizacji tekstu AI, narzędzi tekstowych AI lub jakiejkolwiek innej funkcji w celu plagiatu, oszukiwania osób trzecich, manipulowania systemami oceny (akademickimi, rekrutacyjnymi, sieci reklamowych) w sposób naruszający ich regulamin lub wprowadzania w błąd w jakikolwiek sposób, który narusza obowiązujące prawo;",
              "próby przeciążania, inżynierii wstecznej, scrapingu, nadużywania limitów częstotliwości lub w inny sposób zakłócania działania lub dostępności Usługi;",
              "omijania limitów, wymogów płatności lub jakichkolwiek innych ograniczeń obowiązujących w Usłudze;",
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Zachowujesz wszelkie prawa, tytuł oraz interesy w plikach i tekstach przesyłanych do Usługi. Udzielasz nam ściśle ograniczonej, nieodpłatnej, światowej licencji na ich przetwarzanie wyłącznie w celu świadczenia żądanej przez Ciebie usługi. Licencja ta wygasa w momencie zwrócenia wyniku (narzędzia korzystające z przetwarzania serwerowego) lub w ogóle nie powstaje (narzędzia działające wyłącznie w przeglądarce, gdyż Twój plik nigdy do nas nie trafia). Nie rościmy sobie i nie będziemy rościć praw własności do Twoich treści ani używać ich do trenowania modeli AI."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**Plany**: Darmowy (€0), Pro (€25/miesiąc lub €210/rok), Business (€79/miesiąc lub €664/rok). Funkcje planów i limity są opisane na naszej stronie [Cennik](/pricing) w momencie zakupu. Zastrzegamy sobie prawo do zmiany funkcji planów z 30-dniowym wyprzedzeniem.",
              ...
              "**Podatek**: Paddle jest Sprzedawcą Rejestrującym dla wszystkich zakupów i działa jako sprzedawca rejestrujący. Oblicza, pobiera i przekazuje wszelkie należne podatki VAT lub od sprzedaży w Twojej jurysdykcji, dlatego cena, którą płacisz podczas płatności, już obejmuje wszelkie obowiązujące podatki."
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Zobowiązujesz się do zwolnienia Wydawcy od wszelkiej odpowiedzialności oraz do pokrycia wszelkich roszczeń, strat, szkód, zobowiązań, kosztów lub wydatków (w tym rozsądnych kosztów prawnych) wynikających z (a) naruszenia przez Ciebie niniejszego Regulaminu, (b) naruszenia przez Ciebie jakiegokolwiek prawa lub praw osób trzecich lub (c) jakiejkolwiek treści przesłanej przez Ciebie do Usługi."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Niniejszy Regulamin podlega prawu Francji. Wszelkie spory wynikające z niniejszego Regulaminu lub Usługi będą rozpatrywane przez sądy wyłącznie właściwe w Paryżu we Francji, z zastrzeżeniem obowiązujących praw konsumentów w kraju Twojego zamieszkania w Unii Europejskiej. Przed wszczęciem postępowania sądowego zobowiązujesz się podjąć próbę polubownego rozwiązania sporu, kontaktując się z nami pod adresem [support@konvertools.com](mailto:support@konvertools.com). Konsumenci z UE mogą również skorzystać z platformy do rozstrzygania sporów konsumenckich Komisji Europejskiej pod adresem [ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Jeśli jakiekolwiek postanowienie niniejszego Regulaminu zostanie uznane za nieważne lub nieegzekwowalne, pozostałe postanowienia pozostają w pełni skuteczne. Nasze nieegzekwowanie jakiegokolwiek prawa lub postanowienia nie stanowi zrzeczenia się tego prawa. Niniejszy Regulamin (wraz z Polityką Prywatności i wszelkimi warunkami dotyczącymi konkretnych planów, do których odwołano się podczas zakupu) stanowi całość umowy pomiędzy Tobą a Wydawcą dotyczącą Usługi."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Ці Умови обслуговування (далі — «Умови») становлять юридично обов’язкову угоду між вами (далі — «Користувач») та видавцем Konvertools (далі — «Видавець», «ми», «нас») щодо використання вами веб-сайту Konvertools та усіх пов’язаних інструментів, API та послуг (далі — «Послуга»). Створюючи обліковий запис, встановлюючи прапорець прийняття під час реєстрації або просто використовуючи будь-який інструмент на Послузі, ви підтверджуєте, що прочитали, зрозуміли та повністю приймаєте ці Умови разом із нашою Політикою конфіденційності."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Konvertools надає каталог утиліт для конвертації файлів, інструментів для обробки документів і зображень, утиліт на основі ШІ, індикативних інструментів безпеки (перевірка електронної пошти, детектор фішингу, сканер URL, перевірка SSL-сертифікатів, перевірка витоку паролів) та розробницьких утиліт. Більшість інструментів працюють виключно у вашому браузері; деякі потребують серверної обробки. Послуга надається **«як є» та «за наявності»** без будь-яких гарантій, прямо чи опосередковано, включаючи придатність для продажу, придатність для певної мети або відсутність порушення прав."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**У межах, дозволених законом, Видавець відмовляється від будь-якої відповідальності за шкоду будь-якого роду, що виникла внаслідок використання вами Послуги або неможливості її використання.** Зокрема, ви визнаєте та погоджуєтеся, що Видавець не нестиме відповідальності за:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "збої сторонніх сервісів (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, хостинг-провайдери);",
              "непрямі, випадкові, спеціальні, наслідкові чи штрафні збитки будь-якого роду;",
              "будь-яку сукупну суму, що перевищує плату, яку ви фактично сплатили нам протягом дванадцяти (12) місяців, що передували події, яка призвела до виникнення претензії, з обмеженням у сто (100) євро для користувачів безкоштовного рівня."
            ]
          },
          {
            "kind": "p",
            "text": "**Інструменти безпеки**: Сканер URL, Детектор фішингу, Перевірка електронної пошти, Перевірка SSL-сертифікатів та Перевірка витоку паролів надаються **виключно для інформаційних та індикативних цілей**. Вони агрегують сторонні сигнали (Google Safe Browsing, публічний DNS, HaveIBeenPwned, живі TLS-рукопотискання) та евристику великих мовних моделей. Вони **не становлять гарантії безпеки, дійсності чи відсутності ризику**. Нові фішингові сторінки з’являються швидше, ніж бази репутації можуть їх каталогізувати; електронний лист, який проходить наші перевірки, може виявитися неактивним або шахрайським; дійсний SSL-сертифікат не гарантує змісту сайту. Видавець прямо відмовляється від будь-якої відповідальності за будь-яку шкоду, що виникла внаслідок фішингового електронного листа, який Послуга визнала безпечним, небезпечного посилання, яке Послуга не змогла ідентифікувати, транзакційного електронного листа, надісланого на адресу, яку Послуга позначила як дійсну, або будь-якого рішення щодо безпеки, прийнятого на основі цих інструментів. Користувач несе повну відповідальність за такі рішення."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "завантаження, обробки чи поширення контенту, який є незаконним у вашій країні або у Франції;",
              "обробки файлів, щодо яких у вас немає необхідних прав (охоронюваних авторським правом творів без дозволу, персональних даних, якими ви не маєте права обробляти, секретної інформації);",
              "вчинення або сприяння шахрайству, відмиванню грошей, фінансуванню тероризму чи будь-якої іншої злочинної діяльності;",
              "використання інструментів для гуманізації тексту на основі ШІ, інших текстових інструментів ШІ чи будь-якої іншої функції для плагіату, обману третьої сторони, маніпуляції системами оцінювання (академічними, рекрутинговими, рекламними мережами) у спосіб, що суперечить їхнім правилам, або для введення в оману будь-яким чином, що порушує чинне законодавство;",
              "спроб перевантаження, зворотного інжинірингу, збору даних, зловживання лімітами швидкості чи іншого втручання в роботу чи доступність Послуги;",
              "обходу квот, вимог до оплати чи будь-яких інших обмежень, що діють;",
              "створення кількох облікових записів для збільшення лімітів безкоштовного рівня чи спільного використання облікового запису більшою кількістю осіб, ніж дозволяє ваш тариф."
            ]
          },
          {
            "kind": "p",
            "text": "Ми можемо негайно призупинити або припинити ваш обліковий запис без попередження, якщо маємо достатні підстави вважати, що ви порушили цей розділ, без права на відшкодування будь-яких витрат."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**Тарифи**: Безкоштовний (€0), Pro (€25/місяць або €210/рік), Business (€79/місяць або €664/рік). Особливості та ліміти тарифів описані на нашій сторінці [Ціни](/pricing) на момент покупки. Ми залишаємо за собою право змінювати особливості тарифів із повідомленням за 30 днів.",
              "**Автоматичне поновлення**: щомісячні та щорічні підписки поновлюються автоматично з тією ж періодичністю до моменту скасування. Ви можете скасувати підписку в будь-який час через свій кабінет; скасування набуває чинності після закінчення поточного платіжного періоду. Ви зберігаєте доступ до Послуги до цього моменту.",
              ...
              "**Зміна цін**: ми можемо змінювати ціни з повідомленням за 30 днів. Існуючі підписники зберігають свою поточну ціну до наступного періоду поновлення.",
              "**Податки**: Paddle виступає Merchant of Record для усіх покупок і діє як продавець. Він розраховує, стягує та перераховує будь-який ПДВ чи податок з продажу, що підлягає сплаті у вашій країні, тому ціна, яку ви бачите під час оформлення замовлення, вже включає будь-який застосовний податок."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Назва, логотип, код, дизайн, документація, структура бази даних та агрегований контент Послуги є виключною власністю Видавця та захищені французьким та міжнародним законодавством про інтелектуальну власність. Вам надається лише ліцензія, суворо необхідна для використання Послуги за призначенням. Ви не можете відтворювати, змінювати, декомпілювати чи створювати похідні роботи Послуги або будь-якої її частини, окрім випадків, прямо дозволених чинним законодавством."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Ви можете припинити свій обліковий запис у будь-який час через свій кабінет. Ми можемо негайно припинити або призупинити ваш обліковий запис без попередження, якщо ви порушили ці Умови, зловживаєте Послугою або не сплачуєте поновлення підписки. Після припинення ваші дані видаляються протягом тридцяти (30) днів, окрім записів про оплату та згод, які зберігаються відповідно до нашої Політики конфіденційності."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Якщо будь-яку умову цих Умов визнано недійсною чи нездійсненною, інші умови залишаються в повній силі. Наше нездійснення права чи положення не є відмовою від цього права. Ці Умови (разом із Політикою конфіденційності та будь-якими специфічними умовами тарифу, на які посилаються під час покупки) становлять повну угоду між вами та Видавцем щодо Послуги."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Tyto Služební podmínky (dále jen „Podmínky“) tvoří závaznou dohodu mezi vámi (dále jen „Uživatel“) a vydavatelem služby Konvertools (dále jen „Vydavatel“, „my“, „nás“) týkající se používání webových stránek Konvertools a všech souvisejících nástrojů, API a služeb (dohromady dále jen „Služba“). Vytvořením účtu, zaškrtnutím políčka pro přijetí podmínek při registraci nebo pouhým použitím jakéhokoliv nástroje na Službě potvrzujete, že jste si tyto Podmínky přečetli, porozuměli jim a plně je přijímáte spolu s naší Zásadou ochrany osobních údajů."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "**V maximální míře povolené zákonem Vydavatel odmítá jakoukoliv odpovědnost za škody jakéhokoliv druhu vzniklé v důsledku vašeho používání Služby nebo neschopnosti ji používat.** Zejména uznáváte a souhlasíte, že Vydavatel nebude odpovědný za:"
          },
          {
            "kind": "ul",
            "items": [
              ...
              "prostoje, latenci či dočasnou nedostupnost jakékoliv funkce;",
              "selhání služeb třetích stran (Supabase, Mistral, Google Safe Browsing, HaveIBeenPwned, Paddle, Resend, poskytovatelé hostingu);",
              "nepřímé, vedlejší, zvláštní, následné či trestné škody jakéhokoliv druhu;",
              "jakýkoliv souhrnný obnos převyšující částky, které jste nám skutečně zaplatili v průběhu dvanácti (12) měsíců předcházejících události zakládající nárok, s horní hranicí sto (100) eur pro uživatele bez placeného tarifu."
            ]
          },
          {
            "kind": "p",
            "text": "**Bezpečnostní nástroje**: Skener URL, Detektor phishingu, Ověřovač e-mailů, Kontrola SSL certifikátů a Kontrola prolomených hesel jsou poskytovány **pouze pro informační a indikativní účely**. Shromažďují signály třetích stran (Google Safe Browsing, veřejný DNS, HaveIBeenPwned, živé TLS handshaky) a heuristiky velkých jazykových modelů. **Nejedná se o záruku bezpečnosti, platnosti či absence rizika.** Nové phishingové stránky se objevují rychleji, než mohou databáze reputace zařadit; e-mail, který projde našimi kontrolami, může být stále neaktivní či podvodný; platný SSL certifikát nezaručuje obsah stránky. Vydavatel výslovně odmítá jakoukoliv odpovědnost za jakoukoliv újmu vzniklou v důsledku phishingového e-mailu, který Služba označila za bezpečný, nebezpečného odkazu, který Služba nezjistila, transakčního e-mailu odeslaného na adresu, kterou Služba označila za platnou, či jakéhokoliv bezpečnostního rozhodnutí učiněného na základě těchto nástrojů. Za taková rozhodnutí nese výhradní odpovědnost Uživatel."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "ul",
            "items": [
              "nahraní, zpracování či distribuci obsahu, který je v vaší jurisdikci či ve Francii nelegální;",
              "zpracování souborů, k nimž nemáte potřebná práva (autorskoprávně chráněná díla bez souhlasu, osobní údaje, ke kterým nejste oprávněni, utajované informace);",
              "páchání či usnadňování podvodů, praní špinavých peněz, financování terorismu či jakékoliv trestné činnosti;",
              "používání nástrojů pro „lidštění“ AI textů, nástrojů pro práci s AI texty či jakékoliv jiné funkce k plagiátorství, k podvodu třetí strany, k manipulaci hodnocení systémů (akademických, náborových, reklamních sítí) v rozporu s jejich pravidly, či k jakémukoliv klamání v rozporu s platnými zákony;",
              ...
              "vytváření více účtů za účelem násobení kvót bez placeného tarifu či sdílení účtu s větším počtem osob, než váš tarif umožňuje."
            ]
          },
          {
            "kind": "p",
            "text": "Můžeme váš účet okamžitě a bez předchozího upozornění pozastavit či ukončit, pokud máme oprávněný důvod se domnívat, že jste porušili tuto část, a to bez nároku na jakoukoliv refundaci."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Všechna práva, vlastnictví a zájmy k souborům a textům, které do Služby vložíte, zůstávají nadále ve vašem vlastnictví. Poskytujete nám výhradně omezenou, bezúplatnou, celosvětovou licenci k jejich zpracování výhradně za účelem poskytnutí nástroje, který jste požadovali. Tato licence zaniká okamžikem vrácení výsledku (nástroje využívající serverové zpracování) či nikdy nevzniká (nástroje běžící pouze v prohlížeči, jelikož váš soubor k nám nikdy nedorazí). Netvrdíme si vlastnictví vašeho obsahu ani jej nebudeme používat k trénování AI modelů."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Pro vytvoření účtu musíte být starší šestnácti (16) let. Jste odpovědní za uchovávání svých přihlašovacích údajů v tajnosti a za jakoukoliv činnost probíhající pod vaším účtem. Okamžitě nás informujte na adrese [support@konvertools.com](mailto:support@konvertools.com) o jakémkoliv podezření na neoprávněný přístup."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "**Tarify**: Bezplatný (€0), Pro (€25/měsíc či €210/rok), Business (€79/měsíc či €664/rok). Vlastnosti tarifů a kvóty jsou popsány na naší stránce [Ceník](/pricing) v době nákupu. Vyhrazujeme si právo měnit vlastnosti tarifů s 30denním předchozím oznámením.",
              "**Automatické prodloužení**: Měsíční a roční předplatné se automaticky prodlužují stejným způsobem, dokud nejsou zrušena. Můžete je zrušit kdykoliv z vašeho panelu; zrušení nabývá účinnosti na konci aktuálního fakturačního období. Přístup si ponecháte až do tohoto data.",
              ...
              "**Žádné částečné refundace**: Mimo výše uvedený scénář pro odstoupení jsou již zaplacené částky za aktuální fakturační období nevratné.",
              "**Změny cen**: Můžeme ceny změnit s 30denním předchozím oznámením. Stávající předplatitelé si ponechávají svou aktuální cenu až do dalšího prodloužení.",
              "**Daň**: Paddle je obchodním zástupcem pro všechny nákupy a vystupuje jako prodávající. Vypočítává, vybírá a odvádí jakoukoli DPH či daň z prodeje ve vaší jurisdikci, takže cena, kterou zaplatíte při platbě, již zahrnuje veškeré příslušné daně."
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Souhlasíte, že nás budete chránit a uhradíte nám jakýkoliv nárok, ztrátu, škodu, odpovědnost, náklad či výdaj (včetně přiměřených právních poplatků) vzniklý v důsledku (a) vašeho porušení těchto Podmínek, (b) vašeho porušení jakéhokoliv zákona či práv třetích stran, či (c) jakéhokoliv obsahu, který jste do Služby vložili."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Můžeme tyto Podmínky občas změnit. Podstatné změny budou oznámeny e-mailem držitelům účtů alespoň třicet (30) dnů před jejich nabytím účinnosti. Pokračováním v používání Služby po uplynutí tohoto období přijímáte změněné Podmínky. Nejnovější verze je vždy k dispozici na [https://konvertools.com/terms](https://konvertools.com/terms)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Svůj účet můžete kdykoliv ukončit z vašeho panelu. My můžeme váš účet okamžitě a bez předchozího upozornění ukončit či pozastavit, pokud porušíte tyto Podmínky, zneužijete Službu či nezaplatíte opakující se předplatné. Po ukončení jsou vaše data smazána do třiceti (30) dnů, s výjimkou fakturačních záznamů a záznamů o souhlasu, které si ponecháváme v souladu s naší Zásadou ochrany osobních údajů."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "p",
            "text": "Pokud je jakákoliv část těchto Podmínek shledána neplatnou či nevymahatelnou, zbytek zůstává v plném rozsahu účinný. Naše nevyužití či neuplatnění jakéhokoliv práva či ustanovení není zřeknutím se tohoto práva. Tyto Podmínky (společně se Zásadou ochrany osobních údajů a jakýmikoliv tarif-specifickými podmínkami uvedenými při nákupu) tvoří celou dohodu mezi vámi a Vydavatelem týkající se Služby."
          }
        ]
      }
    ]
