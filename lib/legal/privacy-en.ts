    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "ul", items: [
          ...
          "**Subscription state**: current plan (free / Pro / Business), Paddle customer identifier, and the dates of your most recent renewals.",
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "ul", items: [
          ...
          "**Paddle** (Paddle.com Market Ltd, United Kingdom) — our Merchant of Record: payment processing, subscription management, and worldwide VAT/sales-tax collection and remittance. We **never see or store** your card details. Paddle receives your email, payment method, and the plan you bought.",
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "ul", items: [
          ...
          "**Payment data** — never seen or stored by us; the card payment flow is fully delegated to Paddle, our Merchant of Record (PCI-DSS Level 1 compliant).",
