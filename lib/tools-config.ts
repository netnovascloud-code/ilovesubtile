...
TOOLS.push(
  ...
  imgTool("svg-to-png", ImageIcon, "SVG to PNG", "Rasterize SVG vectors to PNG.",
  ...
  imgTool("compress-image", Shrink, "Compress Image", "Shrink image file size with WebP.",
  ...
  imgTool("resize-image", Scaling, "Resize Image", "Resize images to exact dimensions.",
  ...
  imgTool("crop-image", Crop, "Crop Image", "Crop images to a precise region.",
  ...
  imgTool("rotate-image", RotateCw, "Rotate Image", "Rotate images in 90° steps.",
  ...
  imgTool("grayscale-image", Contrast, "Image to Black & White", "Convert images to grayscale.",
