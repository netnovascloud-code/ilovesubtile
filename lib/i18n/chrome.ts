...
const en: ChromeStrings = {
  ...
  footer: { tagline: "Free subtitle tools online — generate, translate, sync, convert. One simple tool per job, all in your browser.", topTools: "Top tools", product: "Product", legal: "Legal", pricing: "Pricing", api: "API", dashboard: "Dashboard", vsVeed: "vs VEED.io", privacy: "Privacy", terms: "Terms", rights: "All rights reserved." },
  card: { open: "Open", pro: "Pro" },
  upload: { dropOrClick: "Drop your file or click to upload", dropHere: "Drop the file here", formats: "Accepted formats", maxFree: "Max {mb} MB on the free plan.", selectFile: "Select a file", fileTooLarge: "This file is {size}. Free limit is {mb} MB — upgrade to Pro for up to 500 MB." },
  ...
  adblock: { title: "CaptionFlow is free thanks to ads", body1: "You can disable ads by", goPro: "going Pro at €12/month", body2: ", or by allowing ads on this site.", dismiss: "Dismiss" },
...
const fr: ChromeStrings = {
  ...
  upload: { dropOrClick: "Déposez votre fichier ou cliquez pour téléverser", dropHere: "Déposez le fichier ici", formats: "Formats acceptés", maxFree: "Max {mb} Mo sur l'offre gratuite.", selectFile: "Choisir un fichier", fileTooLarge: "Ce fichier fait {size}. Limite gratuite : {mb} Mo — passez Pro pour jusqu'à 500 Mo." },
  ...
  adblock: { title: "CaptionFlow est gratuit grâce aux publicités", body1: "Vous pouvez désactiver les pubs en", goPro: "passant Pro pour 12 €/mois", body2: ", ou en autorisant les pubs sur ce site.", dismiss: "Fermer" },
...
const es: ChromeStrings = {
  ...
  upload: { dropOrClick: "Suelta tu archivo o haz clic para subirlo", dropHere: "Suelta el archivo aquí", formats: "Formatos aceptados", maxFree: "Máx. {mb} MB en el plan gratis.", selectFile: "Elegir un archivo", fileTooLarge: "Este archivo pesa {size}. El límite gratis es {mb} MB — pasa a Pro hasta 500 MB." },
  ...
  adblock: { title: "CaptionFlow es gratis gracias a los anuncios", body1: "Puedes desactivar los anuncios", goPro: "pasando a Pro por 12 €/mes", body2: ", o permitiendo los anuncios en este sitio.", dismiss: "Cerrar" },
...
const pt: ChromeStrings = {
  ...
  card: { open: "Abrir", pro: "Pro" },
  upload: { dropOrClick: "Solte seu arquivo ou clique para enviar", dropHere: "Solte o arquivo aqui", formats: "Formatos aceitos", maxFree: "Máx. {mb} MB no plano grátis.", selectFile: "Escolher arquivo", fileTooLarge: "Este arquivo tem {size}. Limite grátis: {mb} MB — vá Pro até 500 MB." },
  ...
  adblock: { title: "CaptionFlow é grátis graças aos anúncios", body1: "Você pode desativar os anúncios", goPro: "indo Pro por €12/mês", body2: ", ou permitindo anúncios neste site.", dismiss: "Fechar" },
...
const de: ChromeStrings = {
  ...
  upload: { dropOrClick: "Datei hier ablegen oder klicken zum Hochladen", dropHere: "Datei hier ablegen", formats: "Akzeptierte Formate", maxFree: "Max. {mb} MB im Gratis-Plan.", selectFile: "Datei wählen", fileTooLarge: "Diese Datei ist {size}. Gratis-Limit: {mb} MB — Pro bis 500 MB." },
  ...
  adblock: { title: "CaptionFlow ist dank Werbung kostenlos", body1: "Du kannst die Werbung deaktivieren, indem du", goPro: "Pro für 12 €/Monat holst", body2: " oder Werbung auf dieser Seite zulässt.", dismiss: "Schließen" },
  ...
  auth: { loginTitle: "Willkommen zurück", loginLead: "Melde dich bei deinem CaptionFlow-Konto an.", registerTitle: "Konto erstellen", registerLead: "5 kostenlose Durchläufe pro Tag. Keine Karte erforderlich.", email: "E-Mail", password: "Passwort", loginCta: "Anmelden", registerCta: "Konto erstellen", loading: "Bitte warten…", orWithEmail: "oder mit E-Mail", google: "Mit Google fortfahren", checkInbox: "Prüfe dein Postfach zur Bestätigung.", noAccount: "Noch kein Konto?", createOne: "Eines erstellen", hasAccount: "Schon ein Konto?", logIn: "Anmelden" },
};
...
const it: ChromeStrings = {
  ...
  upload: { dropOrClick: "Trascina il file o clicca per caricare", dropHere: "Rilascia il file qui", formats: "Formati accettati", maxFree: "Max {mb} MB nel piano gratuito.", selectFile: "Scegli un file", fileTooLarge: "Questo file è {size}. Limite gratis: {mb} MB — passa a Pro fino a 500 MB." },
  ...
  adblock: { title: "CaptionFlow è gratis grazie agli annunci", body1: "Puoi disattivare gli annunci", goPro: "passando a Pro per 12 €/mese", body2: ", o consentendo gli annunci su questo sito.", dismiss: "Chiudi" },
  ...
  auth: { loginTitle: "Bentornato", loginLead: "Accedi al tuo account CaptionFlow.", registerTitle: "Crea il tuo account", registerLead: "5 utilizzi gratis al giorno. Senza carta.", email: "E-mail", password: "Password", loginCta: "Accedi", registerCta: "Crea account", loading: "Attendere…", orWithEmail: "o con e-mail", google: "Continua con Google", checkInbox: "Controlla la posta per confermare.", noAccount: "Non hai un account?", createOne: "Creane uno", hasAccount: "Hai già un account?", logIn: "Accedi" },
};
...
const nl: ChromeStrings = {
  ...
  upload: { dropOrClick: "Sleep je bestand of klik om te uploaden", dropHere: "Bestand hier neerzetten", formats: "Geaccepteerde formaten", maxFree: "Max. {mb} MB op het gratis abonnement.", selectFile: "Bestand kiezen", fileTooLarge: "Dit bestand is {size}. Gratis limiet: {mb} MB — upgrade naar Pro tot 500 MB." },
  ...
  adblock: { title: "CaptionFlow is gratis dankzij advertenties", body1: "Je kunt advertenties uitschakelen door", goPro: "Pro te nemen voor €12/maand", body2: ", of door advertenties op deze site toe te staan.", dismiss: "Sluiten" },
...
const ja: ChromeStrings = {
  ...
  upload: { dropOrClick: "ファイルをドロップまたはクリックしてアップロード", dropHere: "ここにファイルをドロップ", formats: "対応形式", maxFree: "無料プランは最大 {mb} MB。", selectFile: "ファイルを選択", fileTooLarge: "このファイルは {size} です。無料の上限は {mb} MB — Pro なら 500 MB まで。" },
  ...
  adblock: { title: "CaptionFlow は広告のおかげで無料です", body1: "広告は次の方法で無効化できます：", goPro: "月 12 ユーロで Pro へ", body2: " もしくは、このサイトで広告を許可してください。", dismiss: "閉じる" },
  ...
  auth: { loginTitle: "お帰りなさい", loginLead: "CaptionFlow アカウントにログイン。", registerTitle: "アカウント作成", registerLead: "1 日 5 回まで無料。クレジットカード不要。", email: "メール", password: "パスワード", loginCta: "ログイン", registerCta: "アカウント作成", loading: "お待ちください…", orWithEmail: "またはメールで", google: "Google で続行", checkInbox: "確認メールを受信箱でご確認ください。", noAccount: "アカウントをお持ちでない方は？", createOne: "作成する", hasAccount: "既にアカウントをお持ちですか？", logIn: "ログイン" },
};
...
const zh: ChromeStrings = {
  ...
  upload: { dropOrClick: "拖入文件或点击上传", dropHere: "将文件拖到这里", formats: "支持的格式", maxFree: "免费版最大 {mb} MB。", selectFile: "选择文件", fileTooLarge: "此文件 {size}。免费上限 {mb} MB — 升级 Pro 最大 500 MB。" },
  ...
  adblock: { title: "CaptionFlow 因广告而免费", body1: "您可以通过以下方式关闭广告:", goPro: "每月 12 欧元升级 Pro", body2: ",或在本站允许广告。", dismiss: "关闭" },
  ...
  auth: { loginTitle: "欢迎回来", loginLead: "登录您的 CaptionFlow 帐户。", registerTitle: "创建帐户", registerLead: "每日 5 次免费使用。无需信用卡。", email: "邮箱", password: "密码", loginCta: "登录", registerCta: "创建帐户", loading: "请稍候…", orWithEmail: "或使用邮箱", google: "使用 Google 继续", checkInbox: "请查收邮件确认。", noAccount: "还没有帐户?", createOne: "创建一个", hasAccount: "已有帐户?", logIn: "登录" },
};
...
const ko: ChromeStrings = {
  ...
  upload: { dropOrClick: "파일을 끌어다 놓거나 클릭하여 업로드", dropHere: "여기에 파일을 놓으세요", formats: "지원 형식", maxFree: "무료 플랜은 최대 {mb} MB.", selectFile: "파일 선택", fileTooLarge: "이 파일은 {size} 입니다. 무료 한도 {mb} MB — Pro 는 최대 500 MB." },
  ...
  adblock: { title: "CaptionFlow 는 광고 덕분에 무료입니다", body1: "광고는 다음 방법으로 비활성화 가능:", goPro: "월 12유로로 Pro 가입", body2: " 또는 이 사이트의 광고를 허용해 주세요.", dismiss: "닫기" },
...
const ar: ChromeStrings = {
  ...
  upload: { dropOrClick: "أفلت ملفك أو انقر للرفع", dropHere: "أفلت الملف هنا", formats: "الصيغ المقبولة", maxFree: "أقصى {mb} ميجا في الخطة المجانية.", selectFile: "اختر ملفًا", fileTooLarge: "هذا الملف {size}. الحد المجاني {mb} ميجا — Pro حتى 500 ميجا." },
  ...
  adblock: { title: "CaptionFlow مجاني بفضل الإعلانات", body1: "يمكنك تعطيل الإعلانات عبر:", goPro: "الترقية إلى Pro بـ 12 يورو/شهر", body2: " أو السماح بالإعلانات على هذا الموقع.", dismiss: "إغلاق" },
...
const ru: ChromeStrings = {
  ...
  upload: { dropOrClick: "Перетащите файл или нажмите для загрузки", dropHere: "Бросьте файл сюда", formats: "Допустимые форматы", maxFree: "Макс. {mb} МБ на бесплатном тарифе.", selectFile: "Выбрать файл", fileTooLarge: "Файл размером {size}. Бесплатный лимит {mb} МБ — Pro до 500 МБ." },
  ...
  adblock: { title: "CaptionFlow бесплатен благодаря рекламе", body1: "Рекламу можно отключить,", goPro: "перейдя на Pro за 12 €/мес", body2: ", или разрешив рекламу на этом сайте.", dismiss: "Закрыть" },
...
const hi: ChromeStrings = {
  ...
  upload: { dropOrClick: "फ़ाइल छोड़ें या अपलोड करने के लिए क्लिक करें", dropHere: "फ़ाइल यहाँ छोड़ें", formats: "स्वीकृत प्रारूप", maxFree: "मुफ़्त प्लान में अधिकतम {mb} MB।", selectFile: "फ़ाइल चुनें", fileTooLarge: "यह फ़ाइल {size} है. मुफ़्त सीमा {mb} MB — Pro में 500 MB तक।" },
  ...
  adblock: { title: "CaptionFlow विज्ञापनों के कारण मुफ़्त है", body1: "आप विज्ञापन इस तरह बंद कर सकते हैं:", goPro: "€12/माह में Pro लें", body2: ", या इस साइट पर विज्ञापनों की अनुमति दें।", dismiss: "बंद करें" },
