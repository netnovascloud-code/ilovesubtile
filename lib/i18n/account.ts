...
const en: BillingStrings = {
  ...
  subDescSubscriber: "Change plan, update or remove your card, download invoices, or cancel — all handled securely by Stripe.",
  subDescComped: "Your plan is active on this account.",
  subDescFree: "Pick a plan to unlock higher limits and remove ads.",
  free: "Free",
  perMo: "/mo",
  ...
  opening: "Opening…",
  noSubscriptionError: "You don't have an active subscription — nothing to manage here.",
  signInFirstError: "Sign in first.",
  portalError: "Billing portal error.",
  networkError: "Network error.",
  portalNote: "Opens your secure Stripe portal: payment method, plan changes, invoices and cancellation.",
  portalNoteCustomer: "Opens your Stripe customer portal: update your payment method and download receipts for your purchases.",
  ...
  vatNote: "Payments are processed securely by Stripe (PCI-DSS Level 1) — we never see or store your card details.",
  aiUsage: "AI usage",
...
const fr: BillingStrings = {
  ...
  subDescSubscriber: "Changer d'offre, mettre à jour ou retirer votre carte, télécharger vos factures ou résilier — tout est géré en toute sécurité par Stripe.",
  subDescComped: "Votre offre est active sur ce compte.",
  subDescFree: "Choisissez une offre pour débloquer des limites plus élevées et retirer les publicités.",
  free: "Gratuit",
  perMo: "/mois",
  ...
  opening: "Ouverture…",
  noSubscriptionError: "Vous n'avez pas d'abonnement actif — rien à gérer ici.",
  signInFirstError: "Connectez-vous d'abord.",
  portalError: "Erreur du portail de facturation.",
  networkError: "Erreur réseau.",
  portalNote: "Ouvre votre portail Stripe sécurisé : moyen de paiement, changement d'offre, factures et résiliation.",
  portalNoteCustomer: "Ouvre votre portail client Stripe : mettez à jour votre moyen de paiement et téléchargez les reçus de vos achats.",
  ...
  vatNote: "Les paiements sont traités en toute sécurité par Stripe (PCI-DSS niveau 1) — nous ne voyons ni ne stockons jamais vos données de carte.",
