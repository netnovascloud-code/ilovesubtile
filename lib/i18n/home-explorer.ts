 ...
 * `counter` contains "{n}" (tool count) and "{l}" (language count) placeholders,
 * and `seeAll` contains "{n}" — all interpolated by the page from canonical
 * config (so the numbers never drift, e.g. the language count stays in sync with
 * LOCALES).
...
const en: HomeExplorerStrings = {
  ...
  all: "All",
  counter: "{n}+ free tools · {l} languages · Files deleted instantly",
  ai: "AI",
...
const fr: HomeExplorerStrings = {
  ...
  all: "Tout",
  counter: "{n}+ outils gratuits · {l} langues · Fichiers supprimés instantanément",
  ai: "IA",
...
const es: HomeExplorerStrings = {
  ...
  all: "Todo",
  counter: "{n}+ herramientas gratis · {l} idiomas · Archivos eliminados al instante",
  ai: "IA",
...
const pt: HomeExplorerStrings = {
  ...
  all: "Tudo",
  counter: "{n}+ ferramentas grátis · {l} idiomas · Arquivos excluídos na hora",
  ai: "IA",
...
const de: HomeExplorerStrings = {
  ...
  all: "Alle",
  counter: "{n}+ kostenlose Tools · {l} Sprachen · Dateien sofort gelöscht",
  ai: "KI",
...
const it: HomeExplorerStrings = {
  ...
  all: "Tutto",
  counter: "{n}+ strumenti gratis · {l} lingue · File eliminati all'istante",
  ai: "IA",
...
const nl: HomeExplorerStrings = {
  ...
  all: "Alles",
  counter: "{n}+ gratis tools · {l} talen · Bestanden direct verwijderd",
  ai: "AI",
...
const ja: HomeExplorerStrings = {
  ...
  all: "すべて",
  counter: "{n}+ の無料ツール · {l} 言語 · ファイルは即時削除",
  ai: "AI",
...
const ko: HomeExplorerStrings = {
  ...
  all: "전체",
  counter: "{n}+개 무료 도구 · {l}개 언어 · 파일 즉시 삭제",
  ai: "AI",
  seeAll: "{n}개 도구 모두 보기",
...
const ar: HomeExplorerStrings = {
  ...
  all: "الكل",
  counter: "{n}+ أداة مجانية · {l} لغة · تُحذف الملفات فورًا",
  ai: "ذكاء اصطناعي",
...
const ru: HomeExplorerStrings = {
  ...
  all: "Все",
  counter: "{n}+ бесплатных инструментов · {l} языков · Файлы удаляются мгновенно",
  ai: "ИИ",
...
const hi: HomeExplorerStrings = {
  ...
  all: "सभी",
  counter: "{n}+ मुफ़्त टूल · {l} भाषाएँ · फ़ाइलें तुरंत हटाई जाती हैं",
  ai: "AI",
...
const tr: HomeExplorerStrings = {
  ...
  all: "Tümü",
  counter: "{n}+ ücretsiz araç · {l} dil · Dosyalar anında silinir",
  ai: "AI",
...
const id: HomeExplorerStrings = {
  ...
  all: "Semua",
  counter: "{n}+ alat gratis · {l} bahasa · File dihapus seketika",
  ai: "AI",
...
const vi: HomeExplorerStrings = {
  ...
  all: "Tất cả",
  counter: "{n}+ công cụ miễn phí · {l} ngôn ngữ · Tệp xóa tức thì",
  ai: "AI",
...
const sv: HomeExplorerStrings = {
  ...
  all: "Alla",
  counter: "{n}+ gratis verktyg · {l} språk · Filer raderas direkt",
  ai: "AI",
...
const pl: HomeExplorerStrings = {
  ...
  all: "Wszystko",
  counter: "{n}+ darmowych narzędzi · {l} języków · Pliki usuwane natychmiast",
  ai: "AI",
...
const uk: HomeExplorerStrings = {
  ...
  all: "Усі",
  counter: "{n}+ безкоштовних інструментів · {l} мов · Файли видаляються миттєво",
  ai: "AI",
...
const cs: HomeExplorerStrings = {
  ...
  all: "Vše",
  counter: "{n}+ bezplatných nástrojů · {l} jazyků · Soubory mazány okamžitě",
  ai: "AI",
