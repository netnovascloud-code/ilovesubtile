    ...
    <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
      <div className="rounded-lg border border-ink-100 bg-white p-8 shadow-card">
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="mt-4 text-xl font-semibold text-ink-900">Your file is ready</h3>
        ...
        {crossLinks.length > 0 && (
          <div className="mt-8 border-t border-ink-100 pt-6">
            <div className="text-sm font-semibold text-ink-900">What's next?</div>
      ...
      {!hideAds && (
        <aside className="hidden lg:block">
          <div className="mb-2 text-[10px] uppercase tracking-wide text-ink-300">Advertisement</div>
          <AdSlot slot="sidebar" />
        </aside>
      )}
    </div>
