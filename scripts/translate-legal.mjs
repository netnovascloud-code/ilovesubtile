...
async function main() {
  ...
  for (const [code, name] of LOCALES) {
    ...
    for (const docName of ["privacy", "terms", "cookies"]) {
      if (ONLY_DOC && ONLY_DOC !== docName) continue;
      const overlay = docName === "privacy" ? privacy : docName === "terms" ? terms : cookies;
      ...
      try {
        const src = docName === "privacy" ? PRIVACY_EN : docName === "terms" ? TERMS_EN : COOKIES_EN;
