...
export const metadata: Metadata = {
  ...
  description: "The rules for using Konver.",
  ...
  return (
    <article className="container max-w-3xl py-16">
      ...
      <section className="prose prose-sm mt-8 max-w-none text-ink-700">
        ...
        <p>
          Konver is provided as-is. Free users have daily quotas; Pro and Business users get
        ...
        <p>
          Don&apos;t use Konver to process content you don&apos;t have rights to, to generate
