 ...
 *  into the matching tool. Each maps to a real Wyrlo tool (honest CTA). */
...
export const HOWTOS: Record<string, HowTo> = {
  "compress-pdf-without-losing-quality": {
    ...
    metaTitle: "How to Compress a PDF Without Losing Quality | Wyrlo",
    ...
    why: "Wyrlo compresses PDFs locally in your browser, so your document is never uploaded and the result is instant. It's free and unlimited, with no watermark on the output.",
    faq: [
  ...
  "convert-pdf-to-word-free-online": {
    ...
    metaTitle: "How to Convert a PDF to Word Free Online | Wyrlo",
    ...
    why: "Wyrlo converts in your browser, so your document is private and the result is instant — free and unlimited, no account required.",
    faq: [
  ...
  "remove-background-from-photo-free": {
    ...
    metaTitle: "How to Remove the Background from a Photo Free | Wyrlo",
    ...
    why: "Wyrlo runs the AI entirely in your browser, so your image is never uploaded — and it's free at full resolution, with no credit wall.",
    faq: [
  ...
  "transcribe-audio-to-text-automatically": {
    ...
    metaTitle: "How to Transcribe Audio to Text Automatically | Wyrlo",
    ...
    why: "Wyrlo uses state-of-the-art AI transcription and deletes your file within 30 minutes. Free to start, with a generous daily allowance.",
    faq: [
  ...
  "convert-mp4-to-mp3-online": {
    ...
    metaTitle: "How to Convert MP4 to MP3 Online Free | Wyrlo",
    ...
    why: "Wyrlo runs FFmpeg in your browser, so your video is never uploaded and the conversion is instant — free and unlimited.",
    faq: [
  ...
  "translate-pdf-document-online": {
    ...
    metaTitle: "How to Translate a PDF Document Online Free | Wyrlo",
    ...
    why: "Wyrlo's AI translates naturally rather than word-for-word, and pairs with the PDF tools so you can extract and translate in one place. Free to start.",
    faq: [
  ...
  "generate-subtitles-for-video-free": {
    ...
    metaTitle: "How to Generate Subtitles for a Video Free | Wyrlo",
    ...
    why: "Wyrlo generates subtitles with state-of-the-art AI in 30+ languages, then lets you translate or burn them in — free to start, files deleted within 30 minutes.",
    faq: [
  ...
  "add-a-watermark-to-a-pdf": {
    ...
    metaTitle: "How to Add a Watermark to a PDF Free | Wyrlo",
    ...
    why: "Wyrlo adds watermarks locally with pdf-lib, so your document is never uploaded — free and unlimited, no watermark-on-the-watermark catch.",
    faq: [
