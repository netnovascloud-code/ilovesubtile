...
export const metadata: Metadata = {
  ...
  description: "How Konvertools handles your data.",
  ...
  return (
    <article className="container max-w-3xl py-16">
      ...
      <section className="prose prose-sm mt-8 max-w-none text-ink-700">
        ...
        <p>
          Authentication and storage are provided by Supabase. Payments by Stripe. AI
          processing (transcription, translation, summarisation, cleanup) runs on third-party
          AI providers. Emails are sent by Resend. Each of these services has their own privacy policy.
        </p>
