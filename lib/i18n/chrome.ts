...
const en: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo is free thanks to ads", body1: "You can disable ads by", goPro: "going Pro at €9/month", body2: ", or by allowing ads on this site.", dismiss: "Dismiss" },
...
const fr: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo est gratuit grâce aux publicités", body1: "Vous pouvez désactiver les pubs en", goPro: "passant Pro pour 9 €/mois", body2: ", ou en autorisant les pubs sur ce site.", dismiss: "Fermer" },
...
const es: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo es gratis gracias a los anuncios", body1: "Puedes desactivar los anuncios", goPro: "pasando a Pro por 9 €/mes", body2: ", o permitiendo los anuncios en este sitio.", dismiss: "Cerrar" },
...
const pt: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo é grátis graças aos anúncios", body1: "Você pode desativar os anúncios", goPro: "indo Pro por €9/mês", body2: ", ou permitindo anúncios neste site.", dismiss: "Fechar" },
...
const de: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo ist dank Werbung kostenlos", body1: "Du kannst die Werbung deaktivieren, indem du", goPro: "Pro für 9 €/Monat holst", body2: " oder Werbung auf dieser Seite zulässt.", dismiss: "Schließen" },
...
const it: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo è gratis grazie agli annunci", body1: "Puoi disattivare gli annunci", goPro: "passando a Pro per 9 €/mese", body2: ", o consentendo gli annunci su questo sito.", dismiss: "Chiudi" },
...
const nl: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo is gratis dankzij advertenties", body1: "Je kunt advertenties uitschakelen door", goPro: "Pro te nemen voor €9/maand", body2: ", of door advertenties op deze site toe te staan.", dismiss: "Sluiten" },
...
const ja: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo は広告のおかげで無料です", body1: "広告は次の方法で無効化できます：", goPro: "月 9 ユーロで Pro へ", body2: " もしくは、このサイトで広告を許可してください。", dismiss: "閉じる" },
...
const zh: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo 因广告而免费", body1: "您可以通过以下方式关闭广告:", goPro: "每月 9 欧元升级 Pro", body2: ",或在本站允许广告。", dismiss: "关闭" },
...
const ko: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo 는 광고 덕분에 무료입니다", body1: "광고는 다음 방법으로 비활성화 가능:", goPro: "월 9유로로 Pro 가입", body2: " 또는 이 사이트의 광고를 허용해 주세요.", dismiss: "닫기" },
...
const ar: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo مجاني بفضل الإعلانات", body1: "يمكنك تعطيل الإعلانات عبر:", goPro: "الترقية إلى Pro بـ 9 يورو/شهر", body2: " أو السماح بالإعلانات على هذا الموقع.", dismiss: "إغلاق" },
...
const ru: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo бесплатен благодаря рекламе", body1: "Рекламу можно отключить,", goPro: "перейдя на Pro за 9 €/мес", body2: ", или разрешив рекламу на этом сайте.", dismiss: "Закрыть" },
...
const hi: ChromeStrings = {
  ...
  adblock: { title: "Wyrlo विज्ञापनों के कारण मुफ़्त है", body1: "आप विज्ञापन इस तरह बंद कर सकते हैं:", goPro: "€9/माह में Pro लें", body2: ", या इस साइट पर विज्ञापनों की अनुमति दें।", dismiss: "बंद करें" },
