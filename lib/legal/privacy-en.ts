    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "ul", items: [
          ...
          "**Subscription state**: current plan (free / Pro / Business), Stripe customer identifier, and the dates of your most recent renewals.",
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "ul", items: [
          ...
          "**Stripe** (Stripe Payments Europe, Ltd., Ireland) — payment processing and subscription billing. We **never see or store** your card details. Stripe receives your email, payment method, billing address, and the plan you bought.",
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "ul", items: [
          ...
          "**Payment data** — never seen or stored by us; the card payment flow is fully delegated to Stripe (PCI-DSS Level 1 compliant).",
