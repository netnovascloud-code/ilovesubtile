...
TOOLS.push(
  ...
  utilTool("roman-numeral-converter", Hash, "Roman Numeral Converter", "Convert numbers to Roman numerals and back.",
    ...
    "Roman Numeral Converter — Number ⇄ Roman Online | Wyrlo",
  ...
  utilTool("color-palette-generator", Palette, "Color Palette Generator", "Build harmonious palettes from one colour.",
    ...
    "Color Palette Generator Online — Harmonies & Shades | Wyrlo",
  ...
  utilTool("email-signature-generator", Mail, "Email Signature Generator", "Create a clean HTML email signature.",
    ...
    "Email Signature Generator Online — HTML for Gmail | Wyrlo",
...
export const ALTERNATIVES: AlternativeDef[] = [
  ...
  },
  {
    ...
    competitor: "iLovePDF",
    title: "Best Free iLovePDF Alternative — Wyrlo",
    metaTitle: "Free iLovePDF Alternative — More Tools, No Ads | Wyrlo",
    metaDescription: "Looking for an iLovePDF alternative? Wyrlo does PDF too — merge, split, compress, convert — plus images, audio, video and AI text, with no ads on the free tier.",
    bulletPoints: [
    ...
    faqs: [
      { q: "Does Wyrlo do everything iLovePDF does?", a: "It covers the everyday PDF jobs — merge, split, compress, convert, watermark, page numbers — and adds images, audio, video, code and AI text." },
  ...
  },
  {
    ...
    title: "Free Adobe Acrobat Alternative Online — Wyrlo",
    metaTitle: "Free Adobe Acrobat Alternative Online | Wyrlo",
    ...
    faqs: [
      { q: "Is Wyrlo a real Acrobat replacement?", a: "For everyday tasks — merging, compressing, converting, watermarking — yes, and free. For deep editing, OCR and forms, Acrobat Pro is still ahead." },
      ...
      { q: "Can it edit PDF text?", a: "Wyrlo focuses on conversion and page operations rather than in-place text editing." },
    ],
  },
  {
    slug: "deepl-alternative",
    competitor: "DeepL",
    title: "Free DeepL Alternative — Translate Without Limits — Wyrlo",
    metaTitle: "Free DeepL Alternative — Translate + More | Wyrlo",
    ...
    faqs: [
      { q: "Is the translation as good as DeepL?", a: "DeepL still leads on raw nuance for some pairs. Wyrlo's AI is very strong and adds subtitle, rephrase and summarize features DeepL lacks." },
  ...
  },
  {
    ...
    title: "Free Remove.bg Alternative — AI Background Remover — Wyrlo",
    metaTitle: "Free Remove.bg Alternative — AI Background Remover | Wyrlo",
  ...
  },
  {
    ...
    title: "Convertio Alternative — Convert Files Faster Free — Wyrlo",
    metaTitle: "Free Convertio Alternative — Faster, No Limits | Wyrlo",
    ...
    faqs: [
      { q: "Why is Wyrlo faster?", a: "Most conversions happen in your browser, so there's no upload and no server queue — the result is instant." },
  ...
  },
  {
    ...
    title: "Free Grammarly Alternative — AI Grammar Checker — Wyrlo",
    metaTitle: "Free Grammarly Alternative — AI Grammar + More | Wyrlo",
    ...
    faqs: [
      { q: "Does Wyrlo check grammar like Grammarly?", a: "Yes — paste your text and the AI fixes grammar, spelling and clarity, plus rephrasing and summarizing." },
      { q: "Do I need a browser extension?", a: "No. Wyrlo works on a page — paste, fix, copy. Nothing to install." },
      { q: "What does Grammarly do that Wyrlo doesn't?", a: "Grammarly's always-on, in-context checking across every app as you type is unmatched. Wyrlo is on-demand." },
