...
export const SECTORS: Record<string, Sector> = {
  youtubers: {
    id: "youtubers",
    hero: "Konvertools for YouTubers — Subtitles, Audio & Thumbnails",
    ...
    metaTitle: "Konvertools for YouTubers — Subtitles, Audio & Thumbnails Free | Konvertools",
  ...
  developers: {
    id: "developers",
    hero: "Konvertools for Developers — JSON, Code & Data Tools",
    intro: "Format and validate JSON, convert between data formats, decode JWTs, encode Base64, generate UUIDs and test regex — all in your browser, nothing uploaded.",
    metaTitle: "Konvertools for Developers — JSON, Code & Data Tools | Konvertools",
    metaDescription: "Free dev tools: JSON formatter, JSON↔CSV/XML/YAML, Base64, URL encode, JWT decoder, UUID v4/v7, regex tester, diff. 100% in-browser, no sign-up.",
    highlights: [
      { title: "Browser-first, zero upload", body: "JSON, regex, diff, UUID — runs in your browser. Your code never leaves the device." },
      { title: "Free and unlimited", body: "Every developer tool is free with no account and no usage caps — open the page and go." },
      { title: "Strict, well-formed output", body: "JSON parsed via the engine; XML/CSV/YAML round-trip cleanly." },
    ],
    toolSlugs: ["format-json", "json-to-csv", "csv-to-json", "json-to-xml", "json-to-yaml", "yaml-to-json", "xml-to-json", "base64", "url-encode", "jwt-decoder", "regex-tester", "uuid-generator", "text-diff", "unix-timestamp", "minify-css", "format-sql"],
    faq: [
      { q: "Do these tools work offline?", a: "Once the page has loaded, JSON, regex, diff and the rest run on-device, so they keep working even without a connection." },
      { q: "Is anything uploaded?", a: "No — the developer tools run entirely in your browser. Your code and data never leave your device." },
      { q: "Do I need an account?", a: "No. Every developer tool is free and unlimited with no sign-up." },
    ],
  },
  podcasters: {
    id: "podcasters",
    hero: "Konvertools for Podcasters — Transcription & Audio Tools",
    ...
    metaTitle: "Konvertools for Podcasters — Transcription & Audio Tools | Konvertools",
  ...
  designers: {
    id: "designers",
    hero: "Konvertools for Designers — Image & Color Tools",
    ...
    metaTitle: "Konvertools for Designers — Image & Color Tools Free | Konvertools",
  ...
  students: {
    id: "students",
    hero: "Konvertools for Students — Free Study & Document Tools",
    ...
    metaTitle: "Konvertools for Students — Free Study & Document Tools | Konvertools",
  ...
  lawyers: {
    id: "lawyers",
    hero: "Konvertools for Legal Professionals — Document Conversion",
    ...
    metaTitle: "Konvertools for Legal Professionals — Document Tools | Konvertools",
  ...
  recruiters: {
    id: "recruiters",
    hero: "Konvertools for HR & Recruiters — CV & Document Tools",
    ...
    metaTitle: "Konvertools for HR & Recruiters — CV & Document Tools | Konvertools",
  ...
  ecommerce: {
    id: "ecommerce",
    hero: "Konvertools for E-commerce — Product Images & Descriptions",
    ...
    metaTitle: "Konvertools for E-commerce — Product Images & Descriptions | Konvertools",
