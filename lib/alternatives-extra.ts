// Konvertools vs. major competitors — used by the /alternatives/<slug> pages.
...
export const EXTRA_ALTERNATIVES: AlternativeDef[] = [
  {
    slug: "deepl",
    competitor: "DeepL",
    title: "Free DeepL Alternative — Konvertools Translator",
    metaTitle: "Konvertools vs DeepL — Free Translator with Formal/Informal | Konvertools",
    metaDescription:
      "Looking for a free DeepL alternative? Konvertools Translator covers 30+ languages with formal/informal register, instant translation and zero file retention.",
    bulletPoints: [
    ...
    faqs: [
      { q: "Is Konvertools's translator as good as DeepL?", a: "It uses an advanced AI model and idiomatic prompts — quality is comparable on common language pairs. DeepL still leads on some European pairs; we keep adding tuning." },
  ...
  },
  {
    slug: "ilovepdf",
    competitor: "iLovePDF",
    title: "Free iLovePDF Alternative — All-in-One Konvertools",
    metaTitle: "Konvertools vs iLovePDF — Free PDF, Image, Audio, Video Tools | Konvertools",
    metaDescription:
      "iLovePDF is great for PDF. Konvertools does PDF too — plus images, audio, video, subtitles, code and AI text — all in one place, all free.",
    bulletPoints: [
    ...
    faqs: [
      { q: "Does Konvertools replace iLovePDF for PDFs?", a: "For Merge / Split / Rotate / Images→PDF, yes — done fully in your browser. PDF→Word, PDF→JPG and compress-PDF are coming via in-browser libraries." },
      ...
      { q: "What else does Konvertools do?", a: "Audio/video conversion, image editing, AI text tools, dev utilities, subtitle tools — 80+ tools total." },
    ],
  },
  {
    slug: "convertio",
    competitor: "Convertio",
    title: "Free Convertio Alternative — Konvertools",
    metaTitle: "Konvertools vs Convertio — Faster, Free, Private | Konvertools",
    metaDescription:
      "Convertio uploads your files; Konvertools doesn't. Faster, private, no daily upload cap — and free for most conversions.",
    bulletPoints: [
    ...
    faqs: [
      { q: "Is Konvertools as fast as Convertio?", a: "For images, PDFs and most code tools, faster — there's no upload. For audio/video the first run loads FFmpeg.wasm (~30MB), then everything is instant." },
  ...
  },
  {
    ...
    title: "Free Remove.bg Alternative — Konvertools",
    metaTitle: "Konvertools vs Remove.bg — Free, In-browser, Unlimited | Konvertools",
    metaDescription:
      "Remove backgrounds free without paid credits. Konvertools runs AI background removal in your browser via WebAssembly — no upload, no quota.",
    bulletPoints: [
      "AI background removal that runs entirely in your browser.",
      "No credits, no per-image fee, no upload — even for high-res photos.",
      "Pair it with the other Konvertools image tools (compress, resize, convert).",
  ...
  },
  {
    slug: "smallpdf",
    competitor: "Smallpdf",
    title: "Free Smallpdf Alternative — Konvertools",
    metaTitle: "Konvertools vs Smallpdf — Free Unlimited PDF Tools | Konvertools",
    metaDescription:
      "Smallpdf caps the free plan at 2 tasks/day. Konvertools's PDF tools run in your browser, with no daily cap and no upload.",
    bulletPoints: [
    ...
    faqs: [
      { q: "Is Konvertools really unlimited for PDFs?", a: "For Merge / Split / Rotate / Images→PDF — yes, with no per-day cap, no waterprint, no upload. The processing runs entirely in your browser." },
      { q: "What does Smallpdf still do better?", a: "OCR, PDF→Excel and a few enterprise features. They're on our roadmap." },
      { q: "Why are Konvertools's browser tools free?", a: "We don't charge for tools that run on the user's device — there's no server cost to recoup." },
  ...
  },
  {
    slug: "veed",
    competitor: "VEED.io",
    title: "Free VEED Alternative — Konvertools",
    metaTitle: "Konvertools vs VEED — Free Video Tools without Watermark | Konvertools",
    metaDescription:
      "VEED's free plan watermarks everything. Konvertools's video tools run via FFmpeg.wasm in your browser — no watermark, no upload, no upsell.",
    bulletPoints: [
    ...
    faqs: [
      { q: "Can I use VEED's editor in Konvertools?", a: "Not the timeline editor — Konvertools focuses on one-shot conversions and quick edits. Editing complex sequences is still better in VEED or DaVinci." },
      ...
      { q: "Is there a watermark?", a: "Never on Konvertools's client-side video output." },
      { q: "What about subtitles?", a: "Konvertools has 16 subtitle tools (generate, translate, sync, burn-in, convert)." },
    ],
  },
  {
    slug: "chatgpt",
    competitor: "ChatGPT",
    title: "Free ChatGPT Alternative for Conversions — Konvertools",
    metaTitle: "Konvertools AI Tools — ChatGPT Alternative for File Tasks | Konvertools",
    metaDescription:
      "ChatGPT is generic. Konvertools's AI is purpose-built for translation, rephrasing, humanising AI text and summarising — instantly, in one click.",
    bulletPoints: [
    ...
    faqs: [
      { q: "Does Konvertools replace ChatGPT?", a: "Not for open conversation. For specific copy/file tasks (translate, summarise, rephrase, humanize, fix grammar) — yes, faster and with purpose-built UIs." },
      { q: "Which AI does Konvertools use?", a: "An advanced large language model running server-side via Edge Functions. The technical name isn't surfaced because the experience is what matters." },
