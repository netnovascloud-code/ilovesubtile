    ...
    },
    {
      ...
      blocks: [
        { kind: "ul", items: [
          ...
          "**Payment processing**: payments are handled securely by **Stripe** (Stripe Payments Europe, Ltd.), a PCI-DSS Level 1 payment processor. We never see or store your card details. The Publisher is the seller of record; the amount shown at checkout is the amount charged, and any applicable VAT is indicated there.",
        ] },
      ],
    },
    {
