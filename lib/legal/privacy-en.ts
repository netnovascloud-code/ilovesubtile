    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "ul", items: [
          ...
          "**Subscription state**: current plan (free / Pro / Business), Lemon Squeezy customer identifier, current credit balance, and the dates of your most recent renewals.",
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "ul", items: [
          ...
          "**Lemon Squeezy** (USA) — our Merchant of Record: payment processing, subscription management, and worldwide VAT/sales-tax collection and remittance. We **never see or store** your card details. Lemon Squeezy receives your email, payment method, and the plan/credit-pack you bought.",
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "ul", items: [
          ...
          "**Payment data** — never seen or stored by us; the card payment flow is fully delegated to Lemon Squeezy, our Merchant of Record (PCI-DSS Level 1 compliant).",
