...
const en: ChromeStrings = {
  ...
  adblock: { title: "Konver is free thanks to ads", body1: "You can disable ads by", goPro: "going Pro at €12/month", body2: ", or by allowing ads on this site.", dismiss: "Dismiss" },
...
const fr: ChromeStrings = {
  ...
  adblock: { title: "Konver est gratuit grâce aux publicités", body1: "Vous pouvez désactiver les pubs en", goPro: "passant Pro pour 12 €/mois", body2: ", ou en autorisant les pubs sur ce site.", dismiss: "Fermer" },
...
const es: ChromeStrings = {
  ...
  adblock: { title: "Konver es gratis gracias a los anuncios", body1: "Puedes desactivar los anuncios", goPro: "pasando a Pro por 12 €/mes", body2: ", o permitiendo los anuncios en este sitio.", dismiss: "Cerrar" },
...
const pt: ChromeStrings = {
  ...
  adblock: { title: "Konver é grátis graças aos anúncios", body1: "Você pode desativar os anúncios", goPro: "indo Pro por €12/mês", body2: ", ou permitindo anúncios neste site.", dismiss: "Fechar" },
...
const de: ChromeStrings = {
  ...
  adblock: { title: "Konver ist dank Werbung kostenlos", body1: "Du kannst die Werbung deaktivieren, indem du", goPro: "Pro für 12 €/Monat holst", body2: " oder Werbung auf dieser Seite zulässt.", dismiss: "Schließen" },
...
const it: ChromeStrings = {
  ...
  adblock: { title: "Konver è gratis grazie agli annunci", body1: "Puoi disattivare gli annunci", goPro: "passando a Pro per 12 €/mese", body2: ", o consentendo gli annunci su questo sito.", dismiss: "Chiudi" },
...
const nl: ChromeStrings = {
  ...
  adblock: { title: "Konver is gratis dankzij advertenties", body1: "Je kunt advertenties uitschakelen door", goPro: "Pro te nemen voor €12/maand", body2: ", of door advertenties op deze site toe te staan.", dismiss: "Sluiten" },
...
const ja: ChromeStrings = {
  ...
  adblock: { title: "Konver は広告のおかげで無料です", body1: "広告は次の方法で無効化できます：", goPro: "月 12 ユーロで Pro へ", body2: " もしくは、このサイトで広告を許可してください。", dismiss: "閉じる" },
...
const ko: ChromeStrings = {
  ...
  adblock: { title: "Konver 는 광고 덕분에 무료입니다", body1: "광고는 다음 방법으로 비활성화 가능:", goPro: "월 12유로로 Pro 가입", body2: " 또는 이 사이트의 광고를 허용해 주세요.", dismiss: "닫기" },
...
const ar: ChromeStrings = {
  ...
  adblock: { title: "Konver مجاني بفضل الإعلانات", body1: "يمكنك تعطيل الإعلانات عبر:", goPro: "الترقية إلى Pro بـ 12 يورو/شهر", body2: " أو السماح بالإعلانات على هذا الموقع.", dismiss: "إغلاق" },
...
const ru: ChromeStrings = {
  ...
  adblock: { title: "Konver бесплатен благодаря рекламе", body1: "Рекламу можно отключить,", goPro: "перейдя на Pro за 12 €/мес", body2: ", или разрешив рекламу на этом сайте.", dismiss: "Закрыть" },
...
const hi: ChromeStrings = {
  ...
  adblock: { title: "Konver विज्ञापनों के कारण मुफ़्त है", body1: "आप विज्ञापन इस तरह बंद कर सकते हैं:", goPro: "€12/माह में Pro लें", body2: ", या इस साइट पर विज्ञापनों की अनुमति दें।", dismiss: "बंद करें" },
...
const tr: ChromeStrings = {
  ...
  adblock: { title: "Konver reklamlar sayesinde ücretsizdir", body1: "Reklamları şu şekilde devre dışı bırakabilirsiniz:", goPro: "ayda 12 €'ya Pro'ya geçerek", body2: " veya bu sitede reklamlara izin vererek.", dismiss: "Kapat" },
...
const id: ChromeStrings = {
  ...
  adblock: { title: "Konver gratis berkat iklan", body1: "Anda dapat menonaktifkan iklan dengan", goPro: "beralih ke Pro seharga €12/bulan", body2: ", atau dengan mengizinkan iklan di situs ini.", dismiss: "Tutup" },
...
const vi: ChromeStrings = {
  ...
  adblock: { title: "Konver miễn phí nhờ quảng cáo", body1: "Bạn có thể tắt quảng cáo bằng cách", goPro: "lên Pro với giá 12 €/tháng", body2: ", hoặc cho phép quảng cáo trên trang này.", dismiss: "Đóng" },
...
const sv: ChromeStrings = {
  ...
  adblock: { title: "Konver är gratis tack vare annonser", body1: "Du kan inaktivera annonser genom att", goPro: "gå Pro för 12 €/månad", body2: ", eller genom att tillåta annonser på den här webbplatsen.", dismiss: "Stäng" },
...
const pl: ChromeStrings = {
  ...
  adblock: { title: "Konver jest darmowy dzięki reklamom", body1: "Możesz wyłączyć reklamy,", goPro: "przechodząc na Pro za 12 €/mies.", body2: ", lub zezwalając na reklamy w tej witrynie.", dismiss: "Zamknij" },
...
const uk: ChromeStrings = {
  ...
  adblock: { title: "Konver безкоштовний завдяки рекламі", body1: "Ви можете вимкнути рекламу,", goPro: "перейшовши на Pro за 12 €/міс", body2: ", або дозволивши рекламу на цьому сайті.", dismiss: "Закрити" },
...
const cs: ChromeStrings = {
  ...
  adblock: { title: "Konver je zdarma díky reklamám", body1: "Reklamy můžete vypnout", goPro: "přechodem na Pro za 12 €/měsíc", body2: ", nebo povolením reklam na tomto webu.", dismiss: "Zavřít" },
