...
const cEs: CommonUi = {
  ...
  quotaAnonPrefix: "2 usos de IA gratis/día —", quotaAnonLink: "Inicia sesión para 5", quotaAnonRequire: "Inicia sesión para usar las herramientas de IA — cuenta gratis", quotaFreePrefix: "Plan gratis: 5 usos de IA/día —", quotaFreeLink: "Hazte Pro por 500/mes", unlimited: "Ilimitado",
...
const cPt: CommonUi = {
  ...
  quotaAnonPrefix: "2 usos de IA grátis/dia —", quotaAnonLink: "Entre para 5", quotaAnonRequire: "Entre para usar as ferramentas de IA — conta gratuita", quotaFreePrefix: "Plano grátis: 5 usos de IA/dia —", quotaFreeLink: "Seja Pro por 500/mês", unlimited: "Ilimitado",
...
const cDe: CommonUi = {
  ...
  quotaAnonPrefix: "2 kostenlose KI-Läufe/Tag —", quotaAnonLink: "Anmelden für 5", quotaAnonRequire: "Melde dich an, um die KI-Tools zu nutzen — kostenloses Konto", quotaFreePrefix: "Gratis-Plan: 5 KI-Läufe/Tag —", quotaFreeLink: "Pro für 500/Monat", unlimited: "Unbegrenzt",
...
const cIt: CommonUi = {
  ...
  quotaAnonPrefix: "2 usi IA gratis/giorno —", quotaAnonLink: "Accedi per 5", quotaAnonRequire: "Accedi per usare gli strumenti IA — account gratuito", quotaFreePrefix: "Piano gratis: 5 usi IA/giorno —", quotaFreeLink: "Passa a Pro per 500/mese", unlimited: "Illimitato",
...
const cNl: CommonUi = {
  ...
  quotaAnonPrefix: "2 gratis AI-runs/dag —", quotaAnonLink: "Log in voor 5", quotaAnonRequire: "Log in om de AI-tools te gebruiken — gratis account", quotaFreePrefix: "Gratis plan: 5 AI-runs/dag —", quotaFreeLink: "Ga Pro voor 500/maand", unlimited: "Onbeperkt",
...
const cJa: CommonUi = {
  ...
  quotaAnonPrefix: "無料の AI 実行 2 回/日 —", quotaAnonLink: "ログインで 5 回", quotaAnonRequire: "AIツールを使うにはログインしてください — 無料アカウント", quotaFreePrefix: "無料プラン：AI 実行 5 回/日 —", quotaFreeLink: "Pro で月 500 回", unlimited: "無制限",
...
const cZh: CommonUi = {
  ...
  quotaAnonPrefix: "每天 2 次免费 AI —", quotaAnonLink: "登录可用 5 次", quotaAnonRequire: "登录后即可使用 AI 工具 — 免费账户", quotaFreePrefix: "免费版:每天 5 次 AI —", quotaFreeLink: "升级 Pro 每月 500 次", unlimited: "无限制",
...
const cKo: CommonUi = {
  ...
  quotaAnonPrefix: "무료 AI 하루 2회 —", quotaAnonLink: "로그인하면 5회", quotaAnonRequire: "AI 도구를 사용하려면 로그인하세요 — 무료 계정", quotaFreePrefix: "무료 플랜: AI 하루 5회 —", quotaFreeLink: "Pro 로 월 500회", unlimited: "무제한",
...
const cAr: CommonUi = {
  ...
  quotaAnonPrefix: "تشغيلان مجانيان للذكاء الاصطناعي/يوم —", quotaAnonLink: "سجّل الدخول لـ 5", quotaAnonRequire: "سجّل الدخول لاستخدام أدوات الذكاء الاصطناعي — حساب مجاني", quotaFreePrefix: "الخطة المجانية: 5 تشغيلات ذكاء اصطناعي/يوم —", quotaFreeLink: "اشترك في Pro لـ 500/شهر", unlimited: "غير محدود",
...
const cRu: CommonUi = {
  ...
  quotaAnonPrefix: "2 бесплатных запуска ИИ/день —", quotaAnonLink: "Войдите для 5", quotaAnonRequire: "Войдите, чтобы пользоваться ИИ-инструментами — бесплатный аккаунт", quotaFreePrefix: "Бесплатный план: 5 запусков ИИ/день —", quotaFreeLink: "Pro — 500/месяц", unlimited: "Без ограничений",
...
const cHi: CommonUi = {
  ...
  quotaAnonPrefix: "2 मुफ़्त AI उपयोग/दिन —", quotaAnonLink: "5 के लिए साइन इन करें", quotaAnonRequire: "AI टूल इस्तेमाल करने के लिए साइन इन करें — मुफ़्त खाता", quotaFreePrefix: "मुफ़्त प्लान: 5 AI उपयोग/दिन —", quotaFreeLink: "500/माह के लिए Pro लें", unlimited: "असीमित",
...
const cTr: CommonUi = {
  ...
  quotaAnonPrefix: "Günde 2 ücretsiz AI çalıştırması —", quotaAnonLink: "5 için giriş yapın", quotaAnonRequire: "Yapay zekâ araçlarını kullanmak için giriş yapın — ücretsiz hesap", quotaFreePrefix: "Ücretsiz plan: günde 5 AI çalıştırması —", quotaFreeLink: "Ayda 500 için Pro", unlimited: "Sınırsız",
...
const cId: CommonUi = {
  ...
  quotaAnonPrefix: "2 proses AI gratis/hari —", quotaAnonLink: "Masuk untuk 5", quotaAnonRequire: "Masuk untuk memakai alat AI — akun gratis", quotaFreePrefix: "Paket gratis: 5 proses AI/hari —", quotaFreeLink: "Pro untuk 500/bulan", unlimited: "Tanpa batas",
...
const cVi: CommonUi = {
  ...
  quotaAnonPrefix: "2 lượt AI miễn phí/ngày —", quotaAnonLink: "Đăng nhập để có 5", quotaAnonRequire: "Đăng nhập để dùng công cụ AI — tài khoản miễn phí", quotaFreePrefix: "Gói miễn phí: 5 lượt AI/ngày —", quotaFreeLink: "Lên Pro để có 500/tháng", unlimited: "Không giới hạn",
...
const cSv: CommonUi = {
  ...
  quotaAnonPrefix: "2 gratis AI-körningar/dag —", quotaAnonLink: "Logga in för 5", quotaAnonRequire: "Logga in för att använda AI-verktygen — gratis konto", quotaFreePrefix: "Gratisplan: 5 AI-körningar/dag —", quotaFreeLink: "Bli Pro för 500/månad", unlimited: "Obegränsat",
...
const cPl: CommonUi = {
  ...
  quotaAnonPrefix: "2 darmowe uruchomienia AI/dzień —", quotaAnonLink: "Zaloguj się, by mieć 5", quotaAnonRequire: "Zaloguj się, aby korzystać z narzędzi AI — darmowe konto", quotaFreePrefix: "Plan darmowy: 5 uruchomień AI/dzień —", quotaFreeLink: "Pro za 500/miesiąc", unlimited: "Bez limitu",
...
const cUk: CommonUi = {
  ...
  quotaAnonPrefix: "2 безкоштовні запуски ШІ/день —", quotaAnonLink: "Увійдіть для 5", quotaAnonRequire: "Увійдіть, щоб користуватися ШІ-інструментами — безкоштовний акаунт", quotaFreePrefix: "Безкоштовний план: 5 запусків ШІ/день —", quotaFreeLink: "Pro за 500/місяць", unlimited: "Без обмежень",
...
const cCs: CommonUi = {
  ...
  quotaAnonPrefix: "2 běhy AI zdarma/den —", quotaAnonLink: "Přihlaste se pro 5", quotaAnonRequire: "Přihlaste se k používání nástrojů AI — účet zdarma", quotaFreePrefix: "Plán zdarma: 5 běhů AI/den —", quotaFreeLink: "Pro za 500/měsíc", unlimited: "Bez omezení",
